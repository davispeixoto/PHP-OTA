...
class SummaryAType extends TourActivityChargeType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRQ\BookingInfoAType\PricingAType\SummaryAType\PricingTypeAType
     * $pricingType
     */
    ...
    public function setPricingType(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRQ\BookingInfoAType\PricingAType\SummaryAType\PricingTypeAType $pricingType
    ) {
