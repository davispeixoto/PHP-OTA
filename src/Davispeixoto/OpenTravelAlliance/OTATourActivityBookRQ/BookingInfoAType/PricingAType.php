...
class PricingAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRQ\BookingInfoAType\PricingAType\SummaryAType
     * $summary
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRQ\BookingInfoAType\PricingAType\ParticipantCategoryAType[]
     * $participantCategory
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRQ\BookingInfoAType\PricingAType\GroupAType[]
     * $group
     */
    private $group = null;
    ...
    public function setSummary(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRQ\BookingInfoAType\PricingAType\SummaryAType $summary
    ) {
    ...
    public function addToParticipantCategory(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRQ\BookingInfoAType\PricingAType\ParticipantCategoryAType $participantCategory
    ) {
    ...
    public function addToGroup(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRQ\BookingInfoAType\PricingAType\GroupAType $group
    ) {
        $this->group[] = $group;
