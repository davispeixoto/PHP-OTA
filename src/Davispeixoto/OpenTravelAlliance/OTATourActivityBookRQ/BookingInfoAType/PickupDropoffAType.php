...
class PickupDropoffAType extends TourActivityTransRequestType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRQ\BookingInfoAType\PickupDropoffAType\ParticipantListAType[]
     * $participantList
     */
    ...
    public function addToParticipantList(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRQ\BookingInfoAType\PickupDropoffAType\ParticipantListAType $participantList
    ) {
