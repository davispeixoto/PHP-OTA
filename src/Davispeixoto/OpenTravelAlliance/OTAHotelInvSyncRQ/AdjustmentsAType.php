...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelInvSyncRQ;

use Davispeixoto\OpenTravelAlliance\AdjustmentsType;

/**
 * Class representing AdjustmentsAType
 */
class AdjustmentsAType extends AdjustmentsType
{
