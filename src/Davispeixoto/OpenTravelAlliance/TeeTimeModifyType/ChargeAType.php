...
class ChargeAType
{
    ...
    /**
     * A unique ID that identifies this charge and may be used to associate the charge
     * with a golfer or payment form.
     *
     * @property string $rPH
     */
    private $rPH = null;
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeModifyType\ChargeAType\TaxAmountsAType\TaxAmountAType[]
     * $taxAmounts
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeModifyType\ChargeAType\CalculationAType[]
     * $calculation
     */
    ...
    public function addToTaxAmounts(
        \Davispeixoto\OpenTravelAlliance\TeeTimeModifyType\ChargeAType\TaxAmountsAType\TaxAmountAType $taxAmount
    ) {
    ...
    public function addToCalculation(
        \Davispeixoto\OpenTravelAlliance\TeeTimeModifyType\ChargeAType\CalculationAType $calculation
    ) {
