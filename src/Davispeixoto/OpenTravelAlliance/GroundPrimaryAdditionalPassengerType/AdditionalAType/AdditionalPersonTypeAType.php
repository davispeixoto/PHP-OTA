...
namespace Davispeixoto\OpenTravelAlliance\GroundPrimaryAdditionalPassengerType\AdditionalAType;

/**
 * Class representing AdditionalPersonTypeAType
 */
class AdditionalPersonTypeAType
{
