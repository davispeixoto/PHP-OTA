...
class AdditionalAType extends ContactPersonType
{
    ...
    /**
     * Used to define the specific type of additional person.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\GroundPrimaryAdditionalPassengerType\AdditionalAType\AdditionalPersonTypeAType
     * $additionalPersonType
     */
    private $additionalPersonType = null;
     ...
     * \Davispeixoto\OpenTravelAlliance\GroundPrimaryAdditionalPassengerType\AdditionalAType\AdditionalPersonTypeAType
     */
    public function getAdditionalPersonType()
    {
        return $this->additionalPersonType;
    }

    /**
     * Sets a new additionalPersonType
     *
     * Used to define the specific type of additional person.
     *
     * @param
     ...
     * @return self
     */
    public function setAdditionalPersonType(
        \Davispeixoto\OpenTravelAlliance\GroundPrimaryAdditionalPassengerType\AdditionalAType\AdditionalPersonTypeAType $additionalPersonType
    ) {
        $this->additionalPersonType = $additionalPersonType;
