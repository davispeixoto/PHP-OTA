...
/**
 * Class representing TeeTimeAvailType
 *
 * Tee time information associated with an availability request.
 * XSD Type: TeeTimeAvailType
 */
class TeeTimeAvailType
{
    ...
    /**
     * The number of tee times requested.(Example) If a foursome wants to play two
     * separate rounds within one day, the number of tee times would be 2.
     *
    ...
    /**
     * If true, tee time rounds that accommodate physically challenged individuals are
     * requested.
     *
    ...
    /**
     * Promotions and other rate qualifying discounts requested for this tee time
     * round. Note that promotions may be tied to individual golfers or to the tee time
     * as a whole.
     *
     * @property \Davispeixoto\OpenTravelAlliance\TeeTimeAvailType\DiscountsAType[]
     * $discounts
     */
    private $discounts = null;

    /**
     * Amenities requested for this tee time round. Note that amenities may be tied to
     * individual golfers or to the tee time as a whole.
     *
     * @property \Davispeixoto\OpenTravelAlliance\TeeTimeAvailType\AmenityAType[]
     * $amenity
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\TeeTimeAvailType\DiscountsAType
     * $discounts
     */
    public function addToDiscounts(\Davispeixoto\OpenTravelAlliance\TeeTimeAvailType\DiscountsAType $discounts)
    {
     ...
     * as a whole.
     *
     * @return \Davispeixoto\OpenTravelAlliance\TeeTimeAvailType\DiscountsAType[]
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\TeeTimeAvailType\AmenityAType $amenity
     */
    public function addToAmenity(\Davispeixoto\OpenTravelAlliance\TeeTimeAvailType\AmenityAType $amenity)
    {
     ...
     * individual golfers or to the tee time as a whole.
     *
     * @return \Davispeixoto\OpenTravelAlliance\TeeTimeAvailType\AmenityAType[]
     */
