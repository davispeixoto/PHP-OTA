...
/**
 * Class representing OTACruiseItineraryDescRS
 */
class OTACruiseItineraryDescRS
{
    ...
    /**
     * This element specifies the sailing information.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseItineraryDescRS\SelectedSailingAType
     * $selectedSailing
     */
    private $selectedSailing = null;

    /**
     * A collection of cruise itinerary infos.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseItineraryDescRS\CruiseItinInfosAType\CruiseItinInfoAType[]
     * $cruiseItinInfos
     */
    private $cruiseItinInfos = null;
    ...
    public function setSelectedSailing(
        \Davispeixoto\OpenTravelAlliance\OTACruiseItineraryDescRS\SelectedSailingAType $selectedSailing
    ) {
     ...
     * @return boolean
     */
    public function issetCruiseItinInfos($index)
    {
        return isset($this->cruiseItinInfos[$index]);
    }

    /**
     * unset cruiseItinInfos
     *
     * A collection of cruise itinerary infos.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetCruiseItinInfos($index)
    {
        unset($this->cruiseItinInfos[$index]);
    }

    /**
     * Gets as cruiseItinInfos
     *
     * A collection of cruise itinerary infos.
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTACruiseItineraryDescRS\CruiseItinInfosAType\CruiseItinInfoAType[]
     */
    public function getCruiseItinInfos()
    {
        return $this->cruiseItinInfos;
    }

    /**
     * Sets a new cruiseItinInfos
     *
     * A collection of cruise itinerary infos.
     *
     * @param
     ...
     * @return self
     */
    public function setCruiseItinInfos(array $cruiseItinInfos)
    {
        $this->cruiseItinInfos = $cruiseItinInfos;
