...
/**
 * Class representing OTAHotelAvailNotifRQ
 */
class OTAHotelAvailNotifRQ
{
     ...
     * each AvailStatusMessageRQ, (i.e. the entire message) for tracing of
     * transactions.
     *
    ...
    /**
     * Container for the individual AvailStatusMessage(s). An OTA_HotelAvailNotifRQ
     * contains the availability statuses for a single hotel. Hotel identification
     * information are the attributes of this element.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelAvailNotifRQ\AvailStatusMessagesAType
     * $availStatusMessages
     */
    ...
    public function setAvailStatusMessages(
        \Davispeixoto\OpenTravelAlliance\OTAHotelAvailNotifRQ\AvailStatusMessagesAType $availStatusMessages
    ) {
