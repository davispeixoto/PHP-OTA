...
namespace Davispeixoto\OpenTravelAlliance\OTAVehRateRuleRS\RateRulesAType\PickupReturnRulesAType;

/**
 * Class representing LatestReturnAType
 */
class LatestReturnAType
{

    /**
     * The latest day of the week the rental can terminate to qualify for the specific
     * rate.
     *
    ...
    /**
     * The latest time, in conjunction with the DayOfWeek, the rental can terminate to
