...
namespace Davispeixoto\OpenTravelAlliance\OTAVehRateRuleRS\RateRulesAType\NoShowFeeInfoAType;

/**
 * Class representing GracePeriodAType
 *
 * Provides the ability to specify when a no show fee will be charged to a credit
 * card.
 */
class GracePeriodAType
{
