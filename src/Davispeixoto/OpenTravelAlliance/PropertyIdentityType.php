...
/**
 * Class representing PropertyIdentityType
 *
 * Full name or description plus codes for a property.
 * XSD Type: PropertyIdentityType
 */
class PropertyIdentityType
{
    ...
    /**
     * Refer to OpenTravel Code List Property Class Type (PCT). e.g. 3 (Apartment); 20
     * (Hotel).
     *
    ...
    /**
     * A reference to a source of information for the property.
     *
