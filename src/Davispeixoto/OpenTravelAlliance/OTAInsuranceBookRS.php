...
/**
 * Class representing OTAInsuranceBookRS
 */
class OTAInsuranceBookRS
{
    ...
    /**
     * Indicator for successful request processing
     *
    ...
    /**
     * Contains a booking response for a single insurance plan.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAInsuranceBookRS\PlanForBookRSAType[]
     * $planForBookRS
     */
    private $planForBookRS = null;
    ...
    /**
     * Adds as planForBookRS
     *
     * Contains a booking response for a single insurance plan.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAInsuranceBookRS\PlanForBookRSAType
     * $planForBookRS
     */
    public function addToPlanForBookRS(
        \Davispeixoto\OpenTravelAlliance\OTAInsuranceBookRS\PlanForBookRSAType $planForBookRS
    ) {
        $this->planForBookRS[] = $planForBookRS;
     ...
     * @return boolean
     */
    public function issetPlanForBookRS($index)
    {
        return isset($this->planForBookRS[$index]);
    }
     ...
     * @return void
     */
    public function unsetPlanForBookRS($index)
    {
        unset($this->planForBookRS[$index]);
    }

    /**
     * Gets as planForBookRS
     *
     * Contains a booking response for a single insurance plan.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAInsuranceBookRS\PlanForBookRSAType[]
     */
    public function getPlanForBookRS()
    {
        return $this->planForBookRS;
    }

    /**
     * Sets a new planForBookRS
     *
     * Contains a booking response for a single insurance plan.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAInsuranceBookRS\PlanForBookRSAType[]
     ...
     * @return self
     */
    public function setPlanForBookRS(array $planForBookRS)
    {
        $this->planForBookRS = $planForBookRS;
