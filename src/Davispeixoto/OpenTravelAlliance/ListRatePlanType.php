...
/**
 * Class representing ListRatePlanType
 *
 * Rate plan types.Use: This is a string list of enumerations with an "Other_"
 ...
 * XSD Type: List_RatePlanType
 */
class ListRatePlanType
{
