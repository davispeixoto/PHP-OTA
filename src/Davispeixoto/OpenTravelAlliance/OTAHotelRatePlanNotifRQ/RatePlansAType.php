...
class RatePlansAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelRatePlanNotifRQ\RatePlansAType\RatePlanAType[]
     * $ratePlan
     */
    ...
    public function addToRatePlan(
        \Davispeixoto\OpenTravelAlliance\OTAHotelRatePlanNotifRQ\RatePlansAType\RatePlanAType $ratePlan
    ) {
