...
/**
 * Class representing OTAAirAvailRS
 */
class OTAAirAvailRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirAvailRS\OriginDestinationInformationAType[]
    ...
    public function addToOriginDestinationInformation(
        \Davispeixoto\OpenTravelAlliance\OTAAirAvailRS\OriginDestinationInformationAType $originDestinationInformation
    ) {
