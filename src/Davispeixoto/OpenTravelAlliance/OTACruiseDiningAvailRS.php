...
/**
 * Class representing OTACruiseDiningAvailRS
 */
class OTACruiseDiningAvailRS
{
     ...
     * $diningOption
     */
    public function addToDiningOptions(
     ...
     * @return boolean
     */
    public function issetDiningOptions($index)
    {
        return isset($this->diningOptions[$index]);
    }
     ...
     * @return void
     */
    public function unsetDiningOptions($index)
    {
        unset($this->diningOptions[$index]);
    }

    /**
     * Gets as diningOptions
     *
     * Contains the list of proposed dining options.
     *
     * @return
     ...
     * @return self
     */
    public function setDiningOptions(array $diningOptions)
    {
