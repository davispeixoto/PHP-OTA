...
class OTAHotelGetMsgRS
{
    ...
    /**
     * @property \Davispeixoto\OpenTravelAlliance\MessageType[] $messages
     */
     ...
     */
    public function addToMessages(\Davispeixoto\OpenTravelAlliance\MessageType $message)
    {
     ...
     * Sets a new messages
     *
     * @param \Davispeixoto\OpenTravelAlliance\MessageType[] $messages
     * @return self
     */
