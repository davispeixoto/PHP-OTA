...
/**
 * Class representing OTAProfileMergeRQ
 */
class OTAProfileMergeRQ
{
    ...
    /**
     * Identifies the profile for which information is being merged from the profiles
     * identified by the ObsoleteProfileID together with the owner of the profile or an
