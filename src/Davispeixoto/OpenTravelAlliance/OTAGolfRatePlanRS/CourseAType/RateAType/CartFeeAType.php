...
/**
 * Class representing CartFeeAType
 */
class CartFeeAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGolfRatePlanRS\CourseAType\RateAType\CartFeeAType\CalculationAType[]
     * $calculation
     */
    ...
    public function addToCalculation(
        \Davispeixoto\OpenTravelAlliance\OTAGolfRatePlanRS\CourseAType\RateAType\CartFeeAType\CalculationAType $calculation
    ) {
