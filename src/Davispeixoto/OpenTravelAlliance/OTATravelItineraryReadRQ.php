...
/**
 * Class representing OTATravelItineraryReadRQ
 */
class OTATravelItineraryReadRQ
{
    ...
    /**
     * A unique identifier by which to reference the travel itinerary.
     *
    ...
    /**
     * This is to be used for verification that the record to be returned is the
