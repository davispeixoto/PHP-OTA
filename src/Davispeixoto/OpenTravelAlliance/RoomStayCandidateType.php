...
class RoomStayCandidateType
{
    ...
    /**
     * This element is used to pass room attributes. Typical attributes are smoking,
     * non-smoking, wheelchair access, room location (low floor, high floor, close to
     * elevator, etc) and view (garden, pool, ocean, etc.)
     *
