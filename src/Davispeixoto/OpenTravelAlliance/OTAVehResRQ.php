...
/**
 * Class representing OTAVehResRQ
 */
class OTAVehResRQ
{
     ...
     * reservation of a rental vehicle.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAVehResRQ\VehResRQCoreAType
     * $vehResRQCore
     */
    private $vehResRQCore = null;

    /**
     * Identifies the supplemental information associated with the request for the
     * reservation of a rental vehicle.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAVehResRQ\VehResRQInfoAType
     * $vehResRQInfo
     */
    private $vehResRQInfo = null;

    /**
     * Information about an independent charitable donation made with the vehicle
     * booking.
     *
    ...
    /**
     * Gets as vehResRQCore
     *
     * Identifies the common, or core, information associated with the request for the
     * reservation of a rental vehicle.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAVehResRQ\VehResRQCoreAType
     */
    ...
    /**
     * Sets a new vehResRQCore
     *
     * Identifies the common, or core, information associated with the request for the
     * reservation of a rental vehicle.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAVehResRQ\VehResRQCoreAType
     * $vehResRQCore
     * @return self
     */
    public function setVehResRQCore(\Davispeixoto\OpenTravelAlliance\OTAVehResRQ\VehResRQCoreAType $vehResRQCore)
    {
    ...
    /**
     * Gets as vehResRQInfo
     *
     * Identifies the supplemental information associated with the request for the
     * reservation of a rental vehicle.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAVehResRQ\VehResRQInfoAType
     */
    ...
    /**
     * Sets a new vehResRQInfo
     *
     * Identifies the supplemental information associated with the request for the
     * reservation of a rental vehicle.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAVehResRQ\VehResRQInfoAType
     * $vehResRQInfo
     * @return self
     */
    public function setVehResRQInfo(\Davispeixoto\OpenTravelAlliance\OTAVehResRQ\VehResRQInfoAType $vehResRQInfo)
    {
