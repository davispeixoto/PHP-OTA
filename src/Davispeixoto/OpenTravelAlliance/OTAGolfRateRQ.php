...
/**
 * Class representing OTAGolfRateRQ
 */
class OTAGolfRateRQ
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAGolfRateRQ\ProcessingInfoAType
     * $processingInfo
     */
    private $processingInfo = null;

    /**
     * Provides the criteria to identify the rate(s) to be returned.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAGolfRateRQ\RatePlanCriteriaAType[]
     * $ratePlanCriteria
     */
    private $ratePlanCriteria = null;
     ...
     * default to the value in POS/Source/@ISOCurrency.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAGolfRateRQ\ProcessingInfoAType
     */
     ...
     * default to the value in POS/Source/@ISOCurrency.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfRateRQ\ProcessingInfoAType
     * $processingInfo
     * @return self
     */
    public function setProcessingInfo(
        \Davispeixoto\OpenTravelAlliance\OTAGolfRateRQ\ProcessingInfoAType $processingInfo
    ) {
    ...
    /**
     * Adds as ratePlanCriteria
     *
     * Provides the criteria to identify the rate(s) to be returned.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfRateRQ\RatePlanCriteriaAType
     * $ratePlanCriteria
     */
    public function addToRatePlanCriteria(
        \Davispeixoto\OpenTravelAlliance\OTAGolfRateRQ\RatePlanCriteriaAType $ratePlanCriteria
    ) {
        $this->ratePlanCriteria[] = $ratePlanCriteria;

        return $this;
    }

    /**
     * isset ratePlanCriteria
     *
     * Provides the criteria to identify the rate(s) to be returned.
     *
     * @param scalar $index
     * @return boolean
     */
    public function issetRatePlanCriteria($index)
    {
        return isset($this->ratePlanCriteria[$index]);
    }

    /**
     * unset ratePlanCriteria
     *
     * Provides the criteria to identify the rate(s) to be returned.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetRatePlanCriteria($index)
    {
        unset($this->ratePlanCriteria[$index]);
    }

    /**
     * Gets as ratePlanCriteria
     *
     * Provides the criteria to identify the rate(s) to be returned.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAGolfRateRQ\RatePlanCriteriaAType[]
     */
    public function getRatePlanCriteria()
    {
        return $this->ratePlanCriteria;
    }

    /**
     * Sets a new ratePlanCriteria
     *
     * Provides the criteria to identify the rate(s) to be returned.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfRateRQ\RatePlanCriteriaAType[]
     ...
     * @return self
     */
    public function setRatePlanCriteria(array $ratePlanCriteria)
    {
        $this->ratePlanCriteria = $ratePlanCriteria;
