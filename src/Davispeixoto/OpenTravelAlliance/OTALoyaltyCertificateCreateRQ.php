...
/**
 * Class representing OTALoyaltyCertificateCreateRQ
 */
class OTALoyaltyCertificateCreateRQ
{
    ...
    /**
     * This identifies the party making the request. Trading partners are able to
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTALoyaltyCertificateCreateRQ\CustomerAType[]
     * $customer
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTALoyaltyCertificateCreateRQ\TravelInfosAType
     * $travelInfos
     */
    ...
    public function addToCustomer(
        \Davispeixoto\OpenTravelAlliance\OTALoyaltyCertificateCreateRQ\CustomerAType $customer
    ) {
     ...
     * @return self
     */
    public function setTravelInfos(
        \Davispeixoto\OpenTravelAlliance\OTALoyaltyCertificateCreateRQ\TravelInfosAType $travelInfos
    ) {
