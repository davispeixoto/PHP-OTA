...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelProductRQ;
...
class HotelProductsAType
{
    ...
    /**
     * This may be used for requseting products at multiple hotels or multiple products
     * at a single hotel.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelProductRQ\HotelProductsAType\HotelProductAType[]
     * $hotelProduct
     */
    ...
    public function addToHotelProduct(
        \Davispeixoto\OpenTravelAlliance\OTAHotelProductRQ\HotelProductsAType\HotelProductAType $hotelProduct
    ) {
