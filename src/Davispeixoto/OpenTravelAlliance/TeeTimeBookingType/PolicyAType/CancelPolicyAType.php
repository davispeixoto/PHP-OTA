...
namespace Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType;

/**
 * Class representing CancelPolicyAType
 */
class CancelPolicyAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\CancelPolicyAType\DeadlineAType
     * $deadline
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\CancelPolicyAType\AmountPercentAType
     * $amountPercent
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\CancelPolicyAType\GuaranteeAcceptedAType[]
     * $guaranteeAccepted
     */
    ...
    public function setDeadline(
        \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\CancelPolicyAType\DeadlineAType $deadline
    ) {
    ...
    public function setAmountPercent(
        \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\CancelPolicyAType\AmountPercentAType $amountPercent
    ) {
    ...
    public function addToGuaranteeAccepted(
        \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\CancelPolicyAType\GuaranteeAcceptedAType $guaranteeAccepted
    ) {
