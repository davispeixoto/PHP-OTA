...
class PolicyAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\GeneralAType
     * $general
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\CancelPolicyAType
     * $cancelPolicy
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\TaxPolicyAType[]
     * $taxPolicy
     */
     ...
     * @return self
     */
    public function setGeneral(\Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\GeneralAType $general)
    {
    ...
    public function setCancelPolicy(
        \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\CancelPolicyAType $cancelPolicy
    ) {
    ...
    public function addToTaxPolicy(
        \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType\TaxPolicyAType $taxPolicy
    ) {
