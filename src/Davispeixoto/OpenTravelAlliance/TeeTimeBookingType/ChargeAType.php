...
class ChargeAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\ChargeAType\CalculationAType[]
     * $calculation
     */
    ...
    public function addToCalculation(
        \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\ChargeAType\CalculationAType $calculation
    ) {
