...
/**
 * Class representing OTAAirLowFareSearchRS
 */
class OTAAirLowFareSearchRS
{
    ...
    /**
     * Successfull Low Fare priced itineraries in response to a Low Fare Search
     * request.
     *
     * @property
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\AirOfferChoiceType $offers
     */
    private $offers = null;
     ...
     * Merchandising offers.
     *
     * @param \Davispeixoto\OpenTravelAlliance\AirOfferChoiceType $offers
     * @return self
     */
    public function setOffers(\Davispeixoto\OpenTravelAlliance\AirOfferChoiceType $offers)
    {
        $this->offers = $offers;
