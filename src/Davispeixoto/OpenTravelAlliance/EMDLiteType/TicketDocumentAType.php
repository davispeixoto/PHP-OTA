...
class TicketDocumentAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\EMDLiteType\TicketDocumentAType\CouponInfoAType[]
     * $couponInfo
     */
    ...
    public function addToCouponInfo(
        \Davispeixoto\OpenTravelAlliance\EMDLiteType\TicketDocumentAType\CouponInfoAType $couponInfo
    ) {
