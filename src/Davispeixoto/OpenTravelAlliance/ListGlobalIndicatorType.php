...
/**
 * Class representing ListGlobalIndicatorType
 *
 * Global travel area identifiers.Use: This is a string list of enumerations with
 ...
 * XSD Type: List_GlobalIndicatorType
 */
class ListGlobalIndicatorType
{
