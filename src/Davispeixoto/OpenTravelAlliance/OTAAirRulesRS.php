...
/**
 * Class representing OTAAirRulesRS
 */
class OTAAirRulesRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirRulesRS\FareRuleResponseInfoAType[]
     * $fareRuleResponseInfo
     */
    private $fareRuleResponseInfo = null;
    ...
    /**
     * Adds as fareRuleResponseInfo
     *
     * Provides fare rules and the applicable fare rule categories.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirRulesRS\FareRuleResponseInfoAType
     * $fareRuleResponseInfo
     */
    public function addToFareRuleResponseInfo(
        \Davispeixoto\OpenTravelAlliance\OTAAirRulesRS\FareRuleResponseInfoAType $fareRuleResponseInfo
    ) {
        $this->fareRuleResponseInfo[] = $fareRuleResponseInfo;

        return $this;
    }

    /**
     * isset fareRuleResponseInfo
     *
     * Provides fare rules and the applicable fare rule categories.
     *
     * @param scalar $index
     * @return boolean
     */
    public function issetFareRuleResponseInfo($index)
    {
        return isset($this->fareRuleResponseInfo[$index]);
    }

    /**
     * unset fareRuleResponseInfo
     *
     * Provides fare rules and the applicable fare rule categories.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetFareRuleResponseInfo($index)
    {
        unset($this->fareRuleResponseInfo[$index]);
    }

    /**
     * Gets as fareRuleResponseInfo
     *
     * Provides fare rules and the applicable fare rule categories.
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTAAirRulesRS\FareRuleResponseInfoAType[]
     */
    public function getFareRuleResponseInfo()
    {
        return $this->fareRuleResponseInfo;
    }

    /**
     * Sets a new fareRuleResponseInfo
     *
     * Provides fare rules and the applicable fare rule categories.
     *
     * @param
     ...
     * @return self
     */
    public function setFareRuleResponseInfo(array $fareRuleResponseInfo)
    {
        $this->fareRuleResponseInfo = $fareRuleResponseInfo;
