...
/**
 * Class representing OTARailConfirmBookingRS
 */
class OTARailConfirmBookingRS
{
    ...
    /**
     * The PNR locator list for the provisional reservations that are now confirmed as
     * booked.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailConfirmBookingRS\ConfirmationAType[]
     * $confirmation
     */
    ...
    public function addToConfirmation(
        \Davispeixoto\OpenTravelAlliance\OTARailConfirmBookingRS\ConfirmationAType $confirmation
    ) {
