...
/**
 * Class representing OTACruiseBookingDocumentRQ
 */
class OTACruiseBookingDocumentRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseBookingDocumentRQ\CruiseDocumentAType[]
     * $cruiseDocument
     */
    ...
    public function addToCruiseDocument(
        \Davispeixoto\OpenTravelAlliance\OTACruiseBookingDocumentRQ\CruiseDocumentAType $cruiseDocument
    ) {
