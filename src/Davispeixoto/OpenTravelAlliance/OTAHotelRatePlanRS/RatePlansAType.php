...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelRatePlanRS;
...
class RatePlansAType
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\HotelRatePlanType[] $ratePlan
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\HotelRatePlanType $ratePlan
     */
    public function addToRatePlan(\Davispeixoto\OpenTravelAlliance\HotelRatePlanType $ratePlan)
    {
     ...
     * An individual rate plan.
     *
     * @return \Davispeixoto\OpenTravelAlliance\HotelRatePlanType[]
     */
