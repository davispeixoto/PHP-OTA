...
/**
 * Class representing OTAAuthorizationRQ
 */
class OTAAuthorizationRQ
{
    ...
    /**
     * Information with which the traveler's identification is verified and/or charges
     * are authorized.
     *
     ...
     */
    public function addToAuthorizationDetail(\Davispeixoto\OpenTravelAlliance\AuthorizationType $authorizationDetail)
    {
     ...
     * @return boolean
     */
    public function issetAuthorizationDetail($index)
    {
        return isset($this->authorizationDetail[$index]);
    }

    /**
     * unset authorizationDetail
     *
     * Information with which the traveler's identification is verified and/or charges
     * are authorized.
     *
     ...
     * @return void
     */
    public function unsetAuthorizationDetail($index)
    {
        unset($this->authorizationDetail[$index]);
    }
     ...
     * @return self
     */
    public function setAuthorizationDetail(array $authorizationDetail)
    {
        $this->authorizationDetail = $authorizationDetail;
