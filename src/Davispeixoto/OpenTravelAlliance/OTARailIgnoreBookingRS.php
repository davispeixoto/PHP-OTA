...
/**
 * Class representing OTARailIgnoreBookingRS
 */
class OTARailIgnoreBookingRS
{
    ...
    /**
     * The Unique ID's and other details for the provisional reservation(s) that have
     * been cancelled.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailIgnoreBookingRS\ConfirmationAType[]
     * $confirmation
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTARailIgnoreBookingRS\ConfirmationAType
     * $confirmation
     */
    public function addToConfirmation(
        \Davispeixoto\OpenTravelAlliance\OTARailIgnoreBookingRS\ConfirmationAType $confirmation
    ) {
