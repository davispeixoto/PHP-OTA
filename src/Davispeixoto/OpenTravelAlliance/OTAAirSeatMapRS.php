...
/**
 * Class representing OTAAirSeatMapRS
 */
class OTAAirSeatMapRS
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAAirSeatMapRS\SeatMapResponsesAType
     * $seatMapResponses
     */
    private $seatMapResponses = null;
    ...
    /**
     * Gets as seatMapResponses
     *
     * Seat map response element containing the results of the request.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAAirSeatMapRS\SeatMapResponsesAType
     */
    ...
    /**
     * Sets a new seatMapResponses
     *
     * Seat map response element containing the results of the request.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirSeatMapRS\SeatMapResponsesAType
     * $seatMapResponses
     * @return self
     */
    public function setSeatMapResponses(
        \Davispeixoto\OpenTravelAlliance\OTAAirSeatMapRS\SeatMapResponsesAType $seatMapResponses
    ) {
