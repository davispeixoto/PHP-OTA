...
/**
 * Class representing PassengerTypeQuantityType
 *
 * Specifies a PTC and the associated number of PTC's - for use in specifying
 * passenger lists.
 * XSD Type: PassengerTypeQuantityType
 */
