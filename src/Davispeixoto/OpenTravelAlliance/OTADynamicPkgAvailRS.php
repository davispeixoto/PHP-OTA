...
/**
 * Class representing OTADynamicPkgAvailRS
 */
class OTADynamicPkgAvailRS
{
    ...
    /**
     * Contains the availability and pricing for each vacation component specified in
     * the request.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTADynamicPkgAvailRS\SearchResultsAType
     * $searchResults
     */
    ...
    /**
     * Gets as searchResults
     *
     * Contains the availability and pricing for each vacation component specified in
     * the request.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTADynamicPkgAvailRS\SearchResultsAType
     */
    ...
    /**
     * Sets a new searchResults
     *
     * Contains the availability and pricing for each vacation component specified in
     * the request.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTADynamicPkgAvailRS\SearchResultsAType
     * $searchResults
     * @return self
     */
    public function setSearchResults(
        \Davispeixoto\OpenTravelAlliance\OTADynamicPkgAvailRS\SearchResultsAType $searchResults
    ) {
