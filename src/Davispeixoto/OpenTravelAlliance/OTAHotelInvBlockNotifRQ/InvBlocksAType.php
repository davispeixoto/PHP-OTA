...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockNotifRQ;
...
class InvBlocksAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockNotifRQ\InvBlocksAType\HotelRefAType
     * $hotelRef
     */
    private $hotelRef = null;

    /**
     * This is used to indicate the date or date range applicable to all inventory
     * blocks in this message.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockNotifRQ\InvBlocksAType\InvBlockDatesAType
     * $invBlockDates
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockNotifRQ\InvBlocksAType\InvBlockAType[]
     * $invBlock
     */
    ...
    public function setHotelRef(
        \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockNotifRQ\InvBlocksAType\HotelRefAType $hotelRef
    ) {
     ...
     * @return self
     */
    public function setInvBlockDates(
        \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockNotifRQ\InvBlocksAType\InvBlockDatesAType $invBlockDates
    ) {
     ...
     * $invBlock
     */
    public function addToInvBlock(
        \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockNotifRQ\InvBlocksAType\InvBlockAType $invBlock
    ) {
