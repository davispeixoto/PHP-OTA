...
/**
 * Class representing TotalPriceAType
 */
class TotalPriceAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirBaggageRS\AllowanceAndChargeAType\TotalPriceAType\RedemptionPointsAType
     * $redemptionPoints
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirBaggageRS\AllowanceAndChargeAType\TotalPriceAType\PricingQualifierAType
     * $pricingQualifier
     */
     ...
     * @return self
     */
    public function setRedemptionPoints(
        \Davispeixoto\OpenTravelAlliance\OTAAirBaggageRS\AllowanceAndChargeAType\TotalPriceAType\RedemptionPointsAType $redemptionPoints
    ) {
    ...
    public function setPricingQualifier(
        \Davispeixoto\OpenTravelAlliance\OTAAirBaggageRS\AllowanceAndChargeAType\TotalPriceAType\PricingQualifierAType $pricingQualifier
    ) {
