...
class PricingQualifierAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirBaggageRS\AllowanceAndChargeAType\TotalPriceAType\PricingQualifierAType\NegotiatedFareAType
     * $negotiatedFare
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirBaggageRS\AllowanceAndChargeAType\TotalPriceAType\PricingQualifierAType\OriginalIssueInfoAType
     * $originalIssueInfo
     */
    ...
    public function setNegotiatedFare(
        \Davispeixoto\OpenTravelAlliance\OTAAirBaggageRS\AllowanceAndChargeAType\TotalPriceAType\PricingQualifierAType\NegotiatedFareAType $negotiatedFare
    ) {
    ...
    public function setOriginalIssueInfo(
        \Davispeixoto\OpenTravelAlliance\OTAAirBaggageRS\AllowanceAndChargeAType\TotalPriceAType\PricingQualifierAType\OriginalIssueInfoAType $originalIssueInfo
    ) {
