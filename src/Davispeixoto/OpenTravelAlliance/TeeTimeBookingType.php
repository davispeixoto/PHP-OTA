...
/**
 * Class representing TeeTimeBookingType
 *
 * Information associated with a reserved single round of golf.
 * XSD Type: TeeTimeBookingType
 */
class TeeTimeBookingType
{
    ...
    /**
     * Reservation ID and supporting information from the booking system.
     *
     ...
     * is associated with.
     *
     * @property \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\ChargeAType[]
     * $charge
     */
    private $charge = null;
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PaymentFormAType[]
     * $paymentForm
     */
     ...
     * whole.
     *
     * @property \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\DiscountsAType[]
     * $discounts
     */
    private $discounts = null;

    /**
     * Amenities applied to this tee time round. Note that amenities may be tied to
     * individual golfers or to the tee time as a whole.
     *
     * @property \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\AmenityAType[]
     * $amenity
     */
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType[]
     * $policy
     */
    private $policy = null;
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\ChargeAType $charge
     */
    public function addToCharge(\Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\ChargeAType $charge)
    {
        $this->charge[] = $charge;
     ...
     * is associated with.
     *
     * @return \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\ChargeAType[]
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PaymentFormAType
     * $paymentForm
     */
    public function addToPaymentForm(\Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PaymentFormAType $paymentForm)
    {
     ...
     * individually associated with one or more charges.
     *
     * @return \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PaymentFormAType[]
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\DiscountsAType
     * $discounts
     */
    public function addToDiscounts(\Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\DiscountsAType $discounts)
    {
     ...
     * whole.
     *
     * @return \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\DiscountsAType[]
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\AmenityAType $amenity
     */
    public function addToAmenity(\Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\AmenityAType $amenity)
    {
     ...
     * individual golfers or to the tee time as a whole.
     *
     * @return \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\AmenityAType[]
     */
     ...
     * individual golfers or to the tee time as a whole.
     *
     * @param \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\AmenityAType[]
     * $amenity
     * @return self
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType $policy
     */
    public function addToPolicy(\Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType $policy)
    {
        $this->policy[] = $policy;
     ...
     * Describes the policies of the tee time round, such as cancellation.
     *
     * @return \Davispeixoto\OpenTravelAlliance\TeeTimeBookingType\PolicyAType[]
     */
