...
/**
 * Class representing ListTravelPurposeType
 *
 * Travel purpose types.Use: This is a string list of enumerations with an "Other_"
 ...
 * XSD Type: List_TravelPurpose
 */
class ListTravelPurposeType
{
