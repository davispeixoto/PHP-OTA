...
class AvailabilityDetailAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailShopRS\OriginDestinationInformationAType\OriginDestinationOptionAType\JourneySegmentAType\AvailabilityDetailAType\ClassCodeAType
     * $classCode
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailShopRS\OriginDestinationInformationAType\OriginDestinationOptionAType\JourneySegmentAType\AvailabilityDetailAType\AccommodationAType
     * $accommodation
     */
     ...
     * @return self
     */
    public function setPricing(\Davispeixoto\OpenTravelAlliance\RailPriceType $pricing)
    {
    ...
    public function setClassCode(
        \Davispeixoto\OpenTravelAlliance\OTARailShopRS\OriginDestinationInformationAType\OriginDestinationOptionAType\JourneySegmentAType\AvailabilityDetailAType\ClassCodeAType $classCode
    ) {
    ...
    public function setAccommodation(
        \Davispeixoto\OpenTravelAlliance\OTARailShopRS\OriginDestinationInformationAType\OriginDestinationOptionAType\JourneySegmentAType\AvailabilityDetailAType\AccommodationAType $accommodation
    ) {
