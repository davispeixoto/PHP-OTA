...
/**
 * Class representing OTACruisePaymentRS
 */
class OTACruisePaymentRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruisePaymentRS\ReservationPaymentAType[]
     * $reservationPayment
     */
    ...
    public function addToReservationPayment(
        \Davispeixoto\OpenTravelAlliance\OTACruisePaymentRS\ReservationPaymentAType $reservationPayment
    ) {
