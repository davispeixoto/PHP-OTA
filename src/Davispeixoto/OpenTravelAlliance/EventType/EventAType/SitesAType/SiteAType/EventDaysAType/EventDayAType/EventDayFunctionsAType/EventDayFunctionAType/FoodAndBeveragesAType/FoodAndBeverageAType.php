...
namespace Davispeixoto\OpenTravelAlliance\EventType\EventAType\SitesAType\SiteAType\EventDaysAType\EventDayAType\EventDayFunctionsAType\EventDayFunctionAType\FoodAndBeveragesAType;
...
class FoodAndBeverageAType
{
    ...
    /**
     * The time or date and time when food and beverage will be served.
     *
    ...
    /**
     * The anticipated number of people to be served.
     *
