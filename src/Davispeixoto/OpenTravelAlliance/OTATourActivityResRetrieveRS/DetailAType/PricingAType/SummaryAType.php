...
class SummaryAType extends TourActivityChargeType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\PricingAType\SummaryAType\PricingTypeAType
     * $pricingType
     */
    ...
    public function setPricingType(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\PricingAType\SummaryAType\PricingTypeAType $pricingType
    ) {
