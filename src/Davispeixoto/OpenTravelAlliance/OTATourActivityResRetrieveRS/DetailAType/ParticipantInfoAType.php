...
class ParticipantInfoAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\ParticipantInfoAType\CategoryAType
     * $category
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\ParticipantInfoAType\GroupAType
     * $group
     */
    private $group = null;
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\ParticipantInfoAType\IndividualAType
     * $individual
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\ParticipantInfoAType\LodgingInfoAType
     * $lodgingInfo
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\ParticipantInfoAType\SpecialNeedAType[]
     * $specialNeed
     */
    ...
    public function setCategory(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\ParticipantInfoAType\CategoryAType $category
    ) {
    ...
    public function setGroup(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\ParticipantInfoAType\GroupAType $group
    ) {
        $this->group = $group;
    ...
    public function setIndividual(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\ParticipantInfoAType\IndividualAType $individual
    ) {
    ...
    public function setLodgingInfo(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\ParticipantInfoAType\LodgingInfoAType $lodgingInfo
    ) {
    ...
    public function addToSpecialNeed(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\ParticipantInfoAType\SpecialNeedAType $specialNeed
    ) {
