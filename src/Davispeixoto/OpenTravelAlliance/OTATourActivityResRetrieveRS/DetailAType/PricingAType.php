...
class PricingAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\PricingAType\SummaryAType
     * $summary
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\PricingAType\ParticipantCategoryAType[]
     * $participantCategory
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\PricingAType\GroupAType[]
     * $group
     */
    private $group = null;
    ...
    public function setSummary(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\PricingAType\SummaryAType $summary
    ) {
    ...
    public function addToParticipantCategory(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\PricingAType\ParticipantCategoryAType $participantCategory
    ) {
    ...
    public function addToGroup(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityResRetrieveRS\DetailAType\PricingAType\GroupAType $group
    ) {
        $this->group[] = $group;
