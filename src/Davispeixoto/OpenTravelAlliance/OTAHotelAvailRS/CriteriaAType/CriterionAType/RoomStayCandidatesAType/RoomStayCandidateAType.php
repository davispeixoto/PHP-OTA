...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelAvailRS\CriteriaAType\CriterionAType\RoomStayCandidatesAType;
...
class RoomStayCandidateAType
{
    ...
    /**
     * The BedTypeCode MUST Indicate the type of bed(s) for the availability request.
    ...
    /**
     * When true, indicates that only non-smoking rooms SHOULD be returned in the
