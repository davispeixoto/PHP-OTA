...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelAvailRS\CriteriaAType\CriterionAType\RoomStayCandidatesAType\RoomStayCandidateAType\GuestCountsAType;
...
class GuestCountAType
{
    ...
    /**
     * Age MAY be used to specify the age of the guest(s). This MAY be used to
     * calculate additional person fees by guest age.
     *
