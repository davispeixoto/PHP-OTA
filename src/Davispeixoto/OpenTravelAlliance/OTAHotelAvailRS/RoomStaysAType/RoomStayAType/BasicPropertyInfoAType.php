...
class BasicPropertyInfoAType
{
     ...
     * availability was performed. The HotelCode MAY be used in conjunction with the
     * ChainCode and BrandCode in order to uniquely identify the hotel property. The
