...
/**
 * Class representing OTAFileAttachmentNotifRQ
 */
class OTAFileAttachmentNotifRQ
{
    ...
    /**
     * Details about the file(s) attached to this message.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAFileAttachmentNotifRQ\FileAttachmentReferencesAType
     * $fileAttachmentReferences
     */
    private $fileAttachmentReferences = null;
    ...
    /**
     * Gets as fileAttachmentReferences
     *
     * Details about the file(s) attached to this message.
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTAFileAttachmentNotifRQ\FileAttachmentReferencesAType
     */
    public function getFileAttachmentReferences()
    {
        return $this->fileAttachmentReferences;
    }

    /**
     * Sets a new fileAttachmentReferences
     *
     * Details about the file(s) attached to this message.
     *
     * @param
     ...
     * @return self
     */
    public function setFileAttachmentReferences(
        \Davispeixoto\OpenTravelAlliance\OTAFileAttachmentNotifRQ\FileAttachmentReferencesAType $fileAttachmentReferences
    ) {
        $this->fileAttachmentReferences = $fileAttachmentReferences;
