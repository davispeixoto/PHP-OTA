...
/**
 * Class representing OTAAirDemandTicketRQ
 */
class OTAAirDemandTicketRQ
{
    ...
    /**
     * Specifies the information necessary for the issuer of the ticket to issue the
     * ticket.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRQ\DemandTicketDetailAType
     * $demandTicketDetail
     */
    private $demandTicketDetail = null;
     ...
     * \Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRQ\DemandTicketDetailAType
     */
    public function getDemandTicketDetail()
    {
        return $this->demandTicketDetail;
    }

    /**
     * Sets a new demandTicketDetail
     *
     * Specifies the information necessary for the issuer of the ticket to issue the
     * ticket.
     *
     ...
     * @return self
     */
    public function setDemandTicketDetail(
        \Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRQ\DemandTicketDetailAType $demandTicketDetail
    ) {
