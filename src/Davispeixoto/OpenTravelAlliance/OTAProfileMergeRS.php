...
/**
 * Class representing OTAProfileMergeRS
 */
class OTAProfileMergeRS
{
    ...
    /**
     * A successfully processed OpenTravel message, but one in which warnings are
     * generated.
     *
    ...
    /**
     * Used to convey the identity of the merged profile, the owner of the profile, or
    ...
    /**
     * Contains the UniqueID of a profile that was merged.
     *
     * @property \Davispeixoto\OpenTravelAlliance\UniqueIDType[] $obsoleteProfileID
     */
    private $obsoleteProfileID = null;
    ...
    /**
     * Adds as obsoleteProfileID
     *
     * Contains the UniqueID of a profile that was merged.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\UniqueIDType $obsoleteProfileID
     */
    public function addToObsoleteProfileID(\Davispeixoto\OpenTravelAlliance\UniqueIDType $obsoleteProfileID)
    {
        $this->obsoleteProfileID[] = $obsoleteProfileID;

        return $this;
    }

    /**
     * isset obsoleteProfileID
     *
     * Contains the UniqueID of a profile that was merged.
     *
     * @param scalar $index
     * @return boolean
     */
    public function issetObsoleteProfileID($index)
    {
        return isset($this->obsoleteProfileID[$index]);
    }

    /**
     * unset obsoleteProfileID
     *
     * Contains the UniqueID of a profile that was merged.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetObsoleteProfileID($index)
    {
        unset($this->obsoleteProfileID[$index]);
    }

    /**
     * Gets as obsoleteProfileID
     *
     * Contains the UniqueID of a profile that was merged.
     *
     * @return \Davispeixoto\OpenTravelAlliance\UniqueIDType[]
     */
    public function getObsoleteProfileID()
    {
        return $this->obsoleteProfileID;
    }

    /**
     * Sets a new obsoleteProfileID
     *
     * Contains the UniqueID of a profile that was merged.
     *
     * @param \Davispeixoto\OpenTravelAlliance\UniqueIDType[] $obsoleteProfileID
     * @return self
     */
    public function setObsoleteProfileID(array $obsoleteProfileID)
    {
        $this->obsoleteProfileID = $obsoleteProfileID;
