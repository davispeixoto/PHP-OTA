...
/**
 * Class representing OTAInsurancePlanSearchRS
 */
class OTAInsurancePlanSearchRS
{
     ...
     * $availablePlan
     */
    public function addToAvailablePlans(
     ...
     * @return boolean
     */
    public function issetAvailablePlans($index)
    {
        return isset($this->availablePlans[$index]);
    }

    /**
     * unset availablePlans
     *
     * Collection of plan that meet the search request requirements.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetAvailablePlans($index)
    {
        unset($this->availablePlans[$index]);
    }

    /**
     * Gets as availablePlans
     *
     * Collection of plan that meet the search request requirements.
     *
     * @return
     ...
     * @return self
     */
    public function setAvailablePlans(array $availablePlans)
    {
