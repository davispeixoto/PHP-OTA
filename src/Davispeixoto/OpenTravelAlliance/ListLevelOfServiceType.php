...
/**
 * Class representing ListLevelOfServiceType
 *
 * Service levels.Use: This is a string list of enumerations with an "Other_"
 ...
 * XSD Type: List_LevelOfService
 */
class ListLevelOfServiceType
{
