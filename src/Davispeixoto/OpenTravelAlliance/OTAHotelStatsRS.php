...
/**
 * Class representing OTAHotelStatsRS
 */
class OTAHotelStatsRS
{
    ...
    /**
     * Used to specify information on the organization providing the statistical data.
     *
    ...
    /**
     * Collection of Statistic elements, one for each report being returned.
     *
     * @property \Davispeixoto\OpenTravelAlliance\StatisticType[] $statistics
     */
     ...
     * @return self
     */
    public function setWarnings(\Davispeixoto\OpenTravelAlliance\WarningType $warnings)
    {
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\StatisticType $statistic
     */
    public function addToStatistics(\Davispeixoto\OpenTravelAlliance\StatisticType $statistic)
    {
     ...
     * Collection of Statistic elements, one for each report being returned.
     *
     * @return \Davispeixoto\OpenTravelAlliance\StatisticType[]
     */
     ...
     * Collection of Statistic elements, one for each report being returned.
     *
     * @param \Davispeixoto\OpenTravelAlliance\StatisticType[] $statistics
     * @return self
     */
