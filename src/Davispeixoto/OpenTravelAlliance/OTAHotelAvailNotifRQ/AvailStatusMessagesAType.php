...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelAvailNotifRQ;

/**
 * Class representing AvailStatusMessagesAType
 */
class AvailStatusMessagesAType
{
    ...
    /**
     * The AvailStatusMessage. It is here that one indicates whether the inventory is
     * opened, closed, closed on request, etc.The MinMaxLOSStatusMessage class
     * communicates the set of minimum and maximum length-of-stay availability status
     * changes to be synchronized with another system.The RateHurdleStatusMessage class
     * defines the setting for rate hurdle controls to be synchronized with the central
     * reservation system.
     *
     * @property \Davispeixoto\OpenTravelAlliance\AvailStatusMessageType[]
     * $availStatusMessage
     */
    private $availStatusMessage = null;
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\AvailStatusMessageType
     * $availStatusMessage
     */
    public function addToAvailStatusMessage(\Davispeixoto\OpenTravelAlliance\AvailStatusMessageType $availStatusMessage)
    {
     ...
     * @return boolean
     */
    public function issetAvailStatusMessage($index)
    {
        return isset($this->availStatusMessage[$index]);
    }

    /**
     * unset availStatusMessage
     *
     * The AvailStatusMessage. It is here that one indicates whether the inventory is
     * opened, closed, closed on request, etc.The MinMaxLOSStatusMessage class
     * communicates the set of minimum and maximum length-of-stay availability status
     ...
     * @return void
     */
    public function unsetAvailStatusMessage($index)
    {
        unset($this->availStatusMessage[$index]);
    }

    /**
     * Gets as availStatusMessage
     *
     * The AvailStatusMessage. It is here that one indicates whether the inventory is
     * opened, closed, closed on request, etc.The MinMaxLOSStatusMessage class
     * communicates the set of minimum and maximum length-of-stay availability status
     ...
     * reservation system.
     *
     * @return \Davispeixoto\OpenTravelAlliance\AvailStatusMessageType[]
     */
     ...
     * @return self
     */
    public function setAvailStatusMessage(array $availStatusMessage)
    {
        $this->availStatusMessage = $availStatusMessage;
