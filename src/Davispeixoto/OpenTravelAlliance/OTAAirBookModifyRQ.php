...
/**
 * Class representing OTAAirBookModifyRQ
 */
class OTAAirBookModifyRQ
{
    ...
    /**
     * Specifies an action to be taken following the modification of the booking.
     *
    ...
    /**
     * This identifes the party making the modification request. Trading partners are
     * open to define their own UniqueID.
     *
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirBookModifyRQ\AirBookModifyRQAType
     * $airBookModifyRQ
     */
    private $airBookModifyRQ = null;

    /**
     * Contains all booking information of the current reservation, in this case of the
     * reservation which is to be modified.
     *
     * @property \Davispeixoto\OpenTravelAlliance\AirReservationType $airReservation
     */
    ...
    /**
     * Gets as airBookModifyRQ
     *
     * Contains the new value of data which is to be modified.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAAirBookModifyRQ\AirBookModifyRQAType
     */
    public function getAirBookModifyRQ()
    {
        return $this->airBookModifyRQ;
    }

    /**
     * Sets a new airBookModifyRQ
     *
     * Contains the new value of data which is to be modified.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirBookModifyRQ\AirBookModifyRQAType
     * $airBookModifyRQ
     * @return self
     */
    public function setAirBookModifyRQ(
        \Davispeixoto\OpenTravelAlliance\OTAAirBookModifyRQ\AirBookModifyRQAType $airBookModifyRQ
    ) {
     ...
     * reservation which is to be modified.
     *
     * @param \Davispeixoto\OpenTravelAlliance\AirReservationType $airReservation
     * @return self
     */
    public function setAirReservation(\Davispeixoto\OpenTravelAlliance\AirReservationType $airReservation)
    {
