...
/**
 * Class representing OTARailScheduleRQ
 */
class OTARailScheduleRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailScheduleRQ\RailScheduleQueryAType
     * $railScheduleQuery
     */
    private $railScheduleQuery = null;
     ...
     * \Davispeixoto\OpenTravelAlliance\OTARailScheduleRQ\RailScheduleQueryAType
     */
    public function getRailScheduleQuery()
    {
        return $this->railScheduleQuery;
    }

    /**
     * Sets a new railScheduleQuery
     *
     * The search criteria for a rail schedule search request.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTARailScheduleRQ\RailScheduleQueryAType
     * $railScheduleQuery
     * @return self
     */
    public function setRailScheduleQuery(
        \Davispeixoto\OpenTravelAlliance\OTARailScheduleRQ\RailScheduleQueryAType $railScheduleQuery
    ) {
        $this->railScheduleQuery = $railScheduleQuery;
