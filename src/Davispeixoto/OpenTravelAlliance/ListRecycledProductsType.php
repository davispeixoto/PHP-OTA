...
/**
 * Class representing ListRecycledProductsType
 *
 * Recycled products.Use: This is a string list of enumerations with an "Other_"
 ...
 * XSD Type: List_RecycledProducts
 */
class ListRecycledProductsType
{
