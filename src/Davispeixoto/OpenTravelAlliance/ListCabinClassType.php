...
/**
 * Class representing ListCabinClassType
 *
 * Cabin types.Use: This is a string list of enumerations with an "Other_" literal
 ...
 * XSD Type: List_CabinClass
 */
class ListCabinClassType
{
