...
namespace Davispeixoto\OpenTravelAlliance\OTACruiseCabinUnholdRS;
...
class SelectedSailingAType
{
    ...
    /**
     * Cabins for the given sailing, for which release is being requested.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCabinUnholdRS\SelectedSailingAType\SelectedCabinAType[]
     * $selectedCabin
     */
    ...
    public function addToSelectedCabin(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCabinUnholdRS\SelectedSailingAType\SelectedCabinAType $selectedCabin
    ) {
