...
/**
 * Class representing ListChargeFrequencyType
 *
 * Charge units.Use: This is a string list of enumerations with an "Other_" literal
 ...
 * XSD Type: List_ChargeFrequency
 */
class ListChargeFrequencyType
{
