...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelProductNotifRQ;
...
class HotelProductsAType
{
     ...
     * plan, a room type rate plan combination or hotel policy information. This may be
     * used for sending products at multiple hotels or multiple products at a single
     * hotel.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelProductNotifRQ\HotelProductsAType\HotelProductAType[]
     * $hotelProduct
     */
    private $hotelProduct = null;
     ...
     * $hotelProduct
     */
    public function addToHotelProduct(
        \Davispeixoto\OpenTravelAlliance\OTAHotelProductNotifRQ\HotelProductsAType\HotelProductAType $hotelProduct
    ) {
