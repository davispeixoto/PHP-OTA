...
/**
 * Class representing OTARailScheduleRS
 */
class OTARailScheduleRS
{
    ...
    /**
     * The origin location, destination location and train segment information for the
     * rail schedule request.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailScheduleRS\OriginDestinationOptionsAType
     ...
     * @return self
     */
    public function setOriginDestinationOptions(
        \Davispeixoto\OpenTravelAlliance\OTARailScheduleRS\OriginDestinationOptionsAType $originDestinationOptions
    ) {
