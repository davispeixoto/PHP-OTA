...
class RestrictionsAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\GroundReservationType\RestrictionsAType\AdvanceBookingAType
     * $advanceBooking
     */
    ...
    public function setAdvanceBooking(
        \Davispeixoto\OpenTravelAlliance\GroundReservationType\RestrictionsAType\AdvanceBookingAType $advanceBooking
    ) {
