...
/**
 * Class representing OTAAirFlifoRS
 */
class OTAAirFlifoRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirFlifoRS\FlightInfoDetailsAType[]
     * $flightInfoDetails
     */
    private $flightInfoDetails = null;
    ...
    /**
     * Adds as flightInfoDetails
     *
     * A collection of flight information for a flight number.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirFlifoRS\FlightInfoDetailsAType
     * $flightInfoDetails
     */
    public function addToFlightInfoDetails(
        \Davispeixoto\OpenTravelAlliance\OTAAirFlifoRS\FlightInfoDetailsAType $flightInfoDetails
    ) {
     ...
     * @return boolean
     */
    public function issetFlightInfoDetails($index)
    {
        return isset($this->flightInfoDetails[$index]);
    }

    /**
     * unset flightInfoDetails
     *
     * A collection of flight information for a flight number.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetFlightInfoDetails($index)
    {
        unset($this->flightInfoDetails[$index]);
    }

    /**
     * Gets as flightInfoDetails
     *
     * A collection of flight information for a flight number.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAAirFlifoRS\FlightInfoDetailsAType[]
     */
    public function getFlightInfoDetails()
    {
        return $this->flightInfoDetails;
    }

    /**
     * Sets a new flightInfoDetails
     *
     * A collection of flight information for a flight number.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirFlifoRS\FlightInfoDetailsAType[]
     ...
     * @return self
     */
    public function setFlightInfoDetails(array $flightInfoDetails)
    {
        $this->flightInfoDetails = $flightInfoDetails;
