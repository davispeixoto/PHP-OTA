...
/**
 * Class representing OTAGroundAvailRS
 */
class OTAGroundAvailRS
{
     ...
     * @return boolean
     */
    public function issetGroundServices($index)
    {
        return isset($this->groundServices[$index]);
    }

    /**
     * unset groundServices
     *
     * Information about available ground services.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetGroundServices($index)
    {
        unset($this->groundServices[$index]);
    }

    /**
     * Gets as groundServices
     *
     * Information about available ground services.
     *
     * @return
     ...
     * @return self
     */
    public function setGroundServices(array $groundServices)
    {
