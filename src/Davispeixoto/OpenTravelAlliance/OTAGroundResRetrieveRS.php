...
/**
 * Class representing OTAGroundResRetrieveRS
 */
class OTAGroundResRetrieveRS
{
    ...
    /**
     * One or more summary reservations that match specified reservation search
     * criteria.
     *
     * @property \Davispeixoto\OpenTravelAlliance\GroundReservationSummaryType[]
     * $summaryReservation
     */
    private $summaryReservation = null;

    /**
     * One reservation returned if a valid reservation identifier was located.
     *
     * @property \Davispeixoto\OpenTravelAlliance\GroundReservationType[]
     * $detailedReservation
     */
    ...
    /**
     * Adds as summaryReservation
     *
     * One or more summary reservations that match specified reservation search
     * criteria.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\GroundReservationSummaryType
     * $summaryReservation
     */
    public function addToSummaryReservation(
        \Davispeixoto\OpenTravelAlliance\GroundReservationSummaryType $summaryReservation
    ) {
        $this->summaryReservation[] = $summaryReservation;

        return $this;
    }

    /**
     * isset summaryReservation
     *
     * One or more summary reservations that match specified reservation search
     * criteria.
     *
     ...
     * @return boolean
     */
    public function issetSummaryReservation($index)
    {
        return isset($this->summaryReservation[$index]);
    }

    /**
     * unset summaryReservation
     *
     * One or more summary reservations that match specified reservation search
     * criteria.
     *
     ...
     * @return void
     */
    public function unsetSummaryReservation($index)
    {
        unset($this->summaryReservation[$index]);
    }

    /**
     * Gets as summaryReservation
     *
     * One or more summary reservations that match specified reservation search
     * criteria.
     *
     * @return \Davispeixoto\OpenTravelAlliance\GroundReservationSummaryType[]
     */
    public function getSummaryReservation()
    {
        return $this->summaryReservation;
    }

    /**
     * Sets a new summaryReservation
     *
     * One or more summary reservations that match specified reservation search
     * criteria.
     *
     ...
     * @return self
     */
    public function setSummaryReservation(array $summaryReservation)
    {
        $this->summaryReservation = $summaryReservation;
    ...
    /**
     * Adds as detailedReservation
     *
     * One reservation returned if a valid reservation identifier was located.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\GroundReservationType
     * $detailedReservation
     */
    public function addToDetailedReservation(
        \Davispeixoto\OpenTravelAlliance\GroundReservationType $detailedReservation
    ) {
     ...
     * @return boolean
     */
    public function issetDetailedReservation($index)
    {
        return isset($this->detailedReservation[$index]);
    }

    /**
     * unset detailedReservation
     *
     * One reservation returned if a valid reservation identifier was located.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetDetailedReservation($index)
    {
        unset($this->detailedReservation[$index]);
    }
     ...
     * @return self
     */
    public function setDetailedReservation(array $detailedReservation)
    {
        $this->detailedReservation = $detailedReservation;
