...
/**
 * Class representing OTACruiseCabinUnholdRS
 */
class OTACruiseCabinUnholdRS
{
    ...
    /**
     * Contains information related to the selected sailing(s).
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCabinUnholdRS\SelectedSailingAType[]
     * $selectedSailing
     */
    ...
    public function addToSelectedSailing(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCabinUnholdRS\SelectedSailingAType $selectedSailing
    ) {
