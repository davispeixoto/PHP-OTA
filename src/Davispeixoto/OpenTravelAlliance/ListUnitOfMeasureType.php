...
/**
 * Class representing ListUnitOfMeasureType
 *
 * Units of measure.Use: This is a string list of enumerations with an "Other_"
 ...
 * XSD Type: List_UnitOfMeasure
 */
class ListUnitOfMeasureType
{
