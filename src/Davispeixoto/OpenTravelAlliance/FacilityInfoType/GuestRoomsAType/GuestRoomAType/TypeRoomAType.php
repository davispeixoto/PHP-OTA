...
class TypeRoomAType
{
    ...
    /**
     * @property string $typeImplied
     */
    private $typeImplied = null;

    /**
     * Number of rooms of this room type that makes up a larger unit (composite) such
     * as a two bedroom suite could be comprised of two king rooms plus other room
     * types.
     *
