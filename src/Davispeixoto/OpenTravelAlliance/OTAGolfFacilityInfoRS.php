...
/**
 * Class representing OTAGolfFacilityInfoRS
 */
class OTAGolfFacilityInfoRS
{
    ...
    /**
     * Information for the requested golf facility(s).
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRS\GolfCourseAType[]
     * $golfCourse
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRS\GolfCourseAType
     * $golfCourse
     */
    public function addToGolfCourse(\Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRS\GolfCourseAType $golfCourse)
    {
     ...
     * Information for the requested golf facility(s).
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRS\GolfCourseAType[]
     */
