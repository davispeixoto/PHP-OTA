...
namespace Davispeixoto\OpenTravelAlliance\AccommodationType\SeatAvailabilityDetailAType;
...
class CarAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\AccommodationType\SeatAvailabilityDetailAType\CarAType\CompartmentAType[]
     * $compartment
     */
    ...
    public function addToCompartment(
        \Davispeixoto\OpenTravelAlliance\AccommodationType\SeatAvailabilityDetailAType\CarAType\CompartmentAType $compartment
    ) {
