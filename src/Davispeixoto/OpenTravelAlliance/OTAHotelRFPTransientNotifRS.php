...
/**
 * Class representing OTAHotelRFPTransientNotifRS
 */
class OTAHotelRFPTransientNotifRS
{
    ...
    /**
     * The presence of the empty Successs element explicitly indicates that the
     * OpenTravel versioned message succeeded.
     *
    ...
    /**
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelRFPTransientNotifRS\CommentsAType
     * $comments
     */
    ...
    /**
     * Corresponds to the MessageID used in OTA_HotelRFP_RQ.xsd and
     * OTA_HotelRFP_NotifRQ.xsd. This is a UniqueID that is associated with the request
     * message.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelRFPTransientNotifRS\MessageIDAType
     * $messageID
     */
     ...
     * @return self
     */
    public function setComments(\Davispeixoto\OpenTravelAlliance\OTAHotelRFPTransientNotifRS\CommentsAType $comments)
    {
     ...
     * @return self
     */
    public function setMessageID(\Davispeixoto\OpenTravelAlliance\OTAHotelRFPTransientNotifRS\MessageIDAType $messageID)
    {
