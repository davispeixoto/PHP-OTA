...
class AirAncillaryServiceType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\AirAncillaryServiceType\ProductGroupAType[]
     * $productGroup
     */
    ...
    public function addToProductGroup(
        \Davispeixoto\OpenTravelAlliance\AirAncillaryServiceType\ProductGroupAType $productGroup
    ) {
