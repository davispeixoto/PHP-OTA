...
/**
 * Class representing OTATourActivitySearchRQ
 */
class OTATourActivitySearchRQ
{
    ...
    /**
     * The point-of-sale data, contained in the POS element, communicates the
     * information that allows the receiving system to identify the trading partner
     * that is sending the request or the response message.
     *
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivitySearchRQ\ProcessingInformationAType
     * $processingInformation
     */
    private $processingInformation = null;

    /**
     * Search criteria for tours and/or activities.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivitySearchRQ\SearchCriteriaAType
     * $searchCriteria
     */
    ...
    public function setProcessingInformation(
        \Davispeixoto\OpenTravelAlliance\OTATourActivitySearchRQ\ProcessingInformationAType $processingInformation
    ) {
    ...
    public function setSearchCriteria(
        \Davispeixoto\OpenTravelAlliance\OTATourActivitySearchRQ\SearchCriteriaAType $searchCriteria
    ) {
