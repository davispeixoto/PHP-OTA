...
/**
 * Class representing ListFareStatusType
 *
 * Fare construction, creation and publishing methods.Use: This is a string list of
 ...
 * XSD Type: List_FareStatus
 */
class ListFareStatusType
{
