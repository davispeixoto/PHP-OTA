...
/**
 * Class representing OTACruisePkgAvailRS
 */
class OTACruisePkgAvailRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruisePkgAvailRS\GuestCountsAType\GuestCountAType[]
     * $guestCounts
     */
    ...
    /**
     * Contains the list of packages available for the sailing, which meet the supplied
     * query criteria.
     *
     * @property
    ...
    public function addToGuestCounts(
        \Davispeixoto\OpenTravelAlliance\OTACruisePkgAvailRS\GuestCountsAType\GuestCountAType $guestCount
    ) {
     ...
     * @return boolean
     */
    public function issetCruisePackages($index)
    {
        return isset($this->cruisePackages[$index]);
    }

    /**
     * unset cruisePackages
     *
     * Contains the list of packages available for the sailing, which meet the supplied
     * query criteria.
     *
     ...
     * @return void
     */
    public function unsetCruisePackages($index)
    {
        unset($this->cruisePackages[$index]);
    }

    /**
     * Gets as cruisePackages
     *
     * Contains the list of packages available for the sailing, which meet the supplied
     * query criteria.
     *
     ...
     * \Davispeixoto\OpenTravelAlliance\OTACruisePkgAvailRS\CruisePackagesAType\CruisePackageAType[]
     */
    public function getCruisePackages()
    {
        return $this->cruisePackages;
    }

    /**
     * Sets a new cruisePackages
     *
     * Contains the list of packages available for the sailing, which meet the supplied
     * query criteria.
     *
     ...
     * @return self
     */
    public function setCruisePackages(array $cruisePackages)
    {
        $this->cruisePackages = $cruisePackages;
