...
/**
 * Class representing OTAReviewsRQ
 */
class OTAReviewsRQ
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAReviewsRQ\ReviewRequestAType[]
     * $reviewRequest
     */
    private $reviewRequest = null;
    ...
    /**
     * Adds as reviewRequest
     *
     * Review request criteria.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAReviewsRQ\ReviewRequestAType
     * $reviewRequest
     */
    public function addToReviewRequest(\Davispeixoto\OpenTravelAlliance\OTAReviewsRQ\ReviewRequestAType $reviewRequest)
    {
     ...
     * @return boolean
     */
    public function issetReviewRequest($index)
    {
        return isset($this->reviewRequest[$index]);
    }
     ...
     * @return void
     */
    public function unsetReviewRequest($index)
    {
        unset($this->reviewRequest[$index]);
    }

    /**
     * Gets as reviewRequest
     *
     * Review request criteria.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAReviewsRQ\ReviewRequestAType[]
     */
     ...
     * @return self
     */
    public function setReviewRequest(array $reviewRequest)
    {
        $this->reviewRequest = $reviewRequest;
