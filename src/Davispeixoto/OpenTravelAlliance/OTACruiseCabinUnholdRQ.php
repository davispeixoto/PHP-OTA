...
/**
 * Class representing OTACruiseCabinUnholdRQ
 */
class OTACruiseCabinUnholdRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCabinUnholdRQ\SelectedSailingAType[]
     * $selectedSailing
     */
    ...
    public function addToSelectedSailing(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCabinUnholdRQ\SelectedSailingAType $selectedSailing
    ) {
