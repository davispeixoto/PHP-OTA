...
/**
 * Class representing OTAGolfRatePlanRS
 */
class OTAGolfRatePlanRS
{
    ...
    /**
     * Rate(s) that meet the requested criteria.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAGolfRatePlanRS\CourseAType[]
     * $course
     */
    private $course = null;
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfRatePlanRS\CourseAType $course
     */
    public function addToCourse(\Davispeixoto\OpenTravelAlliance\OTAGolfRatePlanRS\CourseAType $course)
    {
        $this->course[] = $course;
     ...
     * Rate(s) that meet the requested criteria.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAGolfRatePlanRS\CourseAType[]
     */
