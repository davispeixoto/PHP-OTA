...
class DeadlineAType
{
     ...
     *
     * @property boolean $overrideIndicator
     */
    private $overrideIndicator = null;
    ...
    /**
     * Sets a new overrideIndicator
     *
     * When true, indicates that the deadline has been overridden.
     *
     * @param boolean $overrideIndicator
     * @return self
     */
    public function setOverrideIndicator($overrideIndicator)
    {
