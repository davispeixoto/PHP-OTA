...
namespace Davispeixoto\OpenTravelAlliance\EMDType\TicketDocumentAType\CouponInfoAType;

/**
 * Class representing ValidatingAirlineAType
 */
class ValidatingAirlineAType
{
