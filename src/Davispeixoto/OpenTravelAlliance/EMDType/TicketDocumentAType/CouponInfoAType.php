...
class CouponInfoAType
{
     ...
     *
     * @property string $involuntaryIndCode
     */
    private $involuntaryIndCode = null;

    /**
     * A reference number generated by the validating carrier authorising settlment of
     * a coupon.
     *
     * @property string $settlementAuthCode
     */
     ...
     * Reference to the flight segments for this coupon
     *
     * @property string $flownAirlineSegmentRPH
     */
