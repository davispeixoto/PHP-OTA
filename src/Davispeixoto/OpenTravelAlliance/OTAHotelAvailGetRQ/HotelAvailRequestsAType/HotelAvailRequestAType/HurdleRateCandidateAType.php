...
class HurdleRateCandidateAType
{
    ...
    /**
     * Boolean flag indicating the hurdle rate is requested. If this attrinbute is
     * true, the currency code attributes may be included to ensure the responder
     * currency matches the sender currency.
     *
