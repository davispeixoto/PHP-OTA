...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelAvailGetRQ\HotelAvailRequestsAType\HotelAvailRequestAType\RestrictionStatusCandidatesAType;

/**
 * Class representing RestrictionStatusCandidateAType
 */
class RestrictionStatusCandidateAType
{
