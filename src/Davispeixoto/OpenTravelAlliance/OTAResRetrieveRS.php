...
/**
 * Class representing OTAResRetrieveRS
 */
class OTAResRetrieveRS
{
    ...
    /**
     * A container for multiple reservations. The list of reservations will be one of
     * the following types of reservations: global, air, hotel, package tour, golf,
     * cruise, vehicle or rail.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAResRetrieveRS\ReservationsListAType
     * $reservationsList
     */
    private $reservationsList = null;
    ...
    /**
     * Gets as reservationsList
     *
     * A container for multiple reservations. The list of reservations will be one of
     * the following types of reservations: global, air, hotel, package tour, golf,
     * cruise, vehicle or rail.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAResRetrieveRS\ReservationsListAType
     */
    ...
    /**
     * Sets a new reservationsList
     *
     * A container for multiple reservations. The list of reservations will be one of
     * the following types of reservations: global, air, hotel, package tour, golf,
     * cruise, vehicle or rail.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAResRetrieveRS\ReservationsListAType
     * $reservationsList
     * @return self
     */
    public function setReservationsList(
        \Davispeixoto\OpenTravelAlliance\OTAResRetrieveRS\ReservationsListAType $reservationsList
    ) {
