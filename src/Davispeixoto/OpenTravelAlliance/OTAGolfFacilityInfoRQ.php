...
/**
 * Class representing OTAGolfFacilityInfoRQ
 */
class OTAGolfFacilityInfoRQ
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRQ\POSAType $pOS
     */
    private $pOS = null;

    /**
     * Golf facility ID(s) to request updated information for.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRQ\GolfFacilityAType[]
     * $golfFacility
     */
     ...
     * Point of Sale identification.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRQ\POSAType
     */
     ...
     * Point of Sale identification.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRQ\POSAType $pOS
     * @return self
     */
    public function setPOS(\Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRQ\POSAType $pOS)
    {
        $this->pOS = $pOS;
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRQ\GolfFacilityAType
     * $golfFacility
     */
    public function addToGolfFacility(
        \Davispeixoto\OpenTravelAlliance\OTAGolfFacilityInfoRQ\GolfFacilityAType $golfFacility
    ) {
