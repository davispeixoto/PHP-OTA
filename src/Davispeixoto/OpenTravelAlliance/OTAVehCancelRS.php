...
/**
 * Class representing OTAVehCancelRS
 */
class OTAVehCancelRS
{
    ...
    /**
     * Identifies the common, or core, information associated with the response to a
     * request for the cancellation of a vehicle reservation.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAVehCancelRS\VehCancelRSCoreAType
     * $vehCancelRSCore
     */
    private $vehCancelRSCore = null;

    /**
     * Identifies the supplemental information associated with the response to a
     * request for the cancellation of a vehicle reservation.
     *
     * @property \Davispeixoto\OpenTravelAlliance\VehicleCancelRSAdditionalInfoType
     * $vehCancelRSInfo
     */
    private $vehCancelRSInfo = null;
    ...
    /**
     * Gets as vehCancelRSCore
     *
     * Identifies the common, or core, information associated with the response to a
     * request for the cancellation of a vehicle reservation.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAVehCancelRS\VehCancelRSCoreAType
     */
    ...
    /**
     * Sets a new vehCancelRSCore
     *
     * Identifies the common, or core, information associated with the response to a
     * request for the cancellation of a vehicle reservation.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAVehCancelRS\VehCancelRSCoreAType
     * $vehCancelRSCore
     * @return self
     */
    public function setVehCancelRSCore(
        \Davispeixoto\OpenTravelAlliance\OTAVehCancelRS\VehCancelRSCoreAType $vehCancelRSCore
    ) {
    ...
    /**
     * Gets as vehCancelRSInfo
     *
     * Identifies the supplemental information associated with the response to a
     * request for the cancellation of a vehicle reservation.
     *
     * @return \Davispeixoto\OpenTravelAlliance\VehicleCancelRSAdditionalInfoType
     */
    ...
    /**
     * Sets a new vehCancelRSInfo
     *
     * Identifies the supplemental information associated with the response to a
     * request for the cancellation of a vehicle reservation.
     *
     * @param \Davispeixoto\OpenTravelAlliance\VehicleCancelRSAdditionalInfoType
     * $vehCancelRSInfo
     * @return self
     */
    public function setVehCancelRSInfo(
        \Davispeixoto\OpenTravelAlliance\VehicleCancelRSAdditionalInfoType $vehCancelRSInfo
    ) {
