 ...
 *
 * This is a request message for modifying a reservation. It is used for a full
 * overlay of the reservation. When changing data that requires an availability
 * check, this message assumes the availability is known (if availability is not
...
class HotelResModifyRequestType
{
    ...
    /**
     * Indicates the status of the reservation represented by the message. This is an
     * enumeration with possible values of Initiate, Ignore, Modify, Commit.
     *
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\HotelResModifyType $hotelResModifies
     */
     ...
     * A collection of reservations to be modified.
     *
     * @return \Davispeixoto\OpenTravelAlliance\HotelResModifyType
     */
     ...
     * A collection of reservations to be modified.
     *
     * @param \Davispeixoto\OpenTravelAlliance\HotelResModifyType $hotelResModifies
     * @return self
     */
    public function setHotelResModifies(\Davispeixoto\OpenTravelAlliance\HotelResModifyType $hotelResModifies)
    {
