...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelResRQ\HotelReservationsAType\HotelReservationAType\ResGlobalInfoAType\GuaranteeAType\GuaranteesAcceptedAType\GuaranteeAcceptedAType;
...
class PaymentCardAType
{
    ...
    /**
     * CardNumber MUST specify the payment card number (embossed on the card) used to
    ...
    /**
     * ExpireDate MUST indicate the ending date of the payment card.
     *
    ...
    /**
     * MaskedCardNumber MAY specify the payment card number in a concealed format
    ...
    /**
     * CardHolderName MUST specify the name of the card holder.
     *
