...
/**
 * Class representing ListAirFareDateType
 *
 * Air fare applicable date types.Use: This is a string list of enumerations with
 ...
 * XSD Type: List_AirFareDateType
 */
class ListAirFareDateType
{
