...
/**
 * Class representing OTAHotelProductNotifRQ
 */
class OTAHotelProductNotifRQ
{
     ...
     * each HotelProductNotifRQ, (i.e. the entire message) for tracing of transactions.
     *
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelProductNotifRQ\HotelProductsAType
     * $hotelProducts
     */
    ...
    public function setHotelProducts(
        \Davispeixoto\OpenTravelAlliance\OTAHotelProductNotifRQ\HotelProductsAType $hotelProducts
    ) {
