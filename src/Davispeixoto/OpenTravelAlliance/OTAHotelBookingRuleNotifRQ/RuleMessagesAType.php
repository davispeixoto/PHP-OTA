...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelBookingRuleNotifRQ;

/**
 * Class representing RuleMessagesAType
 */
class RuleMessagesAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelBookingRuleNotifRQ\RuleMessagesAType\RuleMessageAType[]
     * $ruleMessage
     */
     ...
     * $ruleMessage
     */
    public function addToRuleMessage(
        \Davispeixoto\OpenTravelAlliance\OTAHotelBookingRuleNotifRQ\RuleMessagesAType\RuleMessageAType $ruleMessage
    ) {
     ...
     * @return boolean
     */
    public function issetRuleMessage($index)
    {
        return isset($this->ruleMessage[$index]);
    }
     ...
     * @return void
     */
    public function unsetRuleMessage($index)
    {
        unset($this->ruleMessage[$index]);
    }
     ...
     * @return self
     */
    public function setRuleMessage(array $ruleMessage)
    {
        $this->ruleMessage = $ruleMessage;
