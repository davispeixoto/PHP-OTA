...
/**
 * Class representing ListGroundLocationType
 *
 * Ground transportation service locations.Use: This is a string list of
 * enumerations with an "Other_" literal to support an open enumeration list. Use
 * the "Other_" enumeration in combination with the Code Extension fields to
 * exchange a value that is not in the list and is known to your trading partners.
 * XSD Type: List_GroundLocationType
 */
class ListGroundLocationType
{
