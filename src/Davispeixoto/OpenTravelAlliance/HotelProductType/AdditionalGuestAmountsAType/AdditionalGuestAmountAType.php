...
namespace Davispeixoto\OpenTravelAlliance\HotelProductType\AdditionalGuestAmountsAType;

use Davispeixoto\OpenTravelAlliance\AdditionalGuestAmountType;

/**
 * Class representing AdditionalGuestAmountAType
 */
class AdditionalGuestAmountAType extends AdditionalGuestAmountType
{
