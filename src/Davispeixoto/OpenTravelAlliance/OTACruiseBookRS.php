...
/**
 * Class representing OTACruiseBookRS
 */
class OTACruiseBookRS
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTACruiseBookRS\ReservationIDAType[]
     * $reservationID
     */
    ...
    /**
     * May be used to provide policy information regarding the booking.
     *
    ...
    /**
     * Specifies pricing and payment information about the booking.
     *
     * @property \Davispeixoto\OpenTravelAlliance\CruiseBookingInfoType $bookingPayment
     */
    private $bookingPayment = null;
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTACruiseBookRS\ReservationIDAType
     * $reservationID
     */
    public function addToReservationID(
        \Davispeixoto\OpenTravelAlliance\OTACruiseBookRS\ReservationIDAType $reservationID
    ) {
     ...
     * modification mode (e.g. PNR Record Locator and/or Vendor Confirmation Number).
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTACruiseBookRS\ReservationIDAType[]
     */
    ...
    /**
     * Gets as bookingPayment
     *
     * Specifies pricing and payment information about the booking.
     *
     * @return \Davispeixoto\OpenTravelAlliance\CruiseBookingInfoType
     */
    public function getBookingPayment()
    {
        return $this->bookingPayment;
    }

    /**
     * Sets a new bookingPayment
     *
     * Specifies pricing and payment information about the booking.
     *
     * @param \Davispeixoto\OpenTravelAlliance\CruiseBookingInfoType $bookingPayment
     * @return self
     */
    public function setBookingPayment(\Davispeixoto\OpenTravelAlliance\CruiseBookingInfoType $bookingPayment)
    {
