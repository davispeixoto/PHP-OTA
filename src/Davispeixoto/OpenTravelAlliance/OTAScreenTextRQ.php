...
/**
 * Class representing OTAScreenTextRQ
 */
class OTAScreenTextRQ
{
    ...
    /**
     * To specify the message function that is being requested.
     *
     * @property string $messageFunction
     */
    ...
    /**
     * If true, blank lines should be omitted in the response.
     *
     * @property boolean $omitBlankLinesIndicator
     */
    private $omitBlankLinesIndicator = null;

    /**
     * If true, all screens should be returned as a continuous string in one TextScreen
     * element.
     *
    ...
    /**
     * Used to provide information about the requester.
     *
    ...
    /**
     * The message input entry which the receiver will process and return the
     * appropriate information (e.g., A28MAYLONPAR, HELP AVAIL).
     *
     * @property string $screenEntry
     */
    private $screenEntry = null;
    ...
    /**
     * Gets as omitBlankLinesIndicator
     *
     * If true, blank lines should be omitted in the response.
     *
     * @return boolean
     */
    public function getOmitBlankLinesIndicator()
    {
        return $this->omitBlankLinesIndicator;
    }

    /**
     * Sets a new omitBlankLinesIndicator
     *
     * If true, blank lines should be omitted in the response.
     *
     * @param boolean $omitBlankLinesIndicator
     * @return self
     */
    public function setOmitBlankLinesIndicator($omitBlankLinesIndicator)
    {
        $this->omitBlankLinesIndicator = $omitBlankLinesIndicator;
     ...
     * @return string
     */
    public function getScreenEntry()
    {
        return $this->screenEntry;
    }

    /**
     * Sets a new screenEntry
     *
     * The message input entry which the receiver will process and return the
     * appropriate information (e.g., A28MAYLONPAR, HELP AVAIL).
     *
     * @param string $screenEntry
     * @return self
     */
    public function setScreenEntry($screenEntry)
    {
        $this->screenEntry = $screenEntry;
