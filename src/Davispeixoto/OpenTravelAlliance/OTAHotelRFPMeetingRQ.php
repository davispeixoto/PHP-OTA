...
/**
 * Class representing OTAHotelRFPMeetingRQ
 */
class OTAHotelRFPMeetingRQ
{
    ...
    /**
     * A collection of RequestSegments which allows multiple requests for different
     * blocks of rooms and/or meeting space to be sent in one message.
     *
     * @property \Davispeixoto\OpenTravelAlliance\RFPRequestSegmentsType
     * $rFPRequestSegments
     */
    private $rFPRequestSegments = null;

    /**
     * This is a UniqueID that would be associated with a collection of RFPs.
     *
    ...
    /**
     * Gets as rFPRequestSegments
     *
     * A collection of RequestSegments which allows multiple requests for different
     * blocks of rooms and/or meeting space to be sent in one message.
     *
     * @return \Davispeixoto\OpenTravelAlliance\RFPRequestSegmentsType
     */
    public function getRFPRequestSegments()
    {
        return $this->rFPRequestSegments;
    }

    /**
     * Sets a new rFPRequestSegments
     *
     * A collection of RequestSegments which allows multiple requests for different
     * blocks of rooms and/or meeting space to be sent in one message.
     *
     * @param \Davispeixoto\OpenTravelAlliance\RFPRequestSegmentsType
     * $rFPRequestSegments
     * @return self
     */
    public function setRFPRequestSegments(\Davispeixoto\OpenTravelAlliance\RFPRequestSegmentsType $rFPRequestSegments)
    {
        $this->rFPRequestSegments = $rFPRequestSegments;
