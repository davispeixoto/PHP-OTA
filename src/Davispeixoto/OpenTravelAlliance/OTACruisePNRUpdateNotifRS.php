...
/**
 * Class representing OTACruisePNRUpdateNotifRS
 */
class OTACruisePNRUpdateNotifRS
{
    ...
    /**
     * Specifies the reservation booking ID number and optionally the PNR control
     * information.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruisePNRUpdateNotifRS\ReservationIDAType[]
     * $reservationID
     */
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTACruisePNRUpdateNotifRS\ErrorsAType
     * $errors
     */
    private $errors = null;
    ...
    public function addToReservationID(
        \Davispeixoto\OpenTravelAlliance\OTACruisePNRUpdateNotifRS\ReservationIDAType $reservationID
    ) {
     ...
     * A collection of errors that occurred during the processing of a message.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTACruisePNRUpdateNotifRS\ErrorsAType
     */
     ...
     * A collection of errors that occurred during the processing of a message.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTACruisePNRUpdateNotifRS\ErrorsAType
     * $errors
     * @return self
     */
    public function setErrors(\Davispeixoto\OpenTravelAlliance\OTACruisePNRUpdateNotifRS\ErrorsAType $errors)
    {
        $this->errors = $errors;
