...
/**
 * Class representing OTACruiseCancellationPricingRQ
 */
class OTACruiseCancellationPricingRQ
{
    ...
    /**
     * Specifies the guest's booking ID (e.g. Vendor Confirmation Number).
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCancellationPricingRQ\ReservationIDAType
     * $reservationID
     */
    private $reservationID = null;

    /**
     * Currency in which the fees will be returned.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCancellationPricingRQ\CurrencyAType
     * $currency
     */
    ...
    public function setReservationID(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCancellationPricingRQ\ReservationIDAType $reservationID
    ) {
     ...
     * @return self
     */
    public function setCurrency(\Davispeixoto\OpenTravelAlliance\OTACruiseCancellationPricingRQ\CurrencyAType $currency)
    {
