...
/**
 * Class representing HotelResResponseType
 *
 * This is the response message for a reservation request. The response could be as
 * simple as indicating the reservation was made or as complex as echoing back all
 * reservation information. It is used by HotelResRS and HotelResNotifRS to keep
 * them synchronized.
 * XSD Type: HotelResResponseType
 */
class HotelResResponseType
{
