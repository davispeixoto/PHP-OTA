...
/**
 * Class representing ListVehCategoryType
 *
 * Vehicle categories.Use: This is a string list of enumerations with an "Other_"
 ...
 * XSD Type: List_VehCategory
 */
class ListVehCategoryType
{
