...
/**
 * Class representing OTATourActivityModifyRQ
 */
class OTATourActivityModifyRQ
{
     ...
     * requesting this reservation modification.
     *
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType
     * $bookingInfo
     */
     ...
     * Information that identifies the tour and/or activity being booked.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType
     * $bookingInfo
     * @return self
     */
    public function setBookingInfo(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType $bookingInfo
    ) {
