...
/**
 * Class representing OTAHotelDescriptiveInfoRQ
 */
class OTAHotelDescriptiveInfoRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelDescriptiveInfoRQ\HotelDescriptiveInfosAType
     * $hotelDescriptiveInfos
     */
    private $hotelDescriptiveInfos = null;
    ...
    /**
     * Sets a new hotelDescriptiveInfos
     *
     * Collection of items for data from multiple hotels.
     *
     * @param
     ...
     * @return self
     */
    public function setHotelDescriptiveInfos(
        \Davispeixoto\OpenTravelAlliance\OTAHotelDescriptiveInfoRQ\HotelDescriptiveInfosAType $hotelDescriptiveInfos
    ) {
