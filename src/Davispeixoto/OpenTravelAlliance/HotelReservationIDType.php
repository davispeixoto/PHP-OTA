...
/**
 * Class representing HotelReservationIDType
 *
 * Detailed reservation or cancellation number information.
 * XSD Type: HotelReservationID_Type
 */
class HotelReservationIDType
{
