...
/**
 * Class representing OTAVehRateRuleNotifRQ
 */
class OTAVehRateRuleNotifRQ
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAVehRateRuleNotifRQ\RulesAType
     * $rules
     */
    private $rules = null;
     ...
     * A collection of rules.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAVehRateRuleNotifRQ\RulesAType
     */
     ...
     * A collection of rules.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAVehRateRuleNotifRQ\RulesAType $rules
     * @return self
     */
    public function setRules(\Davispeixoto\OpenTravelAlliance\OTAVehRateRuleNotifRQ\RulesAType $rules)
    {
        $this->rules = $rules;
