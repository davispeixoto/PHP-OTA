...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelPostEventRQ\EventsAType\EventAType\EventSitesAType;

/**
 * Class representing EventSiteAType
 */
class EventSiteAType
{
