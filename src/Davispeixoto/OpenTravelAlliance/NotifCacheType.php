...
/**
 * Class representing NotifCacheType
 *
 * Information that has changed and should be updated in the cache.
 * XSD Type: NotifCacheType
 */
class NotifCacheType
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\NotifCacheType\TimeSpanAType
     * $timeSpan
     */
    private $timeSpan = null;

    /**
     * Other product information that may be returned.
     *
     * @property \Davispeixoto\OpenTravelAlliance\NotifCacheType\ProductInfoAType
     * $productInfo
     */
     ...
     * there are changes in all or a portion of the returned date range.
     *
     * @return \Davispeixoto\OpenTravelAlliance\NotifCacheType\TimeSpanAType
     */
     ...
     * there are changes in all or a portion of the returned date range.
     *
     * @param \Davispeixoto\OpenTravelAlliance\NotifCacheType\TimeSpanAType $timeSpan
     * @return self
     */
    public function setTimeSpan(\Davispeixoto\OpenTravelAlliance\NotifCacheType\TimeSpanAType $timeSpan)
    {
     ...
     * Other product information that may be returned.
     *
     * @return \Davispeixoto\OpenTravelAlliance\NotifCacheType\ProductInfoAType
     */
     ...
     * Other product information that may be returned.
     *
     * @param \Davispeixoto\OpenTravelAlliance\NotifCacheType\ProductInfoAType
     * $productInfo
     * @return self
     */
    public function setProductInfo(\Davispeixoto\OpenTravelAlliance\NotifCacheType\ProductInfoAType $productInfo)
    {
