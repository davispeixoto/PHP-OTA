...
class TrainSegmentAType extends TrainSegmentType
{
     ...
     * returned indicator, and autotrain vehicle type. This information collectively
     * represents one or more specific classes of service, such as "First class" and/or
     * a seat and berth accommodation.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailAvailRS\OriginDestinationInformationAType\OriginDestinationOptionAType\JourneySegmentAType\TrainSegmentAType\AvailabilityDetailAType[]
     * $availabilityDetail
     */
    ...
    public function addToAvailabilityDetail(
        \Davispeixoto\OpenTravelAlliance\OTARailAvailRS\OriginDestinationInformationAType\OriginDestinationOptionAType\JourneySegmentAType\TrainSegmentAType\AvailabilityDetailAType $availabilityDetail
    ) {
