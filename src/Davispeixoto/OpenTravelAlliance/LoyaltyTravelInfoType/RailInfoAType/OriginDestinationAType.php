...
namespace Davispeixoto\OpenTravelAlliance\LoyaltyTravelInfoType\RailInfoAType;
...
class OriginDestinationAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\LoyaltyTravelInfoType\RailInfoAType\OriginDestinationAType\TrainSegmentAType[]
     * $trainSegment
     */
    ...
    public function addToTrainSegment(
        \Davispeixoto\OpenTravelAlliance\LoyaltyTravelInfoType\RailInfoAType\OriginDestinationAType\TrainSegmentAType $trainSegment
    ) {
