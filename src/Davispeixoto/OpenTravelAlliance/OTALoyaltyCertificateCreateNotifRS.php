...
/**
 * Class representing OTALoyaltyCertificateCreateNotifRS
 */
class OTALoyaltyCertificateCreateNotifRS
{
    ...
    /**
     * A unique ID for the loyalty certificate stored in the trading partner system.
     *
