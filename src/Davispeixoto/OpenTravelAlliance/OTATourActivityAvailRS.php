...
/**
 * Class representing OTATourActivityAvailRS
 */
class OTATourActivityAvailRS
{
     ...
     * has been successfully processed, the request may not have been fully satisfied.
     *
    ...
    /**
     * Information that may have impacted how the receiving system processed the
     * request message.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\ProcessingInformationAType
     * $processingInformation
     */
    private $processingInformation = null;

    /**
     * Available tours/ activities that meet the specified availability request
     * criteria with an indicator is this is an alternate tour/ activity, e.g. it does
     * not meet the exact availability criteria specified.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType[]
     * $tourActivityInfo
     */
    ...
    /**
     * Sets a new processingInformation
     *
     * Information that may have impacted how the receiving system processed the
     * request message.
     *
     ...
     * @return self
     */
    public function setProcessingInformation(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\ProcessingInformationAType $processingInformation
    ) {
     ...
     * $tourActivityInfo
     */
    public function addToTourActivityInfo(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType $tourActivityInfo
    ) {
     ...
     * @return boolean
     */
    public function issetTourActivityInfo($index)
    {
        return isset($this->tourActivityInfo[$index]);
    }

    /**
     * unset tourActivityInfo
     *
     * Available tours/ activities that meet the specified availability request
     * criteria with an indicator is this is an alternate tour/ activity, e.g. it does
     * not meet the exact availability criteria specified.
     ...
     * @return void
     */
    public function unsetTourActivityInfo($index)
    {
        unset($this->tourActivityInfo[$index]);
    }
     ...
     * @return self
     */
    public function setTourActivityInfo(array $tourActivityInfo)
    {
        $this->tourActivityInfo = $tourActivityInfo;
