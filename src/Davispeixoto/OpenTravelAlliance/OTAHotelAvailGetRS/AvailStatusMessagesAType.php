...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelAvailGetRS;
...
class AvailStatusMessagesAType
{
    ...
    /**
     * The AvailStatusMessage indicates whether the inventory is opened, closed, closed
     * on request, etc.The MinMaxLOSStatusMessage class communicates the set of minimum
     * and maximum length-of-stay availability status changes to be synchronized with
     * another system.The RateHurdleStatusMessage class defines the setting for rate
     * hurdle controls to be synchronized with the central reservation system.
     *
