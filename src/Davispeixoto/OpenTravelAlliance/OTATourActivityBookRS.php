...
/**
 * Class representing OTATourActivityBookRS
 */
class OTATourActivityBookRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType
     * $reservationDetails
     */
    private $reservationDetails = null;
     ...
     * @return self
     */
    public function setReservationDetails(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType $reservationDetails
    ) {
