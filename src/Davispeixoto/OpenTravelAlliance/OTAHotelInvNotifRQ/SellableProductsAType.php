...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelInvNotifRQ;

use Davispeixoto\OpenTravelAlliance\SellableProductsType;

/**
 * Class representing SellableProductsAType
 */
class SellableProductsAType extends SellableProductsType
{
