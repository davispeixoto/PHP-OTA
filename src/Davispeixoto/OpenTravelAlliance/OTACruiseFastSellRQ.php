...
/**
 * Class representing OTACruiseFastSellRQ
 */
class OTACruiseFastSellRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\SelectedSailingAType
     * $selectedSailing
     */
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\CurrencyAType
     * $currency
     */
     ...
     * Contains information related to the selected sailing.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\SelectedSailingAType
     * $selectedSailing
     * @return self
     */
    public function setSelectedSailing(
        \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\SelectedSailingAType $selectedSailing
    ) {
     ...
     * Currency in which the fare will be returned.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\CurrencyAType
     */
     ...
     * Currency in which the fare will be returned.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\CurrencyAType
     * $currency
     * @return self
     */
    public function setCurrency(\Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\CurrencyAType $currency)
    {
