...
/**
 * Class representing OTACruiseItineraryDescRQ
 */
class OTACruiseItineraryDescRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseItineraryDescRQ\SelectedSailingAType
     * $selectedSailing
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseItineraryDescRQ\PackageOptionAType
     * $packageOption
     */
    ...
    public function setSelectedSailing(
        \Davispeixoto\OpenTravelAlliance\OTACruiseItineraryDescRQ\SelectedSailingAType $selectedSailing
    ) {
     ...
     * @return self
     */
    public function setPackageOption(
        \Davispeixoto\OpenTravelAlliance\OTACruiseItineraryDescRQ\PackageOptionAType $packageOption
    ) {
