...
namespace Davispeixoto\OpenTravelAlliance\OTACruiseCabinHoldRQ\SelectedSailingAType;
...
class SelectedCategoryAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCabinHoldRQ\SelectedSailingAType\SelectedCategoryAType\SelectedCabinAType[]
     * $selectedCabin
     */
    ...
    public function addToSelectedCabin(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCabinHoldRQ\SelectedSailingAType\SelectedCategoryAType\SelectedCabinAType $selectedCabin
    ) {
