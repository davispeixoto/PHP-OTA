 ...
 */
class OTAHotelDescriptiveContentNotifRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelDescriptiveContentNotifRQ\HotelDescriptiveContentsAType
    ...
    public function setHotelDescriptiveContents(
        \Davispeixoto\OpenTravelAlliance\OTAHotelDescriptiveContentNotifRQ\HotelDescriptiveContentsAType $hotelDescriptiveContents
    ) {
