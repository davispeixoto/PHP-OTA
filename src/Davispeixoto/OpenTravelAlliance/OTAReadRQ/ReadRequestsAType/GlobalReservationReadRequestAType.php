...
/**
 * Class representing GlobalReservationReadRequestAType
 */
class GlobalReservationReadRequestAType
{
    ...
    /**
     * The name of the traveler for whom the reservation is requested.
     *
