...
class PricingOverviewAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\AirReservationType\PricingOverviewAType\PricingIndicatorAType[]
     * $pricingIndicator
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\AirReservationType\PricingOverviewAType\AccountAType[]
     * $account
     */
    ...
    public function addToPricingIndicator(
        \Davispeixoto\OpenTravelAlliance\AirReservationType\PricingOverviewAType\PricingIndicatorAType $pricingIndicator
    ) {
    ...
    public function addToAccount(
        \Davispeixoto\OpenTravelAlliance\AirReservationType\PricingOverviewAType\AccountAType $account
    ) {
