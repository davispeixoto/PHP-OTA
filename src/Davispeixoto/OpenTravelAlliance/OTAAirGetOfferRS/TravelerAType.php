...
class TravelerAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirGetOfferRS\TravelerAType\PassengerTypeQuantityAType[]
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirGetOfferRS\TravelerAType\AirTravelerAType[]
     * $airTraveler
     */
    ...
    public function addToPassengerTypeQuantity(
        \Davispeixoto\OpenTravelAlliance\OTAAirGetOfferRS\TravelerAType\PassengerTypeQuantityAType $passengerTypeQuantity
    ) {
    ...
    public function addToAirTraveler(
        \Davispeixoto\OpenTravelAlliance\OTAAirGetOfferRS\TravelerAType\AirTravelerAType $airTraveler
    ) {
