...
class PricingAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType\PricingAType\SummaryAType
     * $summary
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType\PricingAType\ParticipantCategoryAType[]
     * $participantCategory
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType\PricingAType\GroupAType[]
     * $group
     */
    private $group = null;
    ...
    public function setSummary(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType\PricingAType\SummaryAType $summary
    ) {
    ...
    public function addToParticipantCategory(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType\PricingAType\ParticipantCategoryAType $participantCategory
    ) {
    ...
    public function addToGroup(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType\PricingAType\GroupAType $group
    ) {
        $this->group[] = $group;
