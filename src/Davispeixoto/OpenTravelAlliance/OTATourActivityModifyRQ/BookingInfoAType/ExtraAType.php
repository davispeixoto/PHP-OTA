...
class ExtraAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType\ExtraAType\DepositAType
     * $deposit
     */
    ...
    public function setDeposit(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityModifyRQ\BookingInfoAType\ExtraAType\DepositAType $deposit
    ) {
