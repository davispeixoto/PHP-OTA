...
/**
 * Class representing OTAAirDetailsRQ
 */
class OTAAirDetailsRQ
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAAirDetailsRQ\AirDetailAType[]
     * $airDetail
     */
    private $airDetail = null;
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirDetailsRQ\AirDetailAType
     * $airDetail
     */
    public function addToAirDetail(\Davispeixoto\OpenTravelAlliance\OTAAirDetailsRQ\AirDetailAType $airDetail)
    {
     ...
     * @return boolean
     */
    public function issetAirDetail($index)
    {
        return isset($this->airDetail[$index]);
    }
     ...
     * @return void
     */
    public function unsetAirDetail($index)
    {
        unset($this->airDetail[$index]);
    }
     ...
     * Information for a specific flight.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAAirDetailsRQ\AirDetailAType[]
     */
    public function getAirDetail()
    {
        return $this->airDetail;
    }

    /**
     * Sets a new airDetail
     *
     * Information for a specific flight.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirDetailsRQ\AirDetailAType[]
     ...
     * @return self
     */
    public function setAirDetail(array $airDetail)
    {
        $this->airDetail = $airDetail;
