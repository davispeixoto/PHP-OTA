...
namespace Davispeixoto\OpenTravelAlliance\PricedItineraryType;
...
class TicketingInfoAType extends TicketingInfoRSType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\PricedItineraryType\TicketingInfoAType\DeliveryInfoAType[]
     * $deliveryInfo
     */
    ...
    public function addToDeliveryInfo(
        \Davispeixoto\OpenTravelAlliance\PricedItineraryType\TicketingInfoAType\DeliveryInfoAType $deliveryInfo
    ) {
