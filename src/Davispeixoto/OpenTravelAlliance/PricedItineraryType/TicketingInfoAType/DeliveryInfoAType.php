...
namespace Davispeixoto\OpenTravelAlliance\PricedItineraryType\TicketingInfoAType;

/**
 * Class representing DeliveryInfoAType
 */
class DeliveryInfoAType
{

    /**
     * Specifies the manner in which a ticket will be sent to the traveler. Refer to
