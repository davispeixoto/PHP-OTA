...
/**
 * Class representing ListReservationBillingType
 *
 * Reservation billing code types.Use: This is a string list of enumerations with
 * an "Other_" literal to support an open enumeration list. Use the "Other_"
 ...
 * XSD Type: List_ReservationBilling
 */
class ListReservationBillingType
{
