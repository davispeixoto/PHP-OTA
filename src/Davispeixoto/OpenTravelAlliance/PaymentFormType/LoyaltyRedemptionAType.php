...
class LoyaltyRedemptionAType
{
     ...
     *
     * @property integer $redemptionQuantity
     */
    private $redemptionQuantity = null;

    /**
     * A certificate may be needed in order to redeem miles or points. Certificates may
     * be used in combination with each other as part of a reservation.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\PaymentFormType\LoyaltyRedemptionAType\LoyaltyCertificateAType[]
     * $loyaltyCertificate
     */
    private $loyaltyCertificate = null;
     ...
     * The quantity of loyalty units being redeemed.
     *
     * @param integer $redemptionQuantity
     * @return self
     */
     ...
     * $loyaltyCertificate
     */
    public function addToLoyaltyCertificate(
        \Davispeixoto\OpenTravelAlliance\PaymentFormType\LoyaltyRedemptionAType\LoyaltyCertificateAType $loyaltyCertificate
    ) {
     ...
     * @return self
     */
    public function setLoyaltyCertificate(array $loyaltyCertificate)
    {
        $this->loyaltyCertificate = $loyaltyCertificate;
