...
/**
 * Class representing OTAVehResStatusNotifRS
 */
class OTAVehResStatusNotifRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAVehResStatusNotifRS\VehResStatusNotifRSCoreAType
     * $vehResStatusNotifRSCore
     */
    private $vehResStatusNotifRSCore = null;

    /**
     * Identifies the supplemental information associated with the response poviding
     ...
     */
    private $vehResStatusNotifRSInfo = null;
    ...
    /**
     * Gets as vehResStatusNotifRSCore
     *
     * Identifies the common, or core, information associated with the response
     * providing information on the reservation of a rental vehicle.
     *
     ...
     * \Davispeixoto\OpenTravelAlliance\OTAVehResStatusNotifRS\VehResStatusNotifRSCoreAType
     */
    public function getVehResStatusNotifRSCore()
    {
        return $this->vehResStatusNotifRSCore;
    }

    /**
     * Sets a new vehResStatusNotifRSCore
     *
     * Identifies the common, or core, information associated with the response
     * providing information on the reservation of a rental vehicle.
     *
     ...
     * @return self
     */
    public function setVehResStatusNotifRSCore(
        \Davispeixoto\OpenTravelAlliance\OTAVehResStatusNotifRS\VehResStatusNotifRSCoreAType $vehResStatusNotifRSCore
    ) {
        $this->vehResStatusNotifRSCore = $vehResStatusNotifRSCore;

        return $this;
    }

    /**
     * Gets as vehResStatusNotifRSInfo
     *
     * Identifies the supplemental information associated with the response poviding
     * information on the reservation of a rental vehicle.
     *
     ...
     */
    public function getVehResStatusNotifRSInfo()
    {
        return $this->vehResStatusNotifRSInfo;
    }

    /**
     * Sets a new vehResStatusNotifRSInfo
     *
     * Identifies the supplemental information associated with the response poviding
     * information on the reservation of a rental vehicle.
     *
     ...
     * @return self
     */
    public function setVehResStatusNotifRSInfo(
        \Davispeixoto\OpenTravelAlliance\VehicleResRSAdditionalInfoType $vehResStatusNotifRSInfo
    ) {
        $this->vehResStatusNotifRSInfo = $vehResStatusNotifRSInfo;
