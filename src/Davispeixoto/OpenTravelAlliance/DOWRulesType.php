...
class DOWRulesType
{
     ...
     *
     * @property string $dOWTypeCode
     */
    private $dOWTypeCode = null;
    ...
    /**
     * Sets a new dOWTypeCode
     *
     * This specifies the type of rule for which the day of week or date span applies.
     *
     * @param string $dOWTypeCode
     * @return self
     */
