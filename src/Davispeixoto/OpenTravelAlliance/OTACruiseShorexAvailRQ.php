...
/**
 * Class representing OTACruiseShorexAvailRQ
 */
class OTACruiseShorexAvailRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseShorexAvailRQ\GuestCountsAType\GuestCountAType[]
     * $guestCounts
     */
     ...
     * with the sailing.
     *
     * @property \Davispeixoto\OpenTravelAlliance\CruisePackageType[] $shorexOption
     */
    private $shorexOption = null;
    ...
    public function addToGuestCounts(
        \Davispeixoto\OpenTravelAlliance\OTACruiseShorexAvailRQ\GuestCountsAType\GuestCountAType $guestCount
    ) {
    ...
    /**
     * Adds as shorexOption
     *
     * Specifies the type of package options to query for, that the cruise might offer
     * with the sailing.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\CruisePackageType $shorexOption
     */
    public function addToShorexOption(\Davispeixoto\OpenTravelAlliance\CruisePackageType $shorexOption)
    {
        $this->shorexOption[] = $shorexOption;
     ...
     * @return boolean
     */
    public function issetShorexOption($index)
    {
        return isset($this->shorexOption[$index]);
    }
     ...
     * @return void
     */
    public function unsetShorexOption($index)
    {
        unset($this->shorexOption[$index]);
    }

    /**
     * Gets as shorexOption
     *
     * Specifies the type of package options to query for, that the cruise might offer
     * with the sailing.
     *
     ...
     */
    public function getShorexOption()
    {
        return $this->shorexOption;
    }

    /**
     * Sets a new shorexOption
     *
     * Specifies the type of package options to query for, that the cruise might offer
     * with the sailing.
     *
     ...
     * @return self
     */
    public function setShorexOption(array $shorexOption)
    {
        $this->shorexOption = $shorexOption;
