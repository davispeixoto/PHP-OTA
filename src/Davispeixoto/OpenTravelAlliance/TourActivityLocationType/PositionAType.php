...
class PositionAType
{
    ...
    /**
     * A free-form definition of the destination's position. Could be used as an online
     * mapping service locator.
     *
     ...
     * @return self
     */
    public function setPlacemark($placemark)
    {
