...
/**
 * Class representing OTAScreenTextRS
 */
class OTAScreenTextRS
{
    ...
    /**
     * To specify the message function that is being responded to.
     *
    ...
    /**
     * The container for the screens of text that will be returned.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAScreenTextRS\TextScreensAType
     * $textScreens
     */
    private $textScreens = null;
     ...
     * The container for the screens of text that will be returned.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAScreenTextRS\TextScreensAType
     */
    public function getTextScreens()
    {
        return $this->textScreens;
    }

    /**
     * Sets a new textScreens
     *
     * The container for the screens of text that will be returned.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAScreenTextRS\TextScreensAType
     * $textScreens
     * @return self
     */
    public function setTextScreens(\Davispeixoto\OpenTravelAlliance\OTAScreenTextRS\TextScreensAType $textScreens)
    {
