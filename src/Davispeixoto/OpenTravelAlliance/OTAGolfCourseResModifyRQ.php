...
/**
 * Class representing OTAGolfCourseResModifyRQ
 */
class OTAGolfCourseResModifyRQ
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResModifyRQ\POSAType
     * $pOS
     */
    private $pOS = null;

    /**
     * Golf course tee time reservation(s) to be modified.
     *
     * @property \Davispeixoto\OpenTravelAlliance\TeeTimeModifyType[] $golfCourseRes
     */
     ...
     * Point of Sale identification.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResModifyRQ\POSAType
     */
     ...
     * Point of Sale identification.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResModifyRQ\POSAType $pOS
     * @return self
     */
    public function setPOS(\Davispeixoto\OpenTravelAlliance\OTAGolfCourseResModifyRQ\POSAType $pOS)
    {
        $this->pOS = $pOS;
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\TeeTimeModifyType $golfCourseRes
     */
    public function addToGolfCourseRes(\Davispeixoto\OpenTravelAlliance\TeeTimeModifyType $golfCourseRes)
    {
     ...
     * Golf course tee time reservation(s) to be modified.
     *
     * @return \Davispeixoto\OpenTravelAlliance\TeeTimeModifyType[]
     */
