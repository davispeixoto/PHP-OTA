...
namespace Davispeixoto\OpenTravelAlliance\OTACancelRS\WarningsAType;
...
class WarningAType
{
    ...
    /**
     * Code MAY be used to identify a warning associated with this cancellation and
    ...
    /**
     * Status MAY be used to identify the status of the cancellation. RECOMMENDED
