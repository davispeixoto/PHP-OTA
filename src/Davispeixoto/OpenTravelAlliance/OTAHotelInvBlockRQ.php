...
/**
 * Class representing OTAHotelInvBlockRQ
 */
class OTAHotelInvBlockRQ
{
    ...
    /**
     * Collection of Inventory Block requests criteria.
     *
     * @property
     ...
     */
    private $hotelInvBlockRequests = null;
     ...
     */
    public function addToHotelInvBlockRequests(
        ...
        $this->hotelInvBlockRequests[] = $hotelInvBlockRequest;

        return $this;
    }

    /**
     * isset hotelInvBlockRequests
     *
     * Collection of Inventory Block requests criteria.
     *
     * @param scalar $index
     * @return boolean
     */
    public function issetHotelInvBlockRequests($index)
    {
        return isset($this->hotelInvBlockRequests[$index]);
    }

    /**
     * unset hotelInvBlockRequests
     *
     * Collection of Inventory Block requests criteria.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetHotelInvBlockRequests($index)
    {
        unset($this->hotelInvBlockRequests[$index]);
    }

    /**
     * Gets as hotelInvBlockRequests
     *
     * Collection of Inventory Block requests criteria.
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockRQ\HotelInvBlockRequestsAType\HotelInvBlockRequestAType[]
     */
    public function getHotelInvBlockRequests()
    {
        return $this->hotelInvBlockRequests;
    }

    /**
     * Sets a new hotelInvBlockRequests
     *
     * Collection of Inventory Block requests criteria.
     *
     * @param
     ...
     * @return self
     */
    public function setHotelInvBlockRequests(array $hotelInvBlockRequests)
    {
        $this->hotelInvBlockRequests = $hotelInvBlockRequests;
