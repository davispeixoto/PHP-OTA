...
/**
 * Class representing ListVehChargePurposeType
 *
 * Vehicle charge purpose types.Use: This is a string list of enumerations with an
 ...
 * XSD Type: List_VehChargePurpose
 */
class ListVehChargePurposeType
{
