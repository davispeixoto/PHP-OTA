...
namespace Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ;
...
class RailBookInfoAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType\OriginDestinationAType[]
     * $originDestination
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType\PassengerInfoAType[]
     * $passengerInfo
     */
    ...
    public function addToOriginDestination(
        \Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType\OriginDestinationAType $originDestination
    ) {
    ...
    public function addToPassengerInfo(
        \Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType\PassengerInfoAType $passengerInfo
    ) {
