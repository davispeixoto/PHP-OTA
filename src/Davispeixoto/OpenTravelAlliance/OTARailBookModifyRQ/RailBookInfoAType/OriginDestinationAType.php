...
namespace Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType;
...
class OriginDestinationAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType\OriginDestinationAType\TrainSegmentAType[]
     * $trainSegment
     */
    ...
    public function addToTrainSegment(
        \Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType\OriginDestinationAType\TrainSegmentAType $trainSegment
    ) {
