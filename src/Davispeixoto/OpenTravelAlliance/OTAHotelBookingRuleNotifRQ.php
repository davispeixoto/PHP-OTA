...
/**
 * Class representing OTAHotelBookingRuleNotifRQ
 */
class OTAHotelBookingRuleNotifRQ
{
     ...
     * each BookingRuleNotifRQ, (i.e. the entire message) for tracing of transactions.
     *
    ...
    /**
     * Container for the individual RuleMessage(s). An OTA_HotelBookingRuleNotifRQ
     * contains the booking rules for a single hotel. Hotel identification information
     * are the attributes of this element.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelBookingRuleNotifRQ\RuleMessagesAType
     * $ruleMessages
     */
    private $ruleMessages = null;
     ...
     * @return self
     */
    public function setRuleMessages(
        \Davispeixoto\OpenTravelAlliance\OTAHotelBookingRuleNotifRQ\RuleMessagesAType $ruleMessages
    ) {
