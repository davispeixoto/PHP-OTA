...
/**
 * Class representing OTAHotelResNotifRS
 */
class OTAHotelResNotifRS
{
    ...
    /**
     * An enumerated attribute that contains the status of the processing of the
     * requested hotel reservations, i.e. Pending, Modified and Committed.
     *
