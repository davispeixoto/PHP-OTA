...
/**
 * Class representing OTAAirDetailsRS
 */
class OTAAirDetailsRS
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAAirDetailsRS\FlightDetailsAType[]
     * $flightDetails
     */
    private $flightDetails = null;
    ...
    /**
     * Adds as flightDetails
     *
     * Construct to describe details for a specific flight.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirDetailsRS\FlightDetailsAType
     * $flightDetails
     */
    public function addToFlightDetails(
        \Davispeixoto\OpenTravelAlliance\OTAAirDetailsRS\FlightDetailsAType $flightDetails
    ) {
     ...
     * @return boolean
     */
    public function issetFlightDetails($index)
    {
        return isset($this->flightDetails[$index]);
    }
     ...
     * @return void
     */
    public function unsetFlightDetails($index)
    {
        unset($this->flightDetails[$index]);
    }

    /**
     * Gets as flightDetails
     *
     * Construct to describe details for a specific flight.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAAirDetailsRS\FlightDetailsAType[]
     */
