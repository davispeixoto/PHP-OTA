...
class InsuranceAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivitySearchRS\TourActivityInfoAType\InsuranceAType\PricingAType
     * $pricing
     */
    ...
    public function setPricing(
        \Davispeixoto\OpenTravelAlliance\OTATourActivitySearchRS\TourActivityInfoAType\InsuranceAType\PricingAType $pricing
    ) {
