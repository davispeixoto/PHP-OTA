...
/**
 * Class representing OTACruiseSailAvailRS
 */
class OTACruiseSailAvailRS
{
    ...
    /**
     * Contains the different sailing availability options that customers can choose
     * from.
     *
     * @property
     ...
     * $sailingOptions
     */
    private $sailingOptions = null;

    /**
     * A collection of errors that prevented the processing of a message.
     *
     ...
     * @return boolean
     */
    public function issetSailingOptions($index)
    {
        return isset($this->sailingOptions[$index]);
    }

    /**
     * unset sailingOptions
     *
     * Contains the different sailing availability options that customers can choose
     * from.
     *
     ...
     * @return void
     */
    public function unsetSailingOptions($index)
    {
        unset($this->sailingOptions[$index]);
    }

    /**
     * Gets as sailingOptions
     *
     * Contains the different sailing availability options that customers can choose
     * from.
     *
     ...
     * \Davispeixoto\OpenTravelAlliance\OTACruiseSailAvailRS\SailingOptionsAType\SailingOptionAType[]
     */
    public function getSailingOptions()
    {
        return $this->sailingOptions;
    }

    /**
     * Sets a new sailingOptions
     *
     * Contains the different sailing availability options that customers can choose
     * from.
     *
     ...
     * @return self
     */
    public function setSailingOptions(array $sailingOptions)
    {
        $this->sailingOptions = $sailingOptions;
