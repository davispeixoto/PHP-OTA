...
/**
 * Class representing OTACruiseFareAvailRS
 */
class OTACruiseFareAvailRS
{
    ...
    /**
     * Specifies the selected sailing information.
     *
     * @property \Davispeixoto\OpenTravelAlliance\SailingType $sailingInfo
     */
    private $sailingInfo = null;

    /**
     * Other available currencies for this sailing.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseFareAvailRS\AlternateCurrencyListAType[]
     * $alternateCurrencyList
     */
    private $alternateCurrencyList = null;

    /**
     * Specifies the different fare options available for the selected sailing.
     *
     * @property \Davispeixoto\OpenTravelAlliance\FareCodeOptionType[] $fareCodeOptions
     */
    private $fareCodeOptions = null;
     ...
     * Specifies the selected sailing information.
     *
     * @return \Davispeixoto\OpenTravelAlliance\SailingType
     */
     ...
     * Specifies the selected sailing information.
     *
     * @param \Davispeixoto\OpenTravelAlliance\SailingType $sailingInfo
     * @return self
     */
    public function setSailingInfo(\Davispeixoto\OpenTravelAlliance\SailingType $sailingInfo)
    {
     ...
     * $alternateCurrencyList
     */
    public function addToAlternateCurrencyList(
        \Davispeixoto\OpenTravelAlliance\OTACruiseFareAvailRS\AlternateCurrencyListAType $alternateCurrencyList
    ) {
        $this->alternateCurrencyList[] = $alternateCurrencyList;

        return $this;
    }

    /**
     * isset alternateCurrencyList
     *
     * Other available currencies for this sailing.
     *
     * @param scalar $index
     * @return boolean
     */
    public function issetAlternateCurrencyList($index)
    {
        return isset($this->alternateCurrencyList[$index]);
    }

    /**
     * unset alternateCurrencyList
     *
     * Other available currencies for this sailing.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetAlternateCurrencyList($index)
    {
        unset($this->alternateCurrencyList[$index]);
    }

    /**
     * Gets as alternateCurrencyList
     *
     * Other available currencies for this sailing.
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTACruiseFareAvailRS\AlternateCurrencyListAType[]
     */
    public function getAlternateCurrencyList()
    {
        return $this->alternateCurrencyList;
    }

    /**
     * Sets a new alternateCurrencyList
     *
     * Other available currencies for this sailing.
     *
     * @param
     ...
     * @return self
     */
    public function setAlternateCurrencyList(array $alternateCurrencyList)
    {
        $this->alternateCurrencyList = $alternateCurrencyList;
     ...
     */
    public function addToFareCodeOptions(\Davispeixoto\OpenTravelAlliance\FareCodeOptionType $fareCodeOption)
    {
        $this->fareCodeOptions[] = $fareCodeOption;

        return $this;
    }

    /**
     * isset fareCodeOptions
     *
     * Specifies the different fare options available for the selected sailing.
     *
     * @param scalar $index
     * @return boolean
     */
    public function issetFareCodeOptions($index)
    {
        return isset($this->fareCodeOptions[$index]);
    }

    /**
     * unset fareCodeOptions
     *
     * Specifies the different fare options available for the selected sailing.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetFareCodeOptions($index)
    {
        unset($this->fareCodeOptions[$index]);
    }

    /**
     * Gets as fareCodeOptions
     *
     * Specifies the different fare options available for the selected sailing.
     *
     * @return \Davispeixoto\OpenTravelAlliance\FareCodeOptionType[]
     */
    public function getFareCodeOptions()
    {
        return $this->fareCodeOptions;
    }

    /**
     * Sets a new fareCodeOptions
     *
     * Specifies the different fare options available for the selected sailing.
     *
     * @param \Davispeixoto\OpenTravelAlliance\FareCodeOptionType[] $fareCodeOptions
     * @return self
     */
    public function setFareCodeOptions(array $fareCodeOptions)
    {
        $this->fareCodeOptions = $fareCodeOptions;
