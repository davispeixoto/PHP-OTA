...
/**
 * Class representing OTACruisePriceBookingRS
 */
class OTACruisePriceBookingRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruisePriceBookingRS\ReservationIDAType[]
     * $reservationID
     */
    ...
    /**
     * Specifies price and payment information about the booking.
     *
    ...
    public function addToReservationID(
        \Davispeixoto\OpenTravelAlliance\OTACruisePriceBookingRS\ReservationIDAType $reservationID
    ) {
