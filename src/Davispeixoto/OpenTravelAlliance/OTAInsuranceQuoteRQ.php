...
/**
 * Class representing OTAInsuranceQuoteRQ
 */
class OTAInsuranceQuoteRQ
{
    ...
    /**
     * Container for any Point-of-sale information.
     *
    ...
    /**
     * Requests a quote for a single insurance plan.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAInsuranceQuoteRQ\PlanForQuoteRQAType[]
     * $planForQuoteRQ
     */
    private $planForQuoteRQ = null;
    ...
    /**
     * Adds as planForQuoteRQ
     *
     * Requests a quote for a single insurance plan.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAInsuranceQuoteRQ\PlanForQuoteRQAType
     * $planForQuoteRQ
     */
    public function addToPlanForQuoteRQ(
        \Davispeixoto\OpenTravelAlliance\OTAInsuranceQuoteRQ\PlanForQuoteRQAType $planForQuoteRQ
    ) {
     ...
     * @return boolean
     */
    public function issetPlanForQuoteRQ($index)
    {
        return isset($this->planForQuoteRQ[$index]);
    }

    /**
     * unset planForQuoteRQ
     *
     * Requests a quote for a single insurance plan.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetPlanForQuoteRQ($index)
    {
        unset($this->planForQuoteRQ[$index]);
    }

    /**
     * Gets as planForQuoteRQ
     *
     * Requests a quote for a single insurance plan.
     *
     * @return
     ...
     * @return self
     */
    public function setPlanForQuoteRQ(array $planForQuoteRQ)
    {
        $this->planForQuoteRQ = $planForQuoteRQ;
