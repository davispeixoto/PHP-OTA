...
/**
 * Class representing OTACruiseSpecialServiceAvailRQ
 */
class OTACruiseSpecialServiceAvailRQ
{
    ...
    /**
     * Contains the reservation ID of a booking. If present, then special services
     * available for a booking will be returned.
     *
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\SpecialServiceType $specialService
     */
     ...
     * Used to request details of a specific special service.
     *
     * @param \Davispeixoto\OpenTravelAlliance\SpecialServiceType $specialService
     * @return self
     */
    public function setSpecialService(\Davispeixoto\OpenTravelAlliance\SpecialServiceType $specialService)
    {
