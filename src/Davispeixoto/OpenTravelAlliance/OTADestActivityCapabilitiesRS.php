...
/**
 * Class representing OTADestActivityCapabilitiesRS
 */
class OTADestActivityCapabilitiesRS
{

    /**
     * When 'true, indicates that this system can accept multiple items in a request.
     *
     * @property boolean $multipleItemsInd
     */
    private $multipleItemsInd = null;

    /**
     * When true, indicates that this system can support customer suballocation (not
     * all customers on all items).
     *
     * @property boolean $custSubAllocationInd
     */
    private $custSubAllocationInd = null;

    /**
     * When true, indicates that names (and all other details) are required for *all*
     * customers.
     *
     * @property boolean $fullCustDetailsInd
     */
    private $fullCustDetailsInd = null;
    ...
    /**
     * Gets as multipleItemsInd
     *
     * When 'true, indicates that this system can accept multiple items in a request.
     *
     * @return boolean
     */
    public function getMultipleItemsInd()
    {
        return $this->multipleItemsInd;
    }

    /**
     * Sets a new multipleItemsInd
     *
     * When 'true, indicates that this system can accept multiple items in a request.
     *
     * @param boolean $multipleItemsInd
     * @return self
     */
    public function setMultipleItemsInd($multipleItemsInd)
    {
        $this->multipleItemsInd = $multipleItemsInd;

        return $this;
    }

    /**
     * Gets as custSubAllocationInd
     *
     * When true, indicates that this system can support customer suballocation (not
     * all customers on all items).
     *
     * @return boolean
     */
    public function getCustSubAllocationInd()
    {
        return $this->custSubAllocationInd;
    }

    /**
     * Sets a new custSubAllocationInd
     *
     * When true, indicates that this system can support customer suballocation (not
     * all customers on all items).
     *
     * @param boolean $custSubAllocationInd
     * @return self
     */
    public function setCustSubAllocationInd($custSubAllocationInd)
    {
        $this->custSubAllocationInd = $custSubAllocationInd;

        return $this;
    }

    /**
     * Gets as fullCustDetailsInd
     *
     * When true, indicates that names (and all other details) are required for *all*
     * customers.
     *
     * @return boolean
     */
    public function getFullCustDetailsInd()
    {
        return $this->fullCustDetailsInd;
    }

    /**
     * Sets a new fullCustDetailsInd
     *
     * When true, indicates that names (and all other details) are required for *all*
     * customers.
     *
     * @param boolean $fullCustDetailsInd
     * @return self
     */
    public function setFullCustDetailsInd($fullCustDetailsInd)
    {
        $this->fullCustDetailsInd = $fullCustDetailsInd;
