...
class OTAErrorRS
{
    ...
    /**
     * An indication of the processing that was completed on the request message. An
     * error response may be returned and no action taken on behalf of the request
     * message, or there may be some action taken, or the full action may have been
     * completed.
     *  NotProcessed
     *
    ...
    /**
     * The ErrorCode attribute MUST be present and is defined as free-text with a list
     * of recommended enumerated values, to indicate the error type.
     *
    ...
    /**
     * If present, this attribute refers to an online description of the error that
     * occurred.
     *
