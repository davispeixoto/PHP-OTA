 ...
 *
 * Message initiator information, including country code, currency codes, requestor
 * type and requestor ID.
 * XSD Type: SourceType
 */
class SourceType
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\RequestorIDType $requestorID
     */
     ...
     * @ID_Context MUST be unique.
     *
     * @return \Davispeixoto\OpenTravelAlliance\RequestorIDType
     */
     ...
     * @ID_Context MUST be unique.
     *
     * @param \Davispeixoto\OpenTravelAlliance\RequestorIDType $requestorID
     * @return self
     */
    public function setRequestorID(\Davispeixoto\OpenTravelAlliance\RequestorIDType $requestorID)
    {
