...
class RateQualifierAType
{
    ...
    /**
     * When true, the booking has been modified in such a way that the rate may be
     * changed.
     *
     * @property boolean $rateModifiedInd
     */
    private $rateModifiedInd = null;
     ...
     * @return boolean
     */
    public function getRateModifiedInd()
    {
        return $this->rateModifiedInd;
    }

    /**
     * Sets a new rateModifiedInd
     *
     * When true, the booking has been modified in such a way that the rate may be
     * changed.
     *
     * @param boolean $rateModifiedInd
     * @return self
     */
    public function setRateModifiedInd($rateModifiedInd)
    {
        $this->rateModifiedInd = $rateModifiedInd;
