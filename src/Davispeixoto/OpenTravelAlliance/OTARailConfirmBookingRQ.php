...
/**
 * Class representing OTARailConfirmBookingRQ
 */
class OTARailConfirmBookingRQ
{
    ...
    /**
     * If true, the rail reservation details are to be returned in the response.
     *
     * @property boolean $reservationDetailsInd
     */
    private $reservationDetailsInd = null;
    ...
    /**
     * The unique ID's of the provisional(unconfirmed) booking request(s) to be
     * committed. Note that the @Type attribute will typically contain a value of 23
     * which is a "Provisional reservation" - See OpenTravel Code List Unique ID Type
     * (UIT).
     *
    ...
    /**
     * Gets as reservationDetailsInd
     *
     * If true, the rail reservation details are to be returned in the response.
     *
     * @return boolean
     */
    public function getReservationDetailsInd()
    {
        return $this->reservationDetailsInd;
    }

    /**
     * Sets a new reservationDetailsInd
     *
     * If true, the rail reservation details are to be returned in the response.
     *
     * @param boolean $reservationDetailsInd
     * @return self
     */
    public function setReservationDetailsInd($reservationDetailsInd)
    {
        $this->reservationDetailsInd = $reservationDetailsInd;
