...
/**
 * Class representing OTARailAvailRS
 */
class OTARailAvailRS
{
    ...
    /**
     * Information on the locations between which availability was requested. This
     * provides for multiple origin/destination pairs in one request message.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailAvailRS\OriginDestinationInformationAType[]
    ...
    public function addToOriginDestinationInformation(
        \Davispeixoto\OpenTravelAlliance\OTARailAvailRS\OriginDestinationInformationAType $originDestinationInformation
    ) {
