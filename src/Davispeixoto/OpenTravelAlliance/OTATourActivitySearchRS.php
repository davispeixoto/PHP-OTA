...
/**
 * Class representing OTATourActivitySearchRS
 */
class OTATourActivitySearchRS
{
    ...
    /**
     * Information that may have directly impacted how the receiving system processed
     * the request message.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivitySearchRS\ProcessingInformationAType
     * $processingInformation
     */
    private $processingInformation = null;

    /**
     * A collection of tours and/or activities with an indicator is this is an
     * alternate tour/ activity, e.g. it does not meet the exact search criteria
     * specified. Note that availability is not returned in a search response.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivitySearchRS\TourActivityInfoAType[]
     * $tourActivityInfo
     */
    ...
    public function setProcessingInformation(
        \Davispeixoto\OpenTravelAlliance\OTATourActivitySearchRS\ProcessingInformationAType $processingInformation
    ) {
    ...
    public function addToTourActivityInfo(
        \Davispeixoto\OpenTravelAlliance\OTATourActivitySearchRS\TourActivityInfoAType $tourActivityInfo
    ) {
