...
/**
 * Class representing ListTransactionActionType
 *
 * Transaction actions.Use: This is a string list of enumerations with an "Other_"
 ...
 * XSD Type: List_TransactionAction
 */
class ListTransactionActionType
{
