...
/**
 * Class representing OTAHotelPostEventNotifRQ
 */
class OTAHotelPostEventNotifRQ
{
    ...
    /**
     * Identifes the party sending the message.
     *
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\EventReportType[] $eventReports
     */
    private $eventReports = null;
     ...
     */
    public function addToEventReports(\Davispeixoto\OpenTravelAlliance\EventReportType $eventReport)
    {
     ...
     * @return boolean
     */
    public function issetEventReports($index)
    {
        return isset($this->eventReports[$index]);
    }
     ...
     * @return void
     */
    public function unsetEventReports($index)
    {
        unset($this->eventReports[$index]);
    }

    /**
     * Gets as eventReports
     *
     * Collection of event reports.
     *
    ...
    /**
     * Sets a new eventReports
     *
     * Collection of event reports.
     *
     * @param \Davispeixoto\OpenTravelAlliance\EventReportType[] $eventReports
     * @return self
     */
    public function setEventReports(array $eventReports)
    {
