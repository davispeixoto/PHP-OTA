...
class InvCountType
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\BaseInvCountType[] $inventory
     */
    private $inventory = null;

    /**
     * The unique identifier element allows the trading partners to uniquely identify
     * each Inventory Count Message, for transaction tracability.
     *
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\BaseInvCountType $inventory
     */
    public function addToInventory(\Davispeixoto\OpenTravelAlliance\BaseInvCountType $inventory)
    {
     ...
     * This is the inventory information for a given rate plan, room type, date, etc.
     *
     * @return \Davispeixoto\OpenTravelAlliance\BaseInvCountType[]
     */
