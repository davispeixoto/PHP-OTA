...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelStatsRQ\RequestedHotelsAType;

/**
 * Class representing RequestedHotelAType
 */
class RequestedHotelAType
{
    ...
    /**
     * Collection of requested statistical reports.
     *
     * @property
     ...
     * $requestedReport
     */
    public function addToRequestedReports(
        ...
        $this->requestedReports[] = $requestedReport;

        return $this;
    }

    /**
     * isset requestedReports
     *
     * Collection of requested statistical reports.
     *
     * @param scalar $index
     * @return boolean
     */
    public function issetRequestedReports($index)
    {
        return isset($this->requestedReports[$index]);
    }

    /**
     * unset requestedReports
     *
     * Collection of requested statistical reports.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetRequestedReports($index)
    {
        unset($this->requestedReports[$index]);
    }

    /**
     * Gets as requestedReports
     *
     * Collection of requested statistical reports.
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTAHotelStatsRQ\RequestedHotelsAType\RequestedHotelAType\RequestedReportsAType\RequestedReportAType[]
     */
    public function getRequestedReports()
    {
        return $this->requestedReports;
    }

    /**
     * Sets a new requestedReports
     *
     * Collection of requested statistical reports.
     *
     * @param
     ...
     * @return self
     */
    public function setRequestedReports(array $requestedReports)
    {
