...
class PaymentRulesAType extends PaymentRulesType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGroundAvailRS\GroundServicesAType\GroundServiceAType\PaymentRulesAType\AcceptablePaymentsAType[]
     * $acceptablePayments
     */
    ...
    public function addToAcceptablePayments(
        \Davispeixoto\OpenTravelAlliance\OTAGroundAvailRS\GroundServicesAType\GroundServiceAType\PaymentRulesAType\AcceptablePaymentsAType $acceptablePayments
    ) {
