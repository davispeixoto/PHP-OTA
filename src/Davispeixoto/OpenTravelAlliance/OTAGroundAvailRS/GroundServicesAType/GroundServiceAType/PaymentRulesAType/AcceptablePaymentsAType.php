...
namespace Davispeixoto\OpenTravelAlliance\OTAGroundAvailRS\GroundServicesAType\GroundServiceAType\PaymentRulesAType;
...
class AcceptablePaymentsAType
{
    ...
    /**
     * Specifies the type of payment (i.e., guarantee, deposit). Refer to OpenTravel
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGroundAvailRS\GroundServicesAType\GroundServiceAType\PaymentRulesAType\AcceptablePaymentsAType\AcceptablePaymentAType[]
     * $acceptablePayment
     */
    ...
    public function addToAcceptablePayment(
        \Davispeixoto\OpenTravelAlliance\OTAGroundAvailRS\GroundServicesAType\GroundServiceAType\PaymentRulesAType\AcceptablePaymentsAType\AcceptablePaymentAType $acceptablePayment
    ) {
