...
namespace Davispeixoto\OpenTravelAlliance\OTAAirAvailRS\OriginDestinationInformationAType\OriginDestinationOptionsAType\OriginDestinationOptionAType;
...
class FlightSegmentAType extends FlightSegmentType
{
    ...
    /**
     * When true, optional services are available for this flight.
     *
     * @property boolean $optionalServicesInd
     */
    private $optionalServicesInd = null;

    /**
     * Traffic restriction information for a specific flight.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirAvailRS\OriginDestinationInformationAType\OriginDestinationOptionsAType\OriginDestinationOptionAType\FlightSegmentAType\TrafficRestrictionInfoAType[]
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirAvailRS\OriginDestinationInformationAType\OriginDestinationOptionsAType\OriginDestinationOptionAType\FlightSegmentAType\BookingClassAvailAType[]
     * $bookingClassAvail
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirAvailRS\OriginDestinationInformationAType\OriginDestinationOptionsAType\OriginDestinationOptionAType\FlightSegmentAType\StopLocationAType[]
     * $stopLocation
     */
    ...
    /**
     * Gets as optionalServicesInd
     *
     * When true, optional services are available for this flight.
     *
     * @return boolean
     */
    public function getOptionalServicesInd()
    {
        return $this->optionalServicesInd;
    }

    /**
     * Sets a new optionalServicesInd
     *
     * When true, optional services are available for this flight.
     *
     * @param boolean $optionalServicesInd
     * @return self
     */
    public function setOptionalServicesInd($optionalServicesInd)
    {
        $this->optionalServicesInd = $optionalServicesInd;
    ...
    public function addToTrafficRestrictionInfo(
        \Davispeixoto\OpenTravelAlliance\OTAAirAvailRS\OriginDestinationInformationAType\OriginDestinationOptionsAType\OriginDestinationOptionAType\FlightSegmentAType\TrafficRestrictionInfoAType $trafficRestrictionInfo
    ) {
    ...
    public function addToBookingClassAvail(
        \Davispeixoto\OpenTravelAlliance\OTAAirAvailRS\OriginDestinationInformationAType\OriginDestinationOptionsAType\OriginDestinationOptionAType\FlightSegmentAType\BookingClassAvailAType $bookingClassAvail
    ) {
    ...
    public function addToStopLocation(
        \Davispeixoto\OpenTravelAlliance\OTAAirAvailRS\OriginDestinationInformationAType\OriginDestinationOptionsAType\OriginDestinationOptionAType\FlightSegmentAType\StopLocationAType $stopLocation
    ) {
