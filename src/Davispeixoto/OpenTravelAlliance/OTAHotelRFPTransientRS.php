...
/**
 * Class representing OTAHotelRFPTransientRS
 */
class OTAHotelRFPTransientRS
{
    ...
    /**
     * Used to pass non-fatal communication.
     *
    ...
    /**
     * This has the ability to hold both the information for an acknowlegement as well
     * as the full response depending on its use.
     *
     * @property \Davispeixoto\OpenTravelAlliance\RFPTransientDetailsType
     * $rFPTransientDetail
     */
    private $rFPTransientDetail = null;
    ...
    /**
     * Gets as rFPTransientDetail
     *
     * This has the ability to hold both the information for an acknowlegement as well
     * as the full response depending on its use.
     *
     * @return \Davispeixoto\OpenTravelAlliance\RFPTransientDetailsType
     */
    public function getRFPTransientDetail()
    {
        return $this->rFPTransientDetail;
    }

    /**
     * Sets a new rFPTransientDetail
     *
     * This has the ability to hold both the information for an acknowlegement as well
     * as the full response depending on its use.
     *
     * @param \Davispeixoto\OpenTravelAlliance\RFPTransientDetailsType
     * $rFPTransientDetail
     * @return self
     */
    public function setRFPTransientDetail(\Davispeixoto\OpenTravelAlliance\RFPTransientDetailsType $rFPTransientDetail)
    {
        $this->rFPTransientDetail = $rFPTransientDetail;
