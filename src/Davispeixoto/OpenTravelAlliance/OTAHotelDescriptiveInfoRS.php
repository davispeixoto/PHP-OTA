...
/**
 * Class representing OTAHotelDescriptiveInfoRS
 */
class OTAHotelDescriptiveInfoRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelDescriptiveInfoRS\HotelDescriptiveContentsAType
    ...
    public function setHotelDescriptiveContents(
        \Davispeixoto\OpenTravelAlliance\OTAHotelDescriptiveInfoRS\HotelDescriptiveContentsAType $hotelDescriptiveContents
    ) {
