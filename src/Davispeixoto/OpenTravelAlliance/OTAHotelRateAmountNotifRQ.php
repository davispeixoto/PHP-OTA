...
/**
 * Class representing OTAHotelRateAmountNotifRQ
 */
class OTAHotelRateAmountNotifRQ
{
    ...
    /**
     * Notification type.Example: DeltaNote: This indicates whether this is an update
     * of changed rate amounts, instructions to remove rate amounts or a full
     * replacement of rate amounts for specified products.
     *
     * @property string $notifType
     */
    private $notifType = null;

    /**
     * Change scope.Example: RatePlanRateNote: This indicates the scope of the changes
     * in the notification.
     *
     * @property string $notifScopeType
     */
    private $notifScopeType = null;
     ...
     * each RateAmountNotifRQ, (i.e. the entire message) for transaction tracability.
     *
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelRateAmountNotifRQ\RateAmountMessagesAType
     * $rateAmountMessages
     */
     ...
     * @return string
     */
    public function getNotifScopeType()
    {
        return $this->notifScopeType;
    }

    /**
     * Sets a new notifScopeType
     *
     * Change scope.Example: RatePlanRateNote: This indicates the scope of the changes
     * in the notification.
     *
     * @param string $notifScopeType
     * @return self
     */
    public function setNotifScopeType($notifScopeType)
    {
        $this->notifScopeType = $notifScopeType;
    ...
    public function setRateAmountMessages(
        \Davispeixoto\OpenTravelAlliance\OTAHotelRateAmountNotifRQ\RateAmountMessagesAType $rateAmountMessages
    ) {
