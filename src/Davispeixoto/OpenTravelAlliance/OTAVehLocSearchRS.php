...
/**
 * Class representing OTAVehLocSearchRS
 */
class OTAVehLocSearchRS
{
    ...
    /**
     * A collection of vehicle locations that match the search criteria.
     *
     * @property \Davispeixoto\OpenTravelAlliance\VehicleMatchedLocationType[]
     * $vehMatchedLocs
     */
    private $vehMatchedLocs = null;

    /**
     * Information on the vendor associated with the locations identified in the
     * response.
     *
     ...
     * $vehMatchedLoc
     */
    public function addToVehMatchedLocs(\Davispeixoto\OpenTravelAlliance\VehicleMatchedLocationType $vehMatchedLoc)
    {
        $this->vehMatchedLocs[] = $vehMatchedLoc;

        return $this;
    }

    /**
     * isset vehMatchedLocs
     *
     * A collection of vehicle locations that match the search criteria.
     *
     * @param scalar $index
     * @return boolean
     */
    public function issetVehMatchedLocs($index)
    {
        return isset($this->vehMatchedLocs[$index]);
    }

    /**
     * unset vehMatchedLocs
     *
     * A collection of vehicle locations that match the search criteria.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetVehMatchedLocs($index)
    {
        unset($this->vehMatchedLocs[$index]);
    }

    /**
     * Gets as vehMatchedLocs
     *
     * A collection of vehicle locations that match the search criteria.
     *
     ...
     * @return self
     */
    public function setVehMatchedLocs(array $vehMatchedLocs)
    {
