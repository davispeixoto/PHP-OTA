...
/**
 * Class representing OTAPkgCostRS
 */
class OTAPkgCostRS
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAPkgCostRS\PackageAType $package
     */
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\ExtrasInfoType[] $availableExtras
     */
    private $availableExtras = null;
     ...
     * Details of the selected package.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAPkgCostRS\PackageAType
     */
     ...
     * Details of the selected package.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAPkgCostRS\PackageAType $package
     * @return self
     */
    public function setPackage(\Davispeixoto\OpenTravelAlliance\OTAPkgCostRS\PackageAType $package)
    {
     ...
     */
    public function addToAvailableExtras(\Davispeixoto\OpenTravelAlliance\ExtrasInfoType $availableExtra)
    {
        $this->availableExtras[] = $availableExtra;

        return $this;
    }

    /**
     * isset availableExtras
     *
     * A collection of extras which are bookable with the selected holiday package.
     *
     * @param scalar $index
     * @return boolean
     */
    public function issetAvailableExtras($index)
    {
        return isset($this->availableExtras[$index]);
    }

    /**
     * unset availableExtras
     *
     * A collection of extras which are bookable with the selected holiday package.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetAvailableExtras($index)
    {
        unset($this->availableExtras[$index]);
    }

    /**
     * Gets as availableExtras
     *
     * A collection of extras which are bookable with the selected holiday package.
     *
    ...
    /**
     * Sets a new availableExtras
     *
     * A collection of extras which are bookable with the selected holiday package.
     *
     * @param \Davispeixoto\OpenTravelAlliance\ExtrasInfoType[] $availableExtras
     * @return self
     */
    public function setAvailableExtras(array $availableExtras)
    {
