...
/**
 * Class representing OTAVehRetResRS
 */
class OTAVehRetResRS
{
    ...
    /**
     * Returning an empty element of this type indicates the successful processing of
     * an OpenTravel message. This is used in conjunction with Warnings to report any
     * warnings or business errors.
     *
    ...
    /**
     * Core information associated with the retrieval of a vehicle reservation.
     *
     * @property \Davispeixoto\OpenTravelAlliance\VehicleRetrieveResRSCoreType
     * $vehRetResRSCore
     */
    private $vehRetResRSCore = null;

    /**
     * Additional information associated with the retrieval of a vehicle reservation.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\VehicleRetrieveResRSAdditionalInfoType
     * $vehRetResRSInfo
     */
    private $vehRetResRSInfo = null;

    /**
     * Indicates an error occurred during the processing of an OpenTravel message. If
     * the message successfully processes, but there are business errors, those errors
     * should be passed in the warning element.
     *
    ...
    /**
     * Gets as vehRetResRSCore
     *
     * Core information associated with the retrieval of a vehicle reservation.
     *
     * @return \Davispeixoto\OpenTravelAlliance\VehicleRetrieveResRSCoreType
     */
    ...
    /**
     * Sets a new vehRetResRSCore
     *
     * Core information associated with the retrieval of a vehicle reservation.
     *
     * @param \Davispeixoto\OpenTravelAlliance\VehicleRetrieveResRSCoreType
     * $vehRetResRSCore
     * @return self
     */
    public function setVehRetResRSCore(\Davispeixoto\OpenTravelAlliance\VehicleRetrieveResRSCoreType $vehRetResRSCore)
    {
    ...
    /**
     * Gets as vehRetResRSInfo
     *
     * Additional information associated with the retrieval of a vehicle reservation.
     *
     * @return \Davispeixoto\OpenTravelAlliance\VehicleRetrieveResRSAdditionalInfoType
     */
    ...
    /**
     * Sets a new vehRetResRSInfo
     *
     * Additional information associated with the retrieval of a vehicle reservation.
     *
     * @param \Davispeixoto\OpenTravelAlliance\VehicleRetrieveResRSAdditionalInfoType
     * $vehRetResRSInfo
     * @return self
     */
    public function setVehRetResRSInfo(
        \Davispeixoto\OpenTravelAlliance\VehicleRetrieveResRSAdditionalInfoType $vehRetResRSInfo
    ) {
