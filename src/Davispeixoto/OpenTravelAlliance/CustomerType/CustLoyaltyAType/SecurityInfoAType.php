...
class SecurityInfoAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\CustomerType\CustLoyaltyAType\SecurityInfoAType\PasswordHintAType[]
     * $passwordHint
     */
    ...
    public function addToPasswordHint(
        \Davispeixoto\OpenTravelAlliance\CustomerType\CustLoyaltyAType\SecurityInfoAType\PasswordHintAType $passwordHint
    ) {
