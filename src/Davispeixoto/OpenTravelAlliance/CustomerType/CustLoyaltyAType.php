...
class CustLoyaltyAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\CustomerType\CustLoyaltyAType\MemberPreferencesAType
     * $memberPreferences
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\CustomerType\CustLoyaltyAType\SecurityInfoAType
     * $securityInfo
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\CustomerType\CustLoyaltyAType\SubAccountBalanceAType[]
     * $subAccountBalance
     */
    ...
    public function setMemberPreferences(
        \Davispeixoto\OpenTravelAlliance\CustomerType\CustLoyaltyAType\MemberPreferencesAType $memberPreferences
    ) {
     ...
     * @return self
     */
    public function setSecurityInfo(
        \Davispeixoto\OpenTravelAlliance\CustomerType\CustLoyaltyAType\SecurityInfoAType $securityInfo
    ) {
    ...
    public function addToSubAccountBalance(
        \Davispeixoto\OpenTravelAlliance\CustomerType\CustLoyaltyAType\SubAccountBalanceAType $subAccountBalance
    ) {
