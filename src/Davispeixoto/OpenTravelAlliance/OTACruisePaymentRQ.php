...
/**
 * Class representing OTACruisePaymentRQ
 */
class OTACruisePaymentRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruisePaymentRQ\ReservationPaymentAType[]
     * $reservationPayment
     */
    private $reservationPayment = null;

    /**
     * Provides additional agent-level information when processing a cruise payment.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTACruisePaymentRQ\AgentInfoAType
     * $agentInfo
     */
     ...
     * $reservationPayment
     */
    public function addToReservationPayment(
        \Davispeixoto\OpenTravelAlliance\OTACruisePaymentRQ\ReservationPaymentAType $reservationPayment
    ) {
     ...
     * @return boolean
     */
    public function issetReservationPayment($index)
    {
        return isset($this->reservationPayment[$index]);
    }

    /**
     * unset reservationPayment
     *
     * Payment information for a reservation.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetReservationPayment($index)
    {
        unset($this->reservationPayment[$index]);
    }

    /**
     * Gets as reservationPayment
     *
     * Payment information for a reservation.
     *
     * @return
     ...
     * @return self
     */
    public function setReservationPayment(array $reservationPayment)
    {
        $this->reservationPayment = $reservationPayment;
     ...
     * Provides additional agent-level information when processing a cruise payment.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTACruisePaymentRQ\AgentInfoAType
     */
     ...
     * Provides additional agent-level information when processing a cruise payment.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTACruisePaymentRQ\AgentInfoAType
     * $agentInfo
     * @return self
     */
    public function setAgentInfo(\Davispeixoto\OpenTravelAlliance\OTACruisePaymentRQ\AgentInfoAType $agentInfo)
    {
