...
class OTAPingRS
{
    ...
    /**
     * The free-text data that is to be echoed back that indicates the ping request was
     * accepted and processed.
     *
     * @property string[] $echoData
     */
     ...
     */
    public function addToEchoData($echoData)
    {
     ...
     * @return boolean
     */
    public function issetEchoData($index)
    {
        return isset($this->echoData[$index]);
    }
     ...
     * @return void
     */
    public function unsetEchoData($index)
    {
        unset($this->echoData[$index]);
    }
     ...
     * @return self
     */
    public function setEchoData(array $echoData)
    {
        $this->echoData = $echoData;
