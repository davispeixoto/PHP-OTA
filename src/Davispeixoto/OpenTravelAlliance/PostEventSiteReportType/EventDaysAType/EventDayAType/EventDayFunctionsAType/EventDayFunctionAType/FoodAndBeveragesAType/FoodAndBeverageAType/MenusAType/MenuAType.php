...
namespace Davispeixoto\OpenTravelAlliance\PostEventSiteReportType\EventDaysAType\EventDayAType\EventDayFunctionsAType\EventDayFunctionAType\FoodAndBeveragesAType\FoodAndBeverageAType\MenusAType;
...
class MenuAType
{
    ...
    /**
     * Defines how the charge is applied (e.g. per person, per gallon, per tray). Use
