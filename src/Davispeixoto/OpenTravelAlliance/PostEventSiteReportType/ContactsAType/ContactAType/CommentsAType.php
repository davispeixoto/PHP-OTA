...
namespace Davispeixoto\OpenTravelAlliance\PostEventSiteReportType\ContactsAType\ContactAType;
...
class CommentsAType
{
    ...
    /**
     * Used to provide additional information about the contact or the contact
     * organization.
     *
