...
/**
 * Class representing OTARailResRetrieveDetailRS
 */
class OTARailResRetrieveDetailRS
{
    ...
    /**
     * Represents the train reservation that was previously created.
     *
     * @property \Davispeixoto\OpenTravelAlliance\RailReservationType[]
     * $railReservation
     */
     ...
     */
    public function addToRailReservation(\Davispeixoto\OpenTravelAlliance\RailReservationType $railReservation)
    {
