...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelRatePlanRQ\RatePlansAType\RatePlanAType;
...
class OffersAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelRatePlanRQ\RatePlansAType\RatePlanAType\OffersAType\OfferAType[]
     * $offer
     */
    private $offer = null;
    ...
    public function addToOffer(
        \Davispeixoto\OpenTravelAlliance\OTAHotelRatePlanRQ\RatePlansAType\RatePlanAType\OffersAType\OfferAType $offer
    ) {
        $this->offer[] = $offer;
