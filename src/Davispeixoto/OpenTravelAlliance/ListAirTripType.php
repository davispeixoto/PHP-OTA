...
/**
 * Class representing ListAirTripType
 *
 * Air trip types.Use: This is a string list of enumerations with an "Other_"
 ...
 * XSD Type: List_AirTripType
 */
class ListAirTripType
{
