...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelResRS\HotelReservationsAType\HotelReservationAType\RoomStaysAType\RoomStayAType\GuestCountsAType;
...
class GuestCountAType
{
    ...
    /**
     * The AgeQualifyingCode specifies a code representing the age type of the guest(s)
    ...
    /**
     * Age MAY be used to specify the age of the guest(s).
     *
