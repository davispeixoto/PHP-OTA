...
class ProcessingInformationAType
{
    ...
    /**
     * The Tour/Activity response message may return a value in this element if there
     * is additional data available that is not contained in the response message. The
     * text value should be echoed in this request to indicate where to begin the next
     * block of data.
     *
