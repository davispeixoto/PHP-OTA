...
class SummaryAType extends TourActivityChargeType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\PricingAType\SummaryAType\PricingTypeAType
     * $pricingType
     */
    ...
    public function setPricingType(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\PricingAType\SummaryAType\PricingTypeAType $pricingType
    ) {
