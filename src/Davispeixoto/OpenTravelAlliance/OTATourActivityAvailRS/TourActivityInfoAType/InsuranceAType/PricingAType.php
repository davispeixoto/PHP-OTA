...
namespace Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\InsuranceAType;
...
class PricingAType extends TourActivityChargeType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\InsuranceAType\PricingAType\PricingTypeAType
     * $pricingType
     */
    ...
    public function setPricingType(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\InsuranceAType\PricingAType\PricingTypeAType $pricingType
    ) {
