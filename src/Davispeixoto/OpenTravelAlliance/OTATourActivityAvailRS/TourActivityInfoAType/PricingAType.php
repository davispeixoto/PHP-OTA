...
class PricingAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\PricingAType\SummaryAType
     * $summary
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\PricingAType\ParticipantCategoryAType[]
     * $participantCategory
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\PricingAType\GroupAType[]
     * $group
     */
    private $group = null;
    ...
    public function setSummary(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\PricingAType\SummaryAType $summary
    ) {
    ...
    public function addToParticipantCategory(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\PricingAType\ParticipantCategoryAType $participantCategory
    ) {
    ...
    public function addToGroup(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\PricingAType\GroupAType $group
    ) {
        $this->group[] = $group;
