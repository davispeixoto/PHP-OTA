...
class InsuranceAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\InsuranceAType\PricingAType
     * $pricing
     */
    ...
    public function setPricing(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRS\TourActivityInfoAType\InsuranceAType\PricingAType $pricing
    ) {
