...
/**
 * Class representing OTALoyaltyAccountCreateRQ
 */
class OTALoyaltyAccountCreateRQ
{
    ...
    /**
     * Information associated with a loyalty account.
     *
     ...
     * @return self
     */
    public function setAccountInfo(\Davispeixoto\OpenTravelAlliance\AccountInfoType $accountInfo)
    {
