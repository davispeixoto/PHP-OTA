...
/**
 * Class representing OTAGolfCourseResRS
 */
class OTAGolfCourseResRS
{
    ...
    /**
     * Success: Standard way to indicate successful processing of an OpenTravel
     * message. Returning an empty element of this type indicates success.
     *
    ...
    /**
     * Transaction processing information, including display currency overrides. If no
     * display or pricing currency information is provided, the display currency will
     * default to the value in POS/Source/ @ISOCurrency.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRS\ProcessingInfoAType
     * $processingInfo
     */
    private $processingInfo = null;

    /**
     * Information about the golf reservation(s).
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRS\GolfCourseResAType[]
     * $golfCourseRes
     */
    private $golfCourseRes = null;
     ...
     * default to the value in POS/Source/ @ISOCurrency.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRS\ProcessingInfoAType
     */
     ...
     * default to the value in POS/Source/ @ISOCurrency.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRS\ProcessingInfoAType
     * $processingInfo
     * @return self
     */
    public function setProcessingInfo(
        \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRS\ProcessingInfoAType $processingInfo
    ) {
    ...
    /**
     * Adds as golfCourseRes
     *
     * Information about the golf reservation(s).
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRS\GolfCourseResAType
     * $golfCourseRes
     */
    public function addToGolfCourseRes(
        \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRS\GolfCourseResAType $golfCourseRes
    ) {
        $this->golfCourseRes[] = $golfCourseRes;
     ...
     * @return boolean
     */
    public function issetGolfCourseRes($index)
    {
        return isset($this->golfCourseRes[$index]);
    }
     ...
     * @return void
     */
    public function unsetGolfCourseRes($index)
    {
        unset($this->golfCourseRes[$index]);
    }

    /**
     * Gets as golfCourseRes
     *
     * Information about the golf reservation(s).
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRS\GolfCourseResAType[]
     */
    public function getGolfCourseRes()
    {
        return $this->golfCourseRes;
    }

    /**
     * Sets a new golfCourseRes
     *
     * Information about the golf reservation(s).
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRS\GolfCourseResAType[]
     ...
     * @return self
     */
    public function setGolfCourseRes(array $golfCourseRes)
    {
        $this->golfCourseRes = $golfCourseRes;
