...
class CancelPolicyAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeType\PolicyAType\CancelPolicyAType\DeadlineAType
     * $deadline
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeType\PolicyAType\CancelPolicyAType\AmountPercentAType
     * $amountPercent
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeType\PolicyAType\CancelPolicyAType\GuaranteeAcceptedAType[]
     * $guaranteeAccepted
     */
    ...
    public function setDeadline(
        \Davispeixoto\OpenTravelAlliance\TeeTimeType\PolicyAType\CancelPolicyAType\DeadlineAType $deadline
    ) {
    ...
    public function setAmountPercent(
        \Davispeixoto\OpenTravelAlliance\TeeTimeType\PolicyAType\CancelPolicyAType\AmountPercentAType $amountPercent
    ) {
    ...
    public function addToGuaranteeAccepted(
        \Davispeixoto\OpenTravelAlliance\TeeTimeType\PolicyAType\CancelPolicyAType\GuaranteeAcceptedAType $guaranteeAccepted
    ) {
