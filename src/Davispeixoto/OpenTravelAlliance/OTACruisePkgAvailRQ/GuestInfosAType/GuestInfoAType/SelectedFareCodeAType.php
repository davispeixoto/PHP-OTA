...
namespace Davispeixoto\OpenTravelAlliance\OTACruisePkgAvailRQ\GuestInfosAType\GuestInfoAType;

/**
 * Class representing SelectedFareCodeAType
 */
class SelectedFareCodeAType
{
