...
/**
 * Class representing OTAPkgAvailRQ
 */
class OTAPkgAvailRQ
{
    ...
    /**
     * Information identifying the package for which availability is being requested.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAPkgAvailRQ\PackageRequestAType
     * $packageRequest
     */
    private $packageRequest = null;

    /**
     * Categorization of all Customers in a reservation or request.
     *
     * @property
    ...
    /**
     * An alternative method of identifying the full tour package.
     *
     ...
     * Information identifying the package for which availability is being requested.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAPkgAvailRQ\PackageRequestAType
     */
     ...
     * Information identifying the package for which availability is being requested.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAPkgAvailRQ\PackageRequestAType
     * $packageRequest
     * @return self
     */
    public function setPackageRequest(
        \Davispeixoto\OpenTravelAlliance\OTAPkgAvailRQ\PackageRequestAType $packageRequest
    ) {
