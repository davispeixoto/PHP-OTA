...
/**
 * Class representing OTALoyaltyAccountRS
 */
class OTALoyaltyAccountRS
{
    ...
    /**
     * Loyalty account information, including member information, preferences, security
     * and sub-account balances.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTALoyaltyAccountRS\AccountInfoAType
     * $accountInfo
     */
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\LocationType $location
     */
     ...
     * and sub-account balances.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTALoyaltyAccountRS\AccountInfoAType
     */
     ...
     * and sub-account balances.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTALoyaltyAccountRS\AccountInfoAType
     * $accountInfo
     * @return self
     */
    public function setAccountInfo(\Davispeixoto\OpenTravelAlliance\OTALoyaltyAccountRS\AccountInfoAType $accountInfo)
    {
     ...
     * The location code where the enrollment originated.
     *
     * @param \Davispeixoto\OpenTravelAlliance\LocationType $location
     * @return self
     */
    public function setLocation(\Davispeixoto\OpenTravelAlliance\LocationType $location)
    {
