...
use Davispeixoto\OpenTravelAlliance\VehicleAgeRequirementsType;

/**
 * Class representing AgeRequirementsAType
 */
class AgeRequirementsAType extends VehicleAgeRequirementsType
{
