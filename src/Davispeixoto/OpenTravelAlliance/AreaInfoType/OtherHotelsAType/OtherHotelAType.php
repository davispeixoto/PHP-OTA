...
namespace Davispeixoto\OpenTravelAlliance\AreaInfoType\OtherHotelsAType;
...
class OtherHotelAType
{
    ...
    /**
     * When true, indicates this hotel is a competitor. When false, this hotel is not a
     * competitor.
     *
     * @property boolean $competitorIndicator
     */
    private $competitorIndicator = null;

    /**
     * Identifies the segment (e.g., luxury, upscale, extended stay) of the other
     * hotel. Refer to OpenTravel Codelist SEG.
     *
    ...
    /**
     * An ID as created by the source system (e.g. when passing competitor information,
     * this would be the ID stored in the competitor's system).
     *
     * @property string $iD
     */
    private $iD = null;
    ...
    /**
     * An ID as created by the non-source system (e.g. when passing competitor
     * information, this would be the ID stored in the local company's system).
     *
    ...
    /**
     * Descriptive Content Reference ID.Example: 1Note: This descriptive content
     * reference ID was defined elsewhere in this message
     ...
     *
     * @property string $hotelReferenceRPH
     */
     ...
     * competitor.
     *
     * @param boolean $competitorIndicator
     * @return self
     */
