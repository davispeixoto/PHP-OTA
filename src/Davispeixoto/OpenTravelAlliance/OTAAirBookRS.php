...
/**
 * Class representing OTAAirBookRS
 */
class OTAAirBookRS
{
    ...
    /**
     * When true, pricing was requested along with the booking.
     *
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAAirBookRS\AirReservationAType[]
     * $airReservation
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirBookRS\AirReservationAType
     * $airReservation
     */
    public function addToAirReservation(
        \Davispeixoto\OpenTravelAlliance\OTAAirBookRS\AirReservationAType $airReservation
    ) {
     ...
     * Contains all booking response information pertaining to a completed reservation.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAAirBookRS\AirReservationAType[]
     */
