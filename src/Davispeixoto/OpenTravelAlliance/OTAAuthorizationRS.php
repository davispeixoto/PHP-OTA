...
/**
 * Class representing OTAAuthorizationRS
 */
class OTAAuthorizationRS
{
    ...
    /**
     * An element that is not intended to contain any data. The presence of this empty
     ...
     * recipient of the request message identified one or more business-level warnings
     * and/or errors, but the message itself was successfully processed.
     *
    ...
    /**
     * Response information to an authorization request.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAuthorizationRS\AuthorizationAType[]
     * $authorization
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAAuthorizationRS\AuthorizationAType
     * $authorization
     */
    public function addToAuthorization(
        \Davispeixoto\OpenTravelAlliance\OTAAuthorizationRS\AuthorizationAType $authorization
    ) {
     ...
     * Response information to an authorization request.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAAuthorizationRS\AuthorizationAType[]
     */
