...
/**
 * Class representing OTAHotelInvBlockNotifRS
 */
class OTAHotelInvBlockNotifRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockNotifRS\InvBlockCodeRefsAType
     * $invBlockCodeRefs
     */
    private $invBlockCodeRefs = null;
     ...
     * \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockNotifRS\InvBlockCodeRefsAType
     */
    public function getInvBlockCodeRefs()
    {
        return $this->invBlockCodeRefs;
    }

    /**
     * Sets a new invBlockCodeRefs
     *
     * This accommodates responses for multiple inventory blocks.
     *
     * @param
     ...
     * @return self
     */
    public function setInvBlockCodeRefs(
        \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockNotifRS\InvBlockCodeRefsAType $invBlockCodeRefs
    ) {
        $this->invBlockCodeRefs = $invBlockCodeRefs;
