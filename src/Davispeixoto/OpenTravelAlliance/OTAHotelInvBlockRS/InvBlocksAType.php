...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockRS;
...
class InvBlocksAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockRS\InvBlocksAType\HotelRefAType
     * $hotelRef
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockRS\InvBlocksAType\InvBlockDatesAType
     * $invBlockDates
     */
    ...
    public function setHotelRef(
        \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockRS\InvBlocksAType\HotelRefAType $hotelRef
    ) {
    ...
    public function setInvBlockDates(
        \Davispeixoto\OpenTravelAlliance\OTAHotelInvBlockRS\InvBlocksAType\InvBlockDatesAType $invBlockDates
    ) {
