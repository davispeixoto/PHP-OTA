...
/**
 * Class representing OTARailPriceRS
 */
class OTARailPriceRS
{
    ...
    /**
     * Summary fare information applicable to the total journey, including total fare,
     * basic fare, discounts applied, etc.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTARailPriceRS\PricedItineraryAType
     * $pricedItinerary
     */
    private $pricedItinerary = null;
    ...
    /**
     * Gets as pricedItinerary
     *
     * Summary fare information applicable to the total journey, including total fare,
     * basic fare, discounts applied, etc.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTARailPriceRS\PricedItineraryAType
     */
    ...
    /**
     * Sets a new pricedItinerary
     *
     * Summary fare information applicable to the total journey, including total fare,
     * basic fare, discounts applied, etc.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTARailPriceRS\PricedItineraryAType
     * $pricedItinerary
     * @return self
     */
    public function setPricedItinerary(
        \Davispeixoto\OpenTravelAlliance\OTARailPriceRS\PricedItineraryAType $pricedItinerary
    ) {
