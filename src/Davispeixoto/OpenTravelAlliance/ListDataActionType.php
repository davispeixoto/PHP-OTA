...
/**
 * Class representing ListDataActionType
 *
 * Data action types.Use: This is a string list of enumerations with an "Other_"
 ...
 * XSD Type: List_DataActionType
 */
class ListDataActionType
{
