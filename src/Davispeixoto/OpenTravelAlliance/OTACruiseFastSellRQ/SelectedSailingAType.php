...
class SelectedSailingAType
{
    ...
    /**
     * Specifies the fare code and the group code. Fare codes are specific to cruise
     * lines.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\SelectedSailingAType\SelectedFareAType
     * $selectedFare
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\SelectedSailingAType\SelectedCategoryAType
     * $selectedCategory
     */
    private $selectedCategory = null;

    /**
     * Specifies the package for the Fast Sell. Usually the request will query for
     * packages that are included in the cruise sailing offering (inclusive packages).
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\SelectedSailingAType\InclusivePackageOptionAType
    ...
    public function setSelectedFare(
        \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\SelectedSailingAType\SelectedFareAType $selectedFare
    ) {
    ...
    public function setSelectedCategory(
        \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\SelectedSailingAType\SelectedCategoryAType $selectedCategory
    ) {
    ...
    public function setInclusivePackageOption(
        \Davispeixoto\OpenTravelAlliance\OTACruiseFastSellRQ\SelectedSailingAType\InclusivePackageOptionAType $inclusivePackageOption
    ) {
