...
/**
 * Class representing OTAInsuranceQuoteRS
 */
class OTAInsuranceQuoteRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAInsuranceQuoteRS\PlanForQuoteRSAType[]
     * $planForQuoteRS
     */
    private $planForQuoteRS = null;
    ...
    /**
     * Adds as planForQuoteRS
     *
     * Contains a quote response for a single insurance plan.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAInsuranceQuoteRS\PlanForQuoteRSAType
     * $planForQuoteRS
     */
    public function addToPlanForQuoteRS(
        \Davispeixoto\OpenTravelAlliance\OTAInsuranceQuoteRS\PlanForQuoteRSAType $planForQuoteRS
    ) {
     ...
     * @return boolean
     */
    public function issetPlanForQuoteRS($index)
    {
        return isset($this->planForQuoteRS[$index]);
    }

    /**
     * unset planForQuoteRS
     *
     * Contains a quote response for a single insurance plan.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetPlanForQuoteRS($index)
    {
        unset($this->planForQuoteRS[$index]);
    }

    /**
     * Gets as planForQuoteRS
     *
     * Contains a quote response for a single insurance plan.
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTAInsuranceQuoteRS\PlanForQuoteRSAType[]
     */
    public function getPlanForQuoteRS()
    {
        return $this->planForQuoteRS;
    }

    /**
     * Sets a new planForQuoteRS
     *
     * Contains a quote response for a single insurance plan.
     *
     * @param
     ...
     * @return self
     */
    public function setPlanForQuoteRS(array $planForQuoteRS)
    {
        $this->planForQuoteRS = $planForQuoteRS;
