...
/**
 * Class representing ListPaymentCardIssuerType
 *
 * Payment card issuers.Use: This is a string list of enumerations with an "Other_"
 ...
 * XSD Type: List_PaymentCardIssuer
 */
class ListPaymentCardIssuerType
{
