...
/**
 * Class representing OTAPurchaseItemRQ
 */
class OTAPurchaseItemRQ
{
    ...
    /**
     * An identifier that may be used to reference the item being sold.
     *
    ...
    /**
     * Point of Sale identification that identifies the source (system and/or person)
     * taking the order and is used for message authentication. Terminal, entity,
    ...
    /**
     * A collection of orders with high level information pertaining to the orders.
     *
    ...
    /**
     * Contact and/or reservation information pertaining to a recipient of the
     * purchased item, it different from the purchaser.
     *
     * @property
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAPurchaseItemRQ\PurchaserInfoAType
     * $purchaserInfo
     */
    private $purchaserInfo = null;
    ...
    /**
     * Gets as purchaserInfo
     *
     * Contact and loyalty information for the purchaser of the order(s).
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAPurchaseItemRQ\PurchaserInfoAType
     */
    public function getPurchaserInfo()
    {
        return $this->purchaserInfo;
    }

    /**
     * Sets a new purchaserInfo
     *
     * Contact and loyalty information for the purchaser of the order(s).
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAPurchaseItemRQ\PurchaserInfoAType
     * $purchaserInfo
     * @return self
     */
    public function setPurchaserInfo(
        \Davispeixoto\OpenTravelAlliance\OTAPurchaseItemRQ\PurchaserInfoAType $purchaserInfo
    ) {
