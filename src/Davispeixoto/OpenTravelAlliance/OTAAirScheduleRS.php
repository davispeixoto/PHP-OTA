...
/**
 * Class representing OTAAirScheduleRS
 */
class OTAAirScheduleRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirScheduleRS\OriginDestinationOptionsAType
    ...
    public function setOriginDestinationOptions(
        \Davispeixoto\OpenTravelAlliance\OTAAirScheduleRS\OriginDestinationOptionsAType $originDestinationOptions
    ) {
