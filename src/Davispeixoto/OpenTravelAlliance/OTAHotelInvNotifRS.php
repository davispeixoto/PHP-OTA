...
/**
 * Class representing OTAHotelInvNotifRS
 */
class OTAHotelInvNotifRS
{
     ...
     * $inventoryCrossRefs
     */
    private $inventoryCrossRefs = null;
     ...
     * @return boolean
     */
    public function issetInventoryCrossRefs($index)
    {
        return isset($this->inventoryCrossRefs[$index]);
    }

    /**
     * unset inventoryCrossRefs
     *
     * Container for Inventory Cross Reference elements.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetInventoryCrossRefs($index)
    {
        unset($this->inventoryCrossRefs[$index]);
    }

    /**
     * Gets as inventoryCrossRefs
     *
     * Container for Inventory Cross Reference elements.
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTAHotelInvNotifRS\InventoryCrossRefsAType\InventoryCrossRefAType[]
     */
    public function getInventoryCrossRefs()
    {
        return $this->inventoryCrossRefs;
    }

    /**
     * Sets a new inventoryCrossRefs
     *
     * Container for Inventory Cross Reference elements.
     *
     * @param
     ...
     * @return self
     */
    public function setInventoryCrossRefs(array $inventoryCrossRefs)
    {
        $this->inventoryCrossRefs = $inventoryCrossRefs;
