...
/**
 * Class representing OTARailBookModifyRQ
 */
class OTARailBookModifyRQ
{
    ...
    /**
     * Full details on the reservation that is to be created, specifying location
     * information, passenger data and payment details.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType
     * $railBookInfo
     */
    private $railBookInfo = null;

    /**
     * The contact person for the reservation.
     *
     * @property \Davispeixoto\OpenTravelAlliance\RailPersonInfoType $contact
     */
    ...
    /**
     * Gets as railBookInfo
     *
     * Full details on the reservation that is to be created, specifying location
     * information, passenger data and payment details.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType
     */
    public function getRailBookInfo()
    {
        return $this->railBookInfo;
    }

    /**
     * Sets a new railBookInfo
     *
     * Full details on the reservation that is to be created, specifying location
     * information, passenger data and payment details.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType
     * $railBookInfo
     * @return self
     */
    public function setRailBookInfo(
        \Davispeixoto\OpenTravelAlliance\OTARailBookModifyRQ\RailBookInfoAType $railBookInfo
    ) {
        $this->railBookInfo = $railBookInfo;
     ...
     * The contact person for the reservation.
     *
     * @return \Davispeixoto\OpenTravelAlliance\RailPersonInfoType
     */
     ...
     * The contact person for the reservation.
     *
     * @param \Davispeixoto\OpenTravelAlliance\RailPersonInfoType $contact
     * @return self
     */
    public function setContact(\Davispeixoto\OpenTravelAlliance\RailPersonInfoType $contact)
    {
