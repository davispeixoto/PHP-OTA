...
namespace Davispeixoto\OpenTravelAlliance\TeeTimeResType;
...
class ChargeAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\TeeTimeResType\ChargeAType\CalculationAType[]
     * $calculation
     */
    ...
    public function addToCalculation(
        \Davispeixoto\OpenTravelAlliance\TeeTimeResType\ChargeAType\CalculationAType $calculation
    ) {
