...
/**
 * Class representing OTACruiseBookingDocumentRS
 */
class OTACruiseBookingDocumentRS
{
    ...
    /**
     * Specifies the reservation control information or the guest's booking ID (e.g.
     * PNR Record Locator and/or Vendor Confirmation Number).
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseBookingDocumentRS\ReservationIDAType
     * $reservationID
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseBookingDocumentRS\CruiseDocumentAType[]
     * $cruiseDocument
     */
    ...
    public function setReservationID(
        \Davispeixoto\OpenTravelAlliance\OTACruiseBookingDocumentRS\ReservationIDAType $reservationID
    ) {
     ...
     * $cruiseDocument
     */
    public function addToCruiseDocument(
        \Davispeixoto\OpenTravelAlliance\OTACruiseBookingDocumentRS\CruiseDocumentAType $cruiseDocument
    ) {
