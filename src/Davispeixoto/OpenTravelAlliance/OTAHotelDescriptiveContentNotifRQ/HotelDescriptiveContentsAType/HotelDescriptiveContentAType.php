...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelDescriptiveContentNotifRQ\HotelDescriptiveContentsAType;

use Davispeixoto\OpenTravelAlliance\HotelDescriptiveContentType;

/**
 * Class representing HotelDescriptiveContentAType
 */
class HotelDescriptiveContentAType extends HotelDescriptiveContentType
{
    ...
    /**
     * Indication as to the last time any data supported within this message was
     * updated.
     *
