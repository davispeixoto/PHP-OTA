...
/**
 * Class representing OTATourActivityAvailRQ
 */
class OTATourActivityAvailRQ
{
    ...
    /**
     * Point of sale information for the initiator of the availability request.
     *
    ...
    /**
     * Information that may directly impact how the receiving system processes the
     * request message.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRQ\ProcessingInformationAType
     * $processingInformation
     */
    private $processingInformation = null;

    /**
     * Criteria for a tour/ activity availability request.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRQ\TourActivityAType
     * $tourActivity
     */
    private $tourActivity = null;
    ...
    public function setProcessingInformation(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRQ\ProcessingInformationAType $processingInformation
    ) {
    ...
    /**
     * Sets a new tourActivity
     *
     * Criteria for a tour/ activity availability request.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRQ\TourActivityAType
     * $tourActivity
     * @return self
     */
    public function setTourActivity(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityAvailRQ\TourActivityAType $tourActivity
    ) {
