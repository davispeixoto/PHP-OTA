...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelCacheChangeRQ\CacheSearchCriteriaAType;
...
class CacheSearchCriterionAType
{
     ...
     *
     * @property \DateTime $cacheStartDateTime
     */
    private $cacheStartDateTime = null;

    /**
     * The ending date/time for the cache results to be returned. This is used in
     * conjunction with the cacheStartDate to constrain the date range of the results.
     *
     * @property mixed $cacheEndDateTime
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelCacheChangeRQ\CacheSearchCriteriaAType\CacheSearchCriterionAType\GeographicalInfoAType
     * $geographicalInfo
     */
     ...
     * conjunction with the cacheStartDate to constrain the date range of the results.
     *
     * @param mixed $cacheEndDateTime
     * @return self
     */
    public function setCacheEndDateTime($cacheEndDateTime)
    {
     ...
     * @return self
     */
    public function setGeographicalInfo(
        \Davispeixoto\OpenTravelAlliance\OTAHotelCacheChangeRQ\CacheSearchCriteriaAType\CacheSearchCriterionAType\GeographicalInfoAType $geographicalInfo
    ) {
