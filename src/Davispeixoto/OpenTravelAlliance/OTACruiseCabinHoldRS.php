...
/**
 * Class representing OTACruiseCabinHoldRS
 */
class OTACruiseCabinHoldRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCabinHoldRS\SelectedSailingAType[]
     * $selectedSailing
     */
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTACruiseCabinHoldRS\ErrorsAType
     * $errors
     */
    private $errors = null;
    ...
    public function addToSelectedSailing(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCabinHoldRS\SelectedSailingAType $selectedSailing
    ) {
     ...
     * A collection of errors that occurred during the processing of a message.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTACruiseCabinHoldRS\ErrorsAType
     */
     ...
     * A collection of errors that occurred during the processing of a message.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTACruiseCabinHoldRS\ErrorsAType $errors
     * @return self
     */
    public function setErrors(\Davispeixoto\OpenTravelAlliance\OTACruiseCabinHoldRS\ErrorsAType $errors)
    {
        $this->errors = $errors;
