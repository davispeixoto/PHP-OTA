...
/**
 * Class representing OTAProfileModifyRQ
 */
class OTAProfileModifyRQ
{
    ...
    /**
     * Identifies the profile to be modified together with the owner of the profile or
    ...
    /**
     * A full overlay of profile information containing the modified data.
     *
     * @property \Davispeixoto\OpenTravelAlliance\ProfileType $profileModify
     */
    private $profileModify = null;
    ...
    /**
     * Gets as profileModify
     *
     * A full overlay of profile information containing the modified data.
     *
     * @return \Davispeixoto\OpenTravelAlliance\ProfileType
     */
    public function getProfileModify()
    {
        return $this->profileModify;
    }

    /**
     * Sets a new profileModify
     *
     * A full overlay of profile information containing the modified data.
     *
     * @param \Davispeixoto\OpenTravelAlliance\ProfileType $profileModify
     * @return self
     */
    public function setProfileModify(\Davispeixoto\OpenTravelAlliance\ProfileType $profileModify)
    {
