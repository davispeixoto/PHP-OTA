...
/**
 * Class representing OTAVehLocDetailsNotifRQ
 */
class OTAVehLocDetailsNotifRQ
{
    ...
    /**
     * The action code is used to specify whether the message is for Location or Policy
     * updating process.
     *
    ...
    /**
     * To specify who is sending the vehicle location details database information.
     *
    ...
    /**
     * A container for location detail information.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAVehLocDetailsNotifRQ\LocationDetailsAType
     * $locationDetails
     */
     ...
     * @return self
     */
    public function setLocationDetails(
        \Davispeixoto\OpenTravelAlliance\OTAVehLocDetailsNotifRQ\LocationDetailsAType $locationDetails
    ) {
