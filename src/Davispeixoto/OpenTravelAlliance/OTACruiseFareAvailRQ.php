...
/**
 * Class representing OTACruiseFareAvailRQ
 */
class OTACruiseFareAvailRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseFareAvailRQ\GuestCountsAType\GuestCountAType[]
     * $guestCounts
     */
    ...
    public function addToGuestCounts(
        \Davispeixoto\OpenTravelAlliance\OTACruiseFareAvailRQ\GuestCountsAType\GuestCountAType $guestCount
    ) {
