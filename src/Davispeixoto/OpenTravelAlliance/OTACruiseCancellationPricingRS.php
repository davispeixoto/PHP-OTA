...
/**
 * Class representing OTACruiseCancellationPricingRS
 */
class OTACruiseCancellationPricingRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCancellationPricingRS\ReservationIDAType[]
     * $reservationID
     */
    ...
    /**
     * Specifies the cancellation fees associated with the booking.
     *
     * @property \Davispeixoto\OpenTravelAlliance\CruiseBookingInfoType
     * $cancellationFees
     */
    ...
    public function addToReservationID(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCancellationPricingRS\ReservationIDAType $reservationID
    ) {
     ...
     * Specifies the cancellation fees associated with the booking.
     *
     * @param \Davispeixoto\OpenTravelAlliance\CruiseBookingInfoType $cancellationFees
     * @return self
     */
    public function setCancellationFees(\Davispeixoto\OpenTravelAlliance\CruiseBookingInfoType $cancellationFees)
    {
