...
/**
 * Class representing RailPassengerCategoryType
 *
 * Classification of passenger demographics and rate qualifying information.
 * XSD Type: RailPassengerCategoryType
 */
class RailPassengerCategoryType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\RailPassengerCategoryType\PassengerQualifyingInfoAType[]
    ...
    public function addToPassengerQualifyingInfo(
        \Davispeixoto\OpenTravelAlliance\RailPassengerCategoryType\PassengerQualifyingInfoAType $passengerQualifyingInfo
    ) {
