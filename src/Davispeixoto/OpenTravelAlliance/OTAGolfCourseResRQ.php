...
/**
 * Class representing OTAGolfCourseResRQ
 */
class OTAGolfCourseResRQ
{
    ...
    /**
     * Golf course tee time reservation(s) to be booked.
     *
     * @property \Davispeixoto\OpenTravelAlliance\TeeTimeResType[] $golfCourseRes
     */
     ...
     * Point of Sale identification.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRQ\POSAType
     */
     ...
     * Point of Sale identification.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRQ\POSAType $pOS
     * @return self
     */
    public function setPOS(\Davispeixoto\OpenTravelAlliance\OTAGolfCourseResRQ\POSAType $pOS)
    {
        $this->pOS = $pOS;
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\TeeTimeResType $golfCourseRes
     */
    public function addToGolfCourseRes(\Davispeixoto\OpenTravelAlliance\TeeTimeResType $golfCourseRes)
    {
     ...
     * Golf course tee time reservation(s) to be booked.
     *
     * @return \Davispeixoto\OpenTravelAlliance\TeeTimeResType[]
     */
