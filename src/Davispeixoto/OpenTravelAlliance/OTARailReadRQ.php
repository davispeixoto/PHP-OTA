...
/**
 * Class representing OTARailReadRQ
 */
class OTARailReadRQ
{
    ...
    /**
     * An indicator of whether summary or detailed reservation information should be
     * returned in a Rail Reservation Read response message.
     *
     * @property string $resInfoLevel
     */
    private $resInfoLevel = null;
    ...
    /**
     * Groups of read requests for known and unknown booking references.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTARailReadRQ\ReadRequestsAType
     * $readRequests
     */
     ...
     * @return string
     */
    public function getResInfoLevel()
    {
        return $this->resInfoLevel;
    }

    /**
     * Sets a new resInfoLevel
     *
     * An indicator of whether summary or detailed reservation information should be
     * returned in a Rail Reservation Read response message.
     *
     * @param string $resInfoLevel
     * @return self
     */
    public function setResInfoLevel($resInfoLevel)
    {
        $this->resInfoLevel = $resInfoLevel;
     ...
     * Groups of read requests for known and unknown booking references.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTARailReadRQ\ReadRequestsAType
     */
     ...
     * Groups of read requests for known and unknown booking references.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTARailReadRQ\ReadRequestsAType
     * $readRequests
     * @return self
     */
    public function setReadRequests(\Davispeixoto\OpenTravelAlliance\OTARailReadRQ\ReadRequestsAType $readRequests)
    {
