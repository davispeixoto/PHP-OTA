...
namespace Davispeixoto\OpenTravelAlliance\VehicleLocationServicesOfferedType\OffLocationServicesAType\OffLocationServiceAType\OffLocServiceChargesAType;

use Davispeixoto\OpenTravelAlliance\VehicleChargeType;

/**
 * Class representing OffLocServiceChargeAType
 */
class OffLocServiceChargeAType extends VehicleChargeType
{
