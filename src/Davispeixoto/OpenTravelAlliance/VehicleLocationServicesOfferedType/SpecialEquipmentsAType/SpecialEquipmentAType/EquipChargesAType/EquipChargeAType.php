...
namespace Davispeixoto\OpenTravelAlliance\VehicleLocationServicesOfferedType\SpecialEquipmentsAType\SpecialEquipmentAType\EquipChargesAType;

use Davispeixoto\OpenTravelAlliance\VehicleChargeType;

/**
 * Class representing EquipChargeAType
 */
class EquipChargeAType extends VehicleChargeType
{

    /**
     * A collection of vehicles for which this charge applies. This is to be used when
     * the charge associated with the special equipment is not the same charge for all
     * vehicle types.
     *
