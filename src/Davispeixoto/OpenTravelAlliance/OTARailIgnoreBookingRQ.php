...
/**
 * Class representing OTARailIgnoreBookingRQ
 */
class OTARailIgnoreBookingRQ
{
    ...
    /**
     * The unique ID's of the provisional (unconfirmed) booking requests to be
     * cancelled. Note that the @Type attribute will typically contain a value of 23
