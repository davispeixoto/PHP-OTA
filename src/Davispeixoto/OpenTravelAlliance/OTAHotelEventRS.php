...
/**
 * Class representing OTAHotelEventRS
 */
class OTAHotelEventRS
{
    ...
    /**
     * If true, this transaction is a modification to an existing event.Example: true
     *
     * @property boolean $modifyInd
     */
    private $modifyInd = null;
    ...
    /**
     * Collection of events which may be used to echo back data from the request
     * message.
     *
     * @property \Davispeixoto\OpenTravelAlliance\EventType\EventAType[] $events
     */
    private $events = null;
     ...
     * @return boolean
     */
    public function getModifyInd()
    {
        return $this->modifyInd;
    }

    /**
     * Sets a new modifyInd
     *
     * If true, this transaction is a modification to an existing event.Example: true
     *
     * @param boolean $modifyInd
     * @return self
     */
    public function setModifyInd($modifyInd)
    {
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\EventType\EventAType $event
     */
    public function addToEvents(\Davispeixoto\OpenTravelAlliance\EventType\EventAType $event)
    {
        $this->events[] = $event;
     ...
     * message.
     *
     * @return \Davispeixoto\OpenTravelAlliance\EventType\EventAType[]
     */
     ...
     * message.
     *
     * @param \Davispeixoto\OpenTravelAlliance\EventType\EventAType[] $events
     * @return self
     */
