...
namespace Davispeixoto\OpenTravelAlliance\OTAHotelRateAmountNotifRQ;

/**
 * Class representing RateAmountMessagesAType
 */
class RateAmountMessagesAType
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\RateAmountMessageType[]
     * $rateAmountMessage
     */
    private $rateAmountMessage = null;
    ...
    /**
     * Adds as rateAmountMessage
     *
     * RateAmountMessages that define the rate changes to be made.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\RateAmountMessageType $rateAmountMessage
     */
    public function addToRateAmountMessage(\Davispeixoto\OpenTravelAlliance\RateAmountMessageType $rateAmountMessage)
    {
     ...
     * @return boolean
     */
    public function issetRateAmountMessage($index)
    {
        return isset($this->rateAmountMessage[$index]);
    }

    /**
     * unset rateAmountMessage
     *
     * RateAmountMessages that define the rate changes to be made.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetRateAmountMessage($index)
    {
        unset($this->rateAmountMessage[$index]);
    }

    /**
     * Gets as rateAmountMessage
     *
     * RateAmountMessages that define the rate changes to be made.
     *
     * @return \Davispeixoto\OpenTravelAlliance\RateAmountMessageType[]
     */
    ...
    /**
     * Sets a new rateAmountMessage
     *
     * RateAmountMessages that define the rate changes to be made.
     *
     * @param \Davispeixoto\OpenTravelAlliance\RateAmountMessageType[]
     * $rateAmountMessage
     * @return self
     */
    public function setRateAmountMessage(array $rateAmountMessage)
    {
        $this->rateAmountMessage = $rateAmountMessage;
