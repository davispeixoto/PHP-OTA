...
/**
 * Class representing OTAHotelCommNotifRQ
 */
class OTAHotelCommNotifRQ
{
    ...
    /**
     * A collection of CommissionsEvent elements that result from a guest stay to be
     * sent to the system responsible for processing agent commission payments.
     *
     * @property \Davispeixoto\OpenTravelAlliance\CommissionEventType[]
     * $commissionEvents
     */
    private $commissionEvents = null;
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\CommissionEventType $commissionEvent
     */
    public function addToCommissionEvents(\Davispeixoto\OpenTravelAlliance\CommissionEventType $commissionEvent)
    {
        $this->commissionEvents[] = $commissionEvent;

        return $this;
    }

    /**
     * isset commissionEvents
     *
     * A collection of CommissionsEvent elements that result from a guest stay to be
     * sent to the system responsible for processing agent commission payments.
     *
     ...
     * @return boolean
     */
    public function issetCommissionEvents($index)
    {
        return isset($this->commissionEvents[$index]);
    }

    /**
     * unset commissionEvents
     *
     * A collection of CommissionsEvent elements that result from a guest stay to be
     * sent to the system responsible for processing agent commission payments.
     *
     ...
     * @return void
     */
    public function unsetCommissionEvents($index)
    {
        unset($this->commissionEvents[$index]);
    }

    /**
     * Gets as commissionEvents
     *
     * A collection of CommissionsEvent elements that result from a guest stay to be
     * sent to the system responsible for processing agent commission payments.
     *
     * @return \Davispeixoto\OpenTravelAlliance\CommissionEventType[]
     */
    public function getCommissionEvents()
    {
        return $this->commissionEvents;
    }

    /**
     * Sets a new commissionEvents
     *
     * A collection of CommissionsEvent elements that result from a guest stay to be
     * sent to the system responsible for processing agent commission payments.
     *
     * @param \Davispeixoto\OpenTravelAlliance\CommissionEventType[] $commissionEvents
     * @return self
     */
    public function setCommissionEvents(array $commissionEvents)
    {
        $this->commissionEvents = $commissionEvents;
