...
/**
 * Class representing OTAVehCancelRQ
 */
class OTAVehCancelRQ
{
     ...
     * cancellation of a rental vehicle reservation.
     *
     * @property \Davispeixoto\OpenTravelAlliance\CancelInfoRQType $vehCancelRQCore
     */
    private $vehCancelRQCore = null;

    /**
     * Identifies the supplemental information associated with the request for the
     * cancellation of a rental vehicle reservation.
     *
     * @property \Davispeixoto\OpenTravelAlliance\VehicleCancelRQAdditionalInfoType
     * $vehCancelRQInfo
     */
    private $vehCancelRQInfo = null;
    ...
    /**
     * Gets as vehCancelRQCore
     *
     * Identifies the common, or core, information associated with the request for
     * cancellation of a rental vehicle reservation.
     *
     * @return \Davispeixoto\OpenTravelAlliance\CancelInfoRQType
     */
    ...
    /**
     * Sets a new vehCancelRQCore
     *
     * Identifies the common, or core, information associated with the request for
     * cancellation of a rental vehicle reservation.
     *
     * @param \Davispeixoto\OpenTravelAlliance\CancelInfoRQType $vehCancelRQCore
     * @return self
     */
    public function setVehCancelRQCore(\Davispeixoto\OpenTravelAlliance\CancelInfoRQType $vehCancelRQCore)
    {
    ...
    /**
     * Gets as vehCancelRQInfo
     *
     * Identifies the supplemental information associated with the request for the
     * cancellation of a rental vehicle reservation.
     *
     * @return \Davispeixoto\OpenTravelAlliance\VehicleCancelRQAdditionalInfoType
     */
    ...
    /**
     * Sets a new vehCancelRQInfo
     *
     * Identifies the supplemental information associated with the request for the
     * cancellation of a rental vehicle reservation.
     *
     * @param \Davispeixoto\OpenTravelAlliance\VehicleCancelRQAdditionalInfoType
     * $vehCancelRQInfo
     * @return self
     */
    public function setVehCancelRQInfo(
        \Davispeixoto\OpenTravelAlliance\VehicleCancelRQAdditionalInfoType $vehCancelRQInfo
    ) {
