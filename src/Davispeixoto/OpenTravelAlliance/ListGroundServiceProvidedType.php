...
/**
 * Class representing ListGroundServiceProvidedType
 *
 * Ground transportation service types.Use: This is a string list of enumerations
 ...
 * XSD Type: List_GroundServiceProvided
 */
class ListGroundServiceProvidedType
{
