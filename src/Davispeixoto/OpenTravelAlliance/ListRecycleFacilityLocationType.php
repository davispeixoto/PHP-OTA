...
/**
 * Class representing ListRecycleFacilityLocationType
 *
 * Recycling bin/ facility locations.Use: This is a string list of enumerations
 ...
 * XSD Type: List_RecycleFacilityLocation
 */
class ListRecycleFacilityLocationType
{
