...
/**
 * Class representing OTAHotelRFPTransientRQ
 */
class OTAHotelRFPTransientRQ
{
    ...
    /**
     * Used to identify the sender of the request. If the sender is an intermediary,
     * this may additionally be used to identify the company on whose behalf the
    ...
    /**
     * A collection of TransientRFP_RequestSegment. This allows for the RFP to be sent
     * to multiple properties.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelRFPTransientRQ\TransientRFPRequestSegmentsAType
     * $transientRFPRequestSegments
     */
    private $transientRFPRequestSegments = null;

    /**
     * The ID is used to identify the request.
     *
     * @property \Davispeixoto\OpenTravelAlliance\UniqueIDType $messageID
     */
    ...
    /**
     * Gets as transientRFPRequestSegments
     *
     * A collection of TransientRFP_RequestSegment. This allows for the RFP to be sent
     * to multiple properties.
     *
     ...
     * \Davispeixoto\OpenTravelAlliance\OTAHotelRFPTransientRQ\TransientRFPRequestSegmentsAType
     */
    public function getTransientRFPRequestSegments()
    {
        return $this->transientRFPRequestSegments;
    }

    /**
     * Sets a new transientRFPRequestSegments
     *
     * A collection of TransientRFP_RequestSegment. This allows for the RFP to be sent
     * to multiple properties.
     *
     ...
     * @return self
     */
    public function setTransientRFPRequestSegments(
        \Davispeixoto\OpenTravelAlliance\OTAHotelRFPTransientRQ\TransientRFPRequestSegmentsAType $transientRFPRequestSegments
    ) {
        $this->transientRFPRequestSegments = $transientRFPRequestSegments;
     ...
     * The ID is used to identify the request.
     *
     * @param \Davispeixoto\OpenTravelAlliance\UniqueIDType $messageID
     * @return self
     */
    public function setMessageID(\Davispeixoto\OpenTravelAlliance\UniqueIDType $messageID)
    {
