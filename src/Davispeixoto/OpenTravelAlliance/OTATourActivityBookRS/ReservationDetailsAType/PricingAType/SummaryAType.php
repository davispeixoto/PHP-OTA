...
class SummaryAType extends TourActivityChargeType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\PricingAType\SummaryAType\PricingTypeAType
     * $pricingType
     */
    ...
    public function setPricingType(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\PricingAType\SummaryAType\PricingTypeAType $pricingType
    ) {
