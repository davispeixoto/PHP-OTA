...
class PaymentInfoAType extends TourActivityChargeType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\PaymentInfoAType\DetailAType
     * $detail
     */
    private $detail = null;
    ...
    public function setDetail(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\PaymentInfoAType\DetailAType $detail
    ) {
        $this->detail = $detail;
