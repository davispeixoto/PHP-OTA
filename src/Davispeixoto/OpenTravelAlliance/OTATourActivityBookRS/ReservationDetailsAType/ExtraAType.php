...
class ExtraAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\ExtraAType\DepositAType
     * $deposit
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\ExtraAType\LocationAType[]
     * $location
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\ExtraAType\PricingAType[]
     * $pricing
     */
    ...
    public function setDeposit(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\ExtraAType\DepositAType $deposit
    ) {
    ...
    public function addToLocation(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\ExtraAType\LocationAType $location
    ) {
    ...
    public function addToPricing(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\ExtraAType\PricingAType $pricing
    ) {
