...
class PickupDropoffAType extends TourActivityTransRequestType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\PickupDropoffAType\ParticipantListAType[]
     * $participantList
     */
    ...
    public function addToParticipantList(
        \Davispeixoto\OpenTravelAlliance\OTATourActivityBookRS\ReservationDetailsAType\PickupDropoffAType\ParticipantListAType $participantList
    ) {
