...
/**
 * Class representing OTAInsuranceBookRQ
 */
class OTAInsuranceBookRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAInsuranceBookRQ\PlanForBookRQAType[]
     * $planForBookRQ
     */
    private $planForBookRQ = null;
    ...
    /**
     * Adds as planForBookRQ
     *
     * Contains a booking request for a single insurance plan.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAInsuranceBookRQ\PlanForBookRQAType
     * $planForBookRQ
     */
    public function addToPlanForBookRQ(
        \Davispeixoto\OpenTravelAlliance\OTAInsuranceBookRQ\PlanForBookRQAType $planForBookRQ
    ) {
     ...
     * @return boolean
     */
    public function issetPlanForBookRQ($index)
    {
        return isset($this->planForBookRQ[$index]);
    }
     ...
     * @return void
     */
    public function unsetPlanForBookRQ($index)
    {
        unset($this->planForBookRQ[$index]);
    }

    /**
     * Gets as planForBookRQ
     *
     * Contains a booking request for a single insurance plan.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAInsuranceBookRQ\PlanForBookRQAType[]
     */
     ...
     * @return self
     */
    public function setPlanForBookRQ(array $planForBookRQ)
    {
        $this->planForBookRQ = $planForBookRQ;
