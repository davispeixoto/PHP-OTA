...
/**
 * Class representing OTAAirCheckInRS
 */
class OTAAirCheckInRS
{
    ...
    /**
     * Contains flight check-in response information.
     *
     * @property \Davispeixoto\OpenTravelAlliance\AirCheckInType $airCheckInInfo
     */
    private $airCheckInInfo = null;

    /**
     * Information that may apply to the entire response, such as marketing or header
     * information.
     *
    ...
    /**
     * Gets as airCheckInInfo
     *
     * Contains flight check-in response information.
     *
     * @return \Davispeixoto\OpenTravelAlliance\AirCheckInType
     */
    public function getAirCheckInInfo()
    {
        return $this->airCheckInInfo;
    }

    /**
     * Sets a new airCheckInInfo
     *
     * Contains flight check-in response information.
     *
     * @param \Davispeixoto\OpenTravelAlliance\AirCheckInType $airCheckInInfo
     * @return self
     */
    public function setAirCheckInInfo(\Davispeixoto\OpenTravelAlliance\AirCheckInType $airCheckInInfo)
    {
