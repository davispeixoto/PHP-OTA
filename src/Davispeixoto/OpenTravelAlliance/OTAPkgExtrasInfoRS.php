...
/**
 * Class representing OTAPkgExtrasInfoRS
 */
class OTAPkgExtrasInfoRS
{
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAPkgExtrasInfoRS\PackageInfoAType
     * $packageInfo
     */
    private $packageInfo = null;

    /**
     * A collection of groupings of extra facilities.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAPkgExtrasInfoRS\ExtraGroupsAType\ExtraGroupAType[]
     * $extraGroups
     */
    private $extraGroups = null;

    /**
     * A collection of extra facilities available with the package.
     *
     * @property \Davispeixoto\OpenTravelAlliance\ExtrasInfoType[] $extras
     */
    private $extras = null;
     ...
     * Details of the selected package.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAPkgExtrasInfoRS\PackageInfoAType
     */
    ...
    /**
     * Sets a new packageInfo
     *
     * Details of the selected package.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAPkgExtrasInfoRS\PackageInfoAType
     * $packageInfo
     * @return self
     */
    public function setPackageInfo(\Davispeixoto\OpenTravelAlliance\OTAPkgExtrasInfoRS\PackageInfoAType $packageInfo)
    {
     ...
     * $extraGroup
     */
    public function addToExtraGroups(
     ...
     * @return boolean
     */
    public function issetExtraGroups($index)
    {
        return isset($this->extraGroups[$index]);
    }
     ...
     * @return void
     */
    public function unsetExtraGroups($index)
    {
     ...
     * @return self
     */
    public function setExtraGroups(array $extraGroups)
    {
     ...
     */
    public function addToExtras(\Davispeixoto\OpenTravelAlliance\ExtrasInfoType $extra)
    {
        $this->extras[] = $extra;
     ...
     * A collection of extra facilities available with the package.
     *
     * @param \Davispeixoto\OpenTravelAlliance\ExtrasInfoType[] $extras
     * @return self
     */
