 ...
 *
 * Identifies the supplemental information that may be included when requesting the
...
class VehicleReservationRQAdditionalInfoType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\VehicleReservationRQAdditionalInfoType\CoveragePrefsAType\CoveragePrefAType[]
     * $coveragePrefs
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\VehicleReservationRQAdditionalInfoType\RentalPaymentPrefAType[]
     * $rentalPaymentPref
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\VehicleReservationRQAdditionalInfoType\ReferenceAType
     * $reference
     */
    private $reference = null;

    /**
     * Details of a tour with which this reservation information is associated.
    ...
    public function addToCoveragePrefs(
        \Davispeixoto\OpenTravelAlliance\VehicleReservationRQAdditionalInfoType\CoveragePrefsAType\CoveragePrefAType $coveragePref
    ) {
    ...
    public function addToRentalPaymentPref(
        \Davispeixoto\OpenTravelAlliance\VehicleReservationRQAdditionalInfoType\RentalPaymentPrefAType $rentalPaymentPref
    ) {
    ...
    public function setReference(
        \Davispeixoto\OpenTravelAlliance\VehicleReservationRQAdditionalInfoType\ReferenceAType $reference
    ) {
