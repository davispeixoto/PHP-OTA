...
/**
 * Class representing OTAHotelRoomListRQ
 */
class OTAHotelRoomListRQ
{
    ...
    /**
     * Identifies the group overall for example the association, tour operator, etc.
     * This is independent of Hotel identification.
     *
    ...
    /**
     * Collection of RoomList items which may be for multiple hotels or for multiple
     * groups at a single hotel.
     *
     * @property \Davispeixoto\OpenTravelAlliance\HotelRoomListType[] $hotelRoomLists
     */
     ...
     */
    public function addToHotelRoomLists(\Davispeixoto\OpenTravelAlliance\HotelRoomListType $hotelRoomList)
    {
     ...
     * groups at a single hotel.
     *
     * @param \Davispeixoto\OpenTravelAlliance\HotelRoomListType[] $hotelRoomLists
     * @return self
     */
    public function setHotelRoomLists(array $hotelRoomLists)
    {
