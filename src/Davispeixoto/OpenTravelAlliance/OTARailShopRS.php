...
/**
 * Class representing OTARailShopRS
 */
class OTARailShopRS
{
    ...
    /**
     * Information on the locations between which availability and pricing was
     * requested. This provides for multiple origin/destination pairs in one request
     * message.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTARailShopRS\OriginDestinationInformationAType[]
    ...
    public function addToOriginDestinationInformation(
        \Davispeixoto\OpenTravelAlliance\OTARailShopRS\OriginDestinationInformationAType $originDestinationInformation
    ) {
