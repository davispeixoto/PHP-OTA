...
/**
 * Class representing OTAGolfCourseSearchRS
 */
class OTAGolfCourseSearchRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGolfCourseSearchRS\ProcessingInfoAType
     * $processingInfo
     */
    private $processingInfo = null;

    /**
     * Information about the golf facility(s) that meet the requested criteria.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGolfCourseSearchRS\GolfCourseAType[]
     * $golfCourse
     */
    private $golfCourse = null;
    ...
    public function setProcessingInfo(
        \Davispeixoto\OpenTravelAlliance\OTAGolfCourseSearchRS\ProcessingInfoAType $processingInfo
    ) {
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfCourseSearchRS\GolfCourseAType
     * $golfCourse
     */
    public function addToGolfCourse(\Davispeixoto\OpenTravelAlliance\OTAGolfCourseSearchRS\GolfCourseAType $golfCourse)
    {
     ...
     * @return boolean
     */
    public function issetGolfCourse($index)
    {
        return isset($this->golfCourse[$index]);
    }
     ...
     * @return void
     */
    public function unsetGolfCourse($index)
    {
        unset($this->golfCourse[$index]);
    }
     ...
     * Information about the golf facility(s) that meet the requested criteria.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAGolfCourseSearchRS\GolfCourseAType[]
     */
     ...
     * @return self
     */
    public function setGolfCourse(array $golfCourse)
    {
        $this->golfCourse = $golfCourse;
