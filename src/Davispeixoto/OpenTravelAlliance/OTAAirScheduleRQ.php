...
/**
 * Class representing OTAAirScheduleRQ
 */
class OTAAirScheduleRQ
{
    ...
    /**
     * Origin and Destination location, and time information for the Air Schedule
     * request.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirScheduleRQ\OriginDestinationInformationAType
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\SpecificFlightInfoType $flightInfo
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirScheduleRQ\FlightTypePrefAType[]
     * $flightTypePref
     */
    private $flightTypePref = null;

    /**
     * Equipment Preference to qualify Air Schedule request.
     *
    ...
    public function setOriginDestinationInformation(
        \Davispeixoto\OpenTravelAlliance\OTAAirScheduleRQ\OriginDestinationInformationAType $originDestinationInformation
    ) {
     ...
     * Specific airline and flight number for which a schedule is being requested.
     *
     * @param \Davispeixoto\OpenTravelAlliance\SpecificFlightInfoType $flightInfo
     * @return self
     */
    public function setFlightInfo(\Davispeixoto\OpenTravelAlliance\SpecificFlightInfoType $flightInfo)
    {
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirScheduleRQ\FlightTypePrefAType
     * $flightTypePref
     */
    public function addToFlightTypePref(
        \Davispeixoto\OpenTravelAlliance\OTAAirScheduleRQ\FlightTypePrefAType $flightTypePref
    ) {
     ...
     * Flight Type Preferences to qualify Air Schedule request.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAAirScheduleRQ\FlightTypePrefAType[]
     */
