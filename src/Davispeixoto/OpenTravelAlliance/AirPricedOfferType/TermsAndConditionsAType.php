...
class TermsAndConditionsAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\AirPricedOfferType\TermsAndConditionsAType\VoluntaryChangesAType
     * $voluntaryChanges
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\AirPricedOfferType\TermsAndConditionsAType\VoluntaryRefundsAType
     * $voluntaryRefunds
     */
    ...
    public function setVoluntaryChanges(
        \Davispeixoto\OpenTravelAlliance\AirPricedOfferType\TermsAndConditionsAType\VoluntaryChangesAType $voluntaryChanges
    ) {
    ...
    public function setVoluntaryRefunds(
        \Davispeixoto\OpenTravelAlliance\AirPricedOfferType\TermsAndConditionsAType\VoluntaryRefundsAType $voluntaryRefunds
    ) {
