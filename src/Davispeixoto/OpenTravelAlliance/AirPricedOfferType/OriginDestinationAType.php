...
class OriginDestinationAType extends OriginDestinationInformationType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\AirPricedOfferType\OriginDestinationAType\AlternateLocationInfoAType
    ...
    public function setAlternateLocationInfo(
        \Davispeixoto\OpenTravelAlliance\AirPricedOfferType\OriginDestinationAType\AlternateLocationInfoAType $alternateLocationInfo
    ) {
