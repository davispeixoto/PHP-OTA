...
/**
 * Class representing OTATravelItineraryRS
 */
class OTATravelItineraryRS
{
    ...
    /**
     * Requested itinerary information.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTATravelItineraryRS\TravelItineraryAType
     * $travelItinerary
     */
    private $travelItinerary = null;

    /**
     * Request was not successful - error information.
     *
     ...
     * @return self
     */
    public function setTravelItinerary(
        \Davispeixoto\OpenTravelAlliance\OTATravelItineraryRS\TravelItineraryAType $travelItinerary
    ) {
