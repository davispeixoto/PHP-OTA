...
/**
 * Class representing OTAVehCheckOutRS
 */
class OTAVehCheckOutRS
{
    ...
    /**
     * Vendor information such as company name, travel sector and division.
     *
    ...
    /**
     * Vehicle rental transaction information such as pick up and return details,
     * vehicle information, rental rates, proced equipment, fees, total charges,
     * confirmation ID and contract ID.
     *
     * @property \Davispeixoto\OpenTravelAlliance\VehicleRentalTransactionType
     * $vehRentalTransaction
     */
    private $vehRentalTransaction = null;

    /**
     * Identifies the supplemental information associated with the response for the
     * checkout of a rental vehicle.
     *
     * @property \Davispeixoto\OpenTravelAlliance\VehicleSegmentAdditionalInfoType
     * $vehAdditionalInfo
     */
    private $vehAdditionalInfo = null;
    ...
    /**
     * Gets as vehRentalTransaction
     *
     * Vehicle rental transaction information such as pick up and return details,
     * vehicle information, rental rates, proced equipment, fees, total charges,
     * confirmation ID and contract ID.
     *
     * @return \Davispeixoto\OpenTravelAlliance\VehicleRentalTransactionType
     */
    ...
    /**
     * Sets a new vehRentalTransaction
     *
     * Vehicle rental transaction information such as pick up and return details,
     * vehicle information, rental rates, proced equipment, fees, total charges,
     * confirmation ID and contract ID.
     *
     * @param \Davispeixoto\OpenTravelAlliance\VehicleRentalTransactionType
     * $vehRentalTransaction
     * @return self
     */
    public function setVehRentalTransaction(
        \Davispeixoto\OpenTravelAlliance\VehicleRentalTransactionType $vehRentalTransaction
    ) {
     ...
     */
    public function getVehAdditionalInfo()
    {
        return $this->vehAdditionalInfo;
    }

    /**
     * Sets a new vehAdditionalInfo
     *
     * Identifies the supplemental information associated with the response for the
     * checkout of a rental vehicle.
     *
     ...
     * @return self
     */
    public function setVehAdditionalInfo(
        \Davispeixoto\OpenTravelAlliance\VehicleSegmentAdditionalInfoType $vehAdditionalInfo
    ) {
        $this->vehAdditionalInfo = $vehAdditionalInfo;
