...
class MemberPreferencesAType
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\AccountInfoType\MemberPreferencesAType\AdditionalRewardAType[]
     * $additionalReward
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\AccountInfoType\MemberPreferencesAType\OfferAType[]
     * $offer
     */
    private $offer = null;
    ...
    public function addToAdditionalReward(
        \Davispeixoto\OpenTravelAlliance\AccountInfoType\MemberPreferencesAType\AdditionalRewardAType $additionalReward
    ) {
    ...
    public function addToOffer(
        \Davispeixoto\OpenTravelAlliance\AccountInfoType\MemberPreferencesAType\OfferAType $offer
    ) {
        $this->offer[] = $offer;
