...
/**
 * Class representing OTARailPaymentRS
 */
class OTARailPaymentRS
{
    ...
    /**
     * The reservation confirmation number that uniquely identifies a reservation, e.g.
     * confirmation number and PNR record locator.
     *
