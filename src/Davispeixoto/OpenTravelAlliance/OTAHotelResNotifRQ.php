...
class OTAHotelResNotifRQ
{
    ...
    /**
     * The point-of-sale data, contained in the element, communicates the information
     * that allows the receiving system to identify the trading partner that is sending
     * the request or the response message.
     *
