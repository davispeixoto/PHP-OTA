...
/**
 * Class representing OTAHotelStatsRQ
 */
class OTAHotelStatsRQ
{
     ...
     * @return boolean
     */
    public function issetRequestedHotels($index)
    {
        return isset($this->requestedHotels[$index]);
    }

    /**
     * unset requestedHotels
     *
     * Collection of requested hotels.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetRequestedHotels($index)
    {
        unset($this->requestedHotels[$index]);
    }

    /**
     * Gets as requestedHotels
     *
     * Collection of requested hotels.
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTAHotelStatsRQ\RequestedHotelsAType\RequestedHotelAType[]
     */
    public function getRequestedHotels()
    {
        return $this->requestedHotels;
    }

    /**
     * Sets a new requestedHotels
     *
     * Collection of requested hotels.
     *
     * @param
     ...
     * @return self
     */
    public function setRequestedHotels(array $requestedHotels)
    {
        $this->requestedHotels = $requestedHotels;
