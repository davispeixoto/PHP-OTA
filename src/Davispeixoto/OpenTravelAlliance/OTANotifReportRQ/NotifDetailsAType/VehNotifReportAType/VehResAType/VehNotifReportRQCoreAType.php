...
namespace Davispeixoto\OpenTravelAlliance\OTANotifReportRQ\NotifDetailsAType\VehNotifReportAType\VehResAType;

use Davispeixoto\OpenTravelAlliance\VehicleResRSCoreType;

/**
 * Class representing VehNotifReportRQCoreAType
 */
class VehNotifReportRQCoreAType extends VehicleResRSCoreType
{
