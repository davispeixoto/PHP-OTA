...
namespace Davispeixoto\OpenTravelAlliance\OTANotifReportRQ\NotifDetailsAType\HotelNotifReportAType\RateAmountMessagesAType;

use Davispeixoto\OpenTravelAlliance\RateAmountMessageType;

/**
 * Class representing RateAmountMessageAType
 */
class RateAmountMessageAType extends RateAmountMessageType
{
