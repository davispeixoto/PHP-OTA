...
class AvailStatusMessagesAType
{
    ...
    /**
     * An availability status message.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTANotifReportRQ\NotifDetailsAType\HotelNotifReportAType\AvailStatusMessagesAType\AvailStatusMessageAType[]
     * $availStatusMessage
     */
     ...
     * $availStatusMessage
     */
    public function addToAvailStatusMessage(
        \Davispeixoto\OpenTravelAlliance\OTANotifReportRQ\NotifDetailsAType\HotelNotifReportAType\AvailStatusMessagesAType\AvailStatusMessageAType $availStatusMessage
    ) {
