...
class RateAmountMessagesAType
{
    ...
    /**
     * A rate amount message.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTANotifReportRQ\NotifDetailsAType\HotelNotifReportAType\RateAmountMessagesAType\RateAmountMessageAType[]
     * $rateAmountMessage
     */
     ...
     * $rateAmountMessage
     */
    public function addToRateAmountMessage(
        \Davispeixoto\OpenTravelAlliance\OTANotifReportRQ\NotifDetailsAType\HotelNotifReportAType\RateAmountMessagesAType\RateAmountMessageAType $rateAmountMessage
    ) {
