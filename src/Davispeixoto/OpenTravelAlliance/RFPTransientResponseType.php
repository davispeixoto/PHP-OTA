...
/**
 * Class representing RFPTransientResponseType
 *
 * Provides the detailed RFP data and/or the the general information to let the
 * requestor know when and the detailed information will be returned.
 * XSD Type: RFP_TransientResponseType
 */
class RFPTransientResponseType
{
    ...
    /**
     * Provides the method and time for when the detailed response should be expected
     * as well as other information.
     *
     * @property \Davispeixoto\OpenTravelAlliance\RFPResponseDetailType
     * $rFPResponseDetail
     */
    private $rFPResponseDetail = null;

    /**
     * Provides the details associated with a hotel (e.g. the amenities and services
     * provided and distance to local attractions.)
     *
     * @property \Davispeixoto\OpenTravelAlliance\HotelDescriptiveContentType
     * $hotelDescription
     */
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\AccountSpecificInformationType
     * $accountSpecificInformation
     */
    private $accountSpecificInformation = null;
     ...
     */
    public function getRFPResponseDetail()
    {
        return $this->rFPResponseDetail;
    }

    /**
     * Sets a new rFPResponseDetail
     *
     * Provides the method and time for when the detailed response should be expected
     * as well as other information.
     *
     * @param \Davispeixoto\OpenTravelAlliance\RFPResponseDetailType $rFPResponseDetail
     * @return self
     */
    public function setRFPResponseDetail(\Davispeixoto\OpenTravelAlliance\RFPResponseDetailType $rFPResponseDetail)
    {
        $this->rFPResponseDetail = $rFPResponseDetail;

        return $this;
    }

    /**
     * Gets as hotelDescription
     *
     * Provides the details associated with a hotel (e.g. the amenities and services
     * provided and distance to local attractions.)
     *
     * @return \Davispeixoto\OpenTravelAlliance\HotelDescriptiveContentType
     */
    ...
    /**
     * Sets a new hotelDescription
     *
     * Provides the details associated with a hotel (e.g. the amenities and services
     * provided and distance to local attractions.)
     *
     * @param \Davispeixoto\OpenTravelAlliance\HotelDescriptiveContentType
     * $hotelDescription
     * @return self
     */
    public function setHotelDescription(\Davispeixoto\OpenTravelAlliance\HotelDescriptiveContentType $hotelDescription)
    {
    ...
    /**
     * Gets as accountSpecificInformation
     *
     * Defines the information that is specific to the RFP for this account.
     *
     * @return \Davispeixoto\OpenTravelAlliance\AccountSpecificInformationType
     */
    public function getAccountSpecificInformation()
    {
        return $this->accountSpecificInformation;
    }

    /**
     * Sets a new accountSpecificInformation
     *
     * Defines the information that is specific to the RFP for this account.
     *
     * @param \Davispeixoto\OpenTravelAlliance\AccountSpecificInformationType
     * $accountSpecificInformation
     * @return self
     */
    public function setAccountSpecificInformation(
        \Davispeixoto\OpenTravelAlliance\AccountSpecificInformationType $accountSpecificInformation
    ) {
        $this->accountSpecificInformation = $accountSpecificInformation;
