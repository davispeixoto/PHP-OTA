...
/**
 * Class representing OTAProfileCreateRS
 */
class OTAProfileCreateRS
{
    ...
    /**
     * Indicates successful processing of a profile create message. Returning an empty
     * element of this type indicates success.
     *
    ...
    /**
     * A successfully processed message, but one in which warnings are generated.
     *
    ...
    /**
     * The unique id of the business document created by the request.
     *
    ...
    /**
     * Indicates that an error occurred during the processing of a message.
     *
