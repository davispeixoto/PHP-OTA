...
/**
 * Class representing OTAAirDemandTicketRS
 */
class OTAAirDemandTicketRS
{
    ...
    /**
     * The presence of the empty Success element explicitly indicates that the
     * OpenTravel message succeeded.
     *
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRS\TicketItemInfoAType[]
     * $ticketItemInfo
     */
    private $ticketItemInfo = null;

    /**
     * Information to specify which queue a PNR was placed on after the ticket was
     * isssued.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRS\QueuePNRAType
     * $queuePNR
     */
    ...
    /**
     * Adds as ticketItemInfo
     *
     * Information for the ticket that was issued.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRS\TicketItemInfoAType
     * $ticketItemInfo
     */
    public function addToTicketItemInfo(
        \Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRS\TicketItemInfoAType $ticketItemInfo
    ) {
     ...
     * @return boolean
     */
    public function issetTicketItemInfo($index)
    {
        return isset($this->ticketItemInfo[$index]);
    }

    /**
     * unset ticketItemInfo
     *
     * Information for the ticket that was issued.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetTicketItemInfo($index)
    {
        unset($this->ticketItemInfo[$index]);
    }

    /**
     * Gets as ticketItemInfo
     *
     * Information for the ticket that was issued.
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRS\TicketItemInfoAType[]
     */
    public function getTicketItemInfo()
    {
        return $this->ticketItemInfo;
    }

    /**
     * Sets a new ticketItemInfo
     *
     * Information for the ticket that was issued.
     *
     * @param
     ...
     * @return self
     */
    public function setTicketItemInfo(array $ticketItemInfo)
    {
        $this->ticketItemInfo = $ticketItemInfo;
     ...
     * isssued.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRS\QueuePNRAType
     */
     ...
     * isssued.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRS\QueuePNRAType
     * $queuePNR
     * @return self
     */
    public function setQueuePNR(\Davispeixoto\OpenTravelAlliance\OTAAirDemandTicketRS\QueuePNRAType $queuePNR)
    {
     ...
     * @return self
     */
    public function setComment(\Davispeixoto\OpenTravelAlliance\FreeTextType $comment)
    {
