...
/**
 * Class representing OTAPurchaseItemRS
 */
class OTAPurchaseItemRS
{
    ...
    /**
     * An element that is not intended to contain any data. The mere presence of this
     * element in the response message indicates that the incoming request message was
    ...
    /**
     * Optionally used in conjunction with the Success element to indicate that the
     * recipient of the request message identified one or more business-level
     * warnings/errors, but the message itself was successfully processed.
     *
    ...
    /**
     * Information related to the purchased item.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAPurchaseItemRS\PurchaseItemInfoAType
     * $purchaseItemInfo
     */
    private $purchaseItemInfo = null;
    ...
    /**
     * Gets as purchaseItemInfo
     *
     * Information related to the purchased item.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAPurchaseItemRS\PurchaseItemInfoAType
     */
    public function getPurchaseItemInfo()
    {
        return $this->purchaseItemInfo;
    }

    /**
     * Sets a new purchaseItemInfo
     *
     * Information related to the purchased item.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAPurchaseItemRS\PurchaseItemInfoAType
     * $purchaseItemInfo
     * @return self
     */
    public function setPurchaseItemInfo(
        \Davispeixoto\OpenTravelAlliance\OTAPurchaseItemRS\PurchaseItemInfoAType $purchaseItemInfo
    ) {
        $this->purchaseItemInfo = $purchaseItemInfo;
