...
/**
 * Class representing OTAGolfCourseAvailRS
 */
class OTAGolfCourseAvailRS
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGolfCourseAvailRS\ProcessingInfoAType
     * $processingInfo
     */
    private $processingInfo = null;

    /**
     * One or more golf facility(s) with available tee time round(s).
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGolfCourseAvailRS\GolfFacilityAType[]
     * $golfFacility
     */
    private $golfFacility = null;
     ...
     * default to the value in POS/Source/ @ISOCurrency.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfCourseAvailRS\ProcessingInfoAType
     * $processingInfo
     * @return self
     */
    public function setProcessingInfo(
        \Davispeixoto\OpenTravelAlliance\OTAGolfCourseAvailRS\ProcessingInfoAType $processingInfo
    ) {
    ...
    /**
     * Adds as golfFacility
     *
     * One or more golf facility(s) with available tee time round(s).
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfCourseAvailRS\GolfFacilityAType
     * $golfFacility
     */
    public function addToGolfFacility(
        \Davispeixoto\OpenTravelAlliance\OTAGolfCourseAvailRS\GolfFacilityAType $golfFacility
    ) {
        $this->golfFacility[] = $golfFacility;
     ...
     * @return boolean
     */
    public function issetGolfFacility($index)
    {
        return isset($this->golfFacility[$index]);
    }
     ...
     * @return void
     */
    public function unsetGolfFacility($index)
    {
        unset($this->golfFacility[$index]);
    }

    /**
     * Gets as golfFacility
     *
     * One or more golf facility(s) with available tee time round(s).
     *
     * @return
     * \Davispeixoto\OpenTravelAlliance\OTAGolfCourseAvailRS\GolfFacilityAType[]
     */
    public function getGolfFacility()
    {
        return $this->golfFacility;
    }

    /**
     * Sets a new golfFacility
     *
     * One or more golf facility(s) with available tee time round(s).
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAGolfCourseAvailRS\GolfFacilityAType[]
     ...
     * @return self
     */
    public function setGolfFacility(array $golfFacility)
    {
        $this->golfFacility = $golfFacility;
