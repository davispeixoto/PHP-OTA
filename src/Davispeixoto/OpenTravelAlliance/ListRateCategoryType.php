...
/**
 * Class representing ListRateCategoryType
 *
 * Rate/ rate plan categories.Use: This is a string list of enumerations with an
 ...
 * XSD Type: List_RateCategory
 */
class ListRateCategoryType
{
