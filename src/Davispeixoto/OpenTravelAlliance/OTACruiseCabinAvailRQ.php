...
/**
 * Class representing OTACruiseCabinAvailRQ
 */
class OTACruiseCabinAvailRQ
{
    ...
    /**
     * Specifies guest names and/or their transportation regarding the guest staying in
     * the cabin.
     *
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCabinAvailRQ\GuestCountsAType\GuestCountAType[]
     * $guestCounts
     */
     ...
     * response. Used to request a package option that the cruise might offer with the
     * sailing. It is quite common to request, at this stage, packages that are
     * included in the cruise sailing offering (inclusive packages).
     *
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCabinAvailRQ\SearchQualifiersAType
     * $searchQualifiers
     */
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCabinAvailRQ\SelectedFareAType
     * $selectedFare
     */
    ...
    public function addToGuestCounts(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCabinAvailRQ\GuestCountsAType\GuestCountAType $guestCount
    ) {
    ...
    public function setSearchQualifiers(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCabinAvailRQ\SearchQualifiersAType $searchQualifiers
    ) {
     ...
     * cruise lines.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTACruiseCabinAvailRQ\SelectedFareAType
     */
     ...
     * cruise lines.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTACruiseCabinAvailRQ\SelectedFareAType
     * $selectedFare
     * @return self
     */
    public function setSelectedFare(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCabinAvailRQ\SelectedFareAType $selectedFare
    ) {
