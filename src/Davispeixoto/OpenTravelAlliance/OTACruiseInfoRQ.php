...
/**
 * Class representing OTACruiseInfoRQ
 */
class OTACruiseInfoRQ
{
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseInfoRQ\InformationTypeAType[]
     * $informationType
     */
    ...
    /**
     * Adds as informationType
     *
     * Used to define an information request.
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\OTACruiseInfoRQ\InformationTypeAType
     * $informationType
     */
    public function addToInformationType(
        \Davispeixoto\OpenTravelAlliance\OTACruiseInfoRQ\InformationTypeAType $informationType
    ) {
     ...
     * @return boolean
     */
    public function issetInformationType($index)
    {
        return isset($this->informationType[$index]);
    }

    /**
     * unset informationType
     *
     * Used to define an information request.
     *
     * @param scalar $index
     * @return void
     */
    public function unsetInformationType($index)
    {
        unset($this->informationType[$index]);
    }
     ...
     * Used to define an information request.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTACruiseInfoRQ\InformationTypeAType[]
     */
     ...
     * @return self
     */
    public function setInformationType(array $informationType)
    {
        $this->informationType = $informationType;
