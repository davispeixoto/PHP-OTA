...
/**
 * Class representing OTAVehRateRuleRQ
 */
class OTAVehRateRuleRQ
{
     ...
     * the vehicle rate rule request and agency number assigned by IATA, ARC, ESRP or
     * TID.
     *
    ...
    /**
     * The reference element is used to send either the confirmation number when
     * retrieving rate rule information for a previously confirmed booking or a
     * reference ID from a previous rate display.
     *
    ...
    /**
     * Contains information for a vehicle rental.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAVehRateRuleRQ\RentalInfoAType
     * $rentalInfo
     */
     ...
     * Contains information for a vehicle rental.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAVehRateRuleRQ\RentalInfoAType
     */
     ...
     * Contains information for a vehicle rental.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAVehRateRuleRQ\RentalInfoAType
     * $rentalInfo
     * @return self
     */
    public function setRentalInfo(\Davispeixoto\OpenTravelAlliance\OTAVehRateRuleRQ\RentalInfoAType $rentalInfo)
    {
