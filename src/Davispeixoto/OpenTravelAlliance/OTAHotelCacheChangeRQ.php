...
class OTAHotelCacheChangeRQ
{
    ...
    /**
     * A container element for one or more cache search criteria definitions.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelCacheChangeRQ\CacheSearchCriteriaAType
     * $cacheSearchCriteria
     */
    private $cacheSearchCriteria = null;
     ...
     * \Davispeixoto\OpenTravelAlliance\OTAHotelCacheChangeRQ\CacheSearchCriteriaAType
     */
    public function getCacheSearchCriteria()
    {
        return $this->cacheSearchCriteria;
    }

    /**
     * Sets a new cacheSearchCriteria
     *
     * A container element for one or more cache search criteria definitions.
     *
     * @param
     ...
     * @return self
     */
    public function setCacheSearchCriteria(
        \Davispeixoto\OpenTravelAlliance\OTAHotelCacheChangeRQ\CacheSearchCriteriaAType $cacheSearchCriteria
    ) {
