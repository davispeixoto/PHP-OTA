...
namespace Davispeixoto\OpenTravelAlliance\OTACruiseCabinUnholdRQ;
...
class SelectedSailingAType
{
    ...
    /**
     * Identifies the currently held cabins for the given sailing, for which release is
     * being requested.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTACruiseCabinUnholdRQ\SelectedSailingAType\SelectedCabinAType[]
     * $selectedCabin
     */
    ...
    public function addToSelectedCabin(
        \Davispeixoto\OpenTravelAlliance\OTACruiseCabinUnholdRQ\SelectedSailingAType\SelectedCabinAType $selectedCabin
    ) {
