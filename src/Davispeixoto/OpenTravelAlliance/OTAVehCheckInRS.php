...
/**
 * Class representing OTAVehCheckInRS
 */
class OTAVehCheckInRS
{
    ...
    /**
     * A collection of vehicle rental transaction information, including Pickup and
     * return details, vehicle information, rental rates, additional or special
     * equipment, fees, total charges, a confirmation ID and contract information.
     *
    ...
    /**
     * Vehicle check in information, including payment rules, rental payment amount,
     * priced coverages, vendor messages, location details, tour information, special
     * requests, arrival details, written confirmation instructions and remarks.
     *
     * @property \Davispeixoto\OpenTravelAlliance\VehicleSegmentAdditionalInfoType
     * $vehCheckInInfo
     */
    private $vehCheckInInfo = null;
     ...
     * @return self
     */
    public function setVehCheckInInfo(\Davispeixoto\OpenTravelAlliance\VehicleSegmentAdditionalInfoType $vehCheckInInfo)
    {
