...
/**
 * Class representing OTAHotelInvNotifRQ
 */
class OTAHotelInvNotifRQ
{
     ...
     * each InvNotifRQ, (i.e. the entire message) for transaction tracability.
     *
    ...
    /**
     * A collection of Sellable products for a given hotel.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAHotelInvNotifRQ\SellableProductsAType
     * $sellableProducts
     */
     ...
     * A collection of Sellable products for a given hotel.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAHotelInvNotifRQ\SellableProductsAType
     * $sellableProducts
     * @return self
     */
    public function setSellableProducts(
        \Davispeixoto\OpenTravelAlliance\OTAHotelInvNotifRQ\SellableProductsAType $sellableProducts
    ) {
