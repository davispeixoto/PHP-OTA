...
/**
 * Class representing OTAProfileModifyRS
 */
class OTAProfileModifyRS
{
    ...
    /**
     * Used to convey the identity of the modified profile, the owner of the profile,
     * or an id provided by the client.
     *
