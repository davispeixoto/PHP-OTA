...
class RoomTypeType
{
    ...
    /**
     * Indicates the room is an alternate room type to the requested room type when
     * true.
     *
     ...
     *
     * @property string $reqdGuaranteeType
     */
     ...
     *
     * @property \Davispeixoto\OpenTravelAlliance\RoomTypeType\OccupancyAType[]
     * $occupancy
     */
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\RoomTypeType\OccupancyAType $occupancy
     */
    public function addToOccupancy(\Davispeixoto\OpenTravelAlliance\RoomTypeType\OccupancyAType $occupancy)
    {
     ...
     * Provides parameters of occupancy limits.
     *
     * @return \Davispeixoto\OpenTravelAlliance\RoomTypeType\OccupancyAType[]
     */
