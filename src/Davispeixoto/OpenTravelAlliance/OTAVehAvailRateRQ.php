...
/**
 * Class representing OTAVehAvailRateRQ
 */
class OTAVehAvailRateRQ
{
     ...
     *
     * @property boolean $maxPerVendorInd
     */
    private $maxPerVendorInd = null;
    ...
    /**
     * Customer identification.Implementer: This is the identification of the customer
     * for whom availability is being requested. This is different than the customer's
     * loyalty number.
     *
    ...
    /**
     * Core availability request information.
     *
     * @property \Davispeixoto\OpenTravelAlliance\OTAVehAvailRateRQ\VehAvailRQCoreAType
     * $vehAvailRQCore
     */
    ...
    /**
     * Sets a new maxPerVendorInd
     *
     * When true, max responses is per vendor.
     *
     * @param boolean $maxPerVendorInd
     * @return self
     */
    public function setMaxPerVendorInd($maxPerVendorInd)
    {
     ...
     */
    public function addToCustomerID(\Davispeixoto\OpenTravelAlliance\UniqueIDType $customerID)
    {
     ...
     * Core availability request information.
     *
     * @return \Davispeixoto\OpenTravelAlliance\OTAVehAvailRateRQ\VehAvailRQCoreAType
     */
     ...
     * Core availability request information.
     *
     * @param \Davispeixoto\OpenTravelAlliance\OTAVehAvailRateRQ\VehAvailRQCoreAType
     * $vehAvailRQCore
     * @return self
     */
    public function setVehAvailRQCore(
        \Davispeixoto\OpenTravelAlliance\OTAVehAvailRateRQ\VehAvailRQCoreAType $vehAvailRQCore
    ) {
