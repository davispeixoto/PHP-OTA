...
namespace Davispeixoto\OpenTravelAlliance\OTAGroundModifyRQ\ReservationAType\PassengerAType\AdditionalAType;

/**
 * Class representing AdditionalTypeAType
 */
class AdditionalTypeAType
{
