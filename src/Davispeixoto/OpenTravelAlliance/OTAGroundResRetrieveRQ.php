...
/**
 * Class representing OTAGroundResRetrieveRQ
 */
class OTAGroundResRetrieveRQ
{
    ...
    /**
     * An indication of the level of information to be returned in the response
     * message.
     *
     * @property string $reqRespChoice
     */
    private $reqRespChoice = null;
    ...
    /**
     * Search criteria that can be used to retrieve an existing ground transportation
     * reservation if the reservation ID/reference number is not known.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTAGroundResRetrieveRQ\ReservationSearchCriteriaAType
     * $reservationSearchCriteria
     */
    private $reservationSearchCriteria = null;
     ...
     * @return string
     */
    public function getReqRespChoice()
    {
        return $this->reqRespChoice;
    }

    /**
     * Sets a new reqRespChoice
     *
     * An indication of the level of information to be returned in the response
     * message.
     *
     * @param string $reqRespChoice
     * @return self
     */
    public function setReqRespChoice($reqRespChoice)
    {
        $this->reqRespChoice = $reqRespChoice;
    ...
    /**
     * Gets as reservationSearchCriteria
     *
     * Search criteria that can be used to retrieve an existing ground transportation
     * reservation if the reservation ID/reference number is not known.
     *
     ...
     * \Davispeixoto\OpenTravelAlliance\OTAGroundResRetrieveRQ\ReservationSearchCriteriaAType
     */
    public function getReservationSearchCriteria()
    {
        return $this->reservationSearchCriteria;
    }

    /**
     * Sets a new reservationSearchCriteria
     *
     * Search criteria that can be used to retrieve an existing ground transportation
     * reservation if the reservation ID/reference number is not known.
     *
     ...
     * @return self
     */
    public function setReservationSearchCriteria(
        \Davispeixoto\OpenTravelAlliance\OTAGroundResRetrieveRQ\ReservationSearchCriteriaAType $reservationSearchCriteria
    ) {
