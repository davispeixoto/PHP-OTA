...
/**
 * Class representing OTALoyaltyCertificateCreateRS
 */
class OTALoyaltyCertificateCreateRS
{
    ...
    /**
     * Details about the loyalty certificate, including certifacte number and type.
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTALoyaltyCertificateCreateRS\LoyaltyCertificateDetailAType[]
     ...
     *
     * @property
     * \Davispeixoto\OpenTravelAlliance\OTALoyaltyCertificateCreateRS\CustomerAType[]
     * $customer
     */
    private $customer = null;

    /**
     * Travel information for created certificates.
     *
    ...
    /**
     * Loyalty account information used to create certificate.
     *
     * @property \Davispeixoto\OpenTravelAlliance\AccountInfoType[] $accountInfo
     */
    ...
    public function addToLoyaltyCertificateDetail(
        \Davispeixoto\OpenTravelAlliance\OTALoyaltyCertificateCreateRS\LoyaltyCertificateDetailAType $loyaltyCertificateDetail
    ) {
    ...
    public function addToCustomer(
        \Davispeixoto\OpenTravelAlliance\OTALoyaltyCertificateCreateRS\CustomerAType $customer
    ) {
     ...
     *
     * @return self
     * @param \Davispeixoto\OpenTravelAlliance\AccountInfoType $accountInfo
     */
    public function addToAccountInfo(\Davispeixoto\OpenTravelAlliance\AccountInfoType $accountInfo)
    {
     ...
     * @return boolean
     */
    public function issetAccountInfo($index)
    {
        return isset($this->accountInfo[$index]);
    }
     ...
     * @return void
     */
    public function unsetAccountInfo($index)
    {
        unset($this->accountInfo[$index]);
    }
     ...
     * Loyalty account information used to create certificate.
     *
     * @return \Davispeixoto\OpenTravelAlliance\AccountInfoType[]
     */
